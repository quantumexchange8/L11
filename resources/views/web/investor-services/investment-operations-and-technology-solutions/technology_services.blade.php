...
@section('title', 'Technology Services | Investment Operations & Technology Solutions | Investor Services | Sunrise Fund Limited')
...
@component('components.page-header', [
    ...
    'headerImage' => url('assets/img/banner65.jpg'),
