...
@section('title', 'InfoRecon | Targeted Technology Solutions via Infomediary | Middle Office Outsourcing | Investment Operations & Technology Solutions | Investor Services | Sunrise Fund Limited')
...
@component('components.page-header', [
    ...
    'headerImage' => url('assets/img/banner86.jpg'),
])
@endcomponent
    <main>
