...
@section('title', 'InfoAction | Targeted Technology Solutions via Infomediary | Middle Office Outsourcing | Investment Operations & Technology Solutions | Investor Services | Vanward International')

@section('content')
@component('components.page-header', [
    'title' => __('public.infoAction'),
    ...
    'headerImage' => url('assets/img/banner84.jpg'),
        ...
        <section class="section-base">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-8">
                        <p class="paragraph">
                            {{-- <strong>@lang('public.infoAction')</strong> --}}
                        </p>
                    </div>
                    {{-- <div class="col-lg-4">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <p class="paragraph">
                            @lang('public.inforecon 1')
                            <br><br>
                            <strong>@lang('public.inforecon 2')</strong>
                            <br>
                            &nbsp;&nbsp;&nbsp;&bull;&nbsp;@lang('public.inforecon 3')<br>
                            &nbsp;&nbsp;&nbsp;&bull;&nbsp;@lang('public.inforecon 4')<br>
                            &nbsp;&nbsp;&nbsp;&bull;&nbsp;@lang('public.inforecon 5')
                            <br><br>
                            <strong>@lang('public.inforecon 6')</strong>
                            <br>
                            &nbsp;&nbsp;&nbsp;&bull;&nbsp;@lang('public.inforecon 7')<br>
                            &nbsp;&nbsp;&nbsp;&bull;&nbsp;@lang('public.inforecon 8')
                            <br><br>
                            <strong>@lang('public.inforecon 9')</strong>
                            <br>
                            &nbsp;&nbsp;&nbsp;&bull;&nbsp;@lang('public.inforecon 10') <br>
                            &nbsp;&nbsp;&nbsp;&bull;&nbsp;@lang('public.inforecon 11')
                        </p>
                    </div>
                </div>
