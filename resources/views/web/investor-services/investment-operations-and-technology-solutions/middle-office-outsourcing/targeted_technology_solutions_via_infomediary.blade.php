...
@section('title', 'Targeted Technology Solutions Via Infomediary | Middle Office Outsourcing | Investment Operations & Technology Solutions | Investor Services | Sunrise Fund Limited')
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <p class="paragraph">
                            ...
                            <br><br>
                            &nbsp;&nbsp;&nbsp;&bull;&nbsp;<a class="link-effect" href="{{ route('web.investor-services.infoAction') }}">@lang('public.infoAction')</a>®: @lang('public.data connectivity & applications via infomediary 6')
                            <br>
                            &nbsp;&nbsp;&nbsp;&bull;&nbsp;<a class="link-effect" href="{{ route('web.investor-services.markets.infofx') }}">@lang('public.infofx')</a>®: @lang('public.data connectivity & applications via infomediary 7')
                            <br>
                            &nbsp;&nbsp;&nbsp;&bull;&nbsp;<a class="link-effect" href="{{ route('web.investor-services.infoRecon') }}">@lang('public.inforecon')</a>™: @lang('public.data connectivity & applications via infomediary 8')
                            <br>
                            &nbsp;&nbsp;&nbsp;&bull;&nbsp;<a class="link-effect" href="{{ route('web.investor-services.infoNav') }}">@lang('public.infonav')</a>™: @lang('public.data connectivity & applications via infomediary 9')
                            <br>
                        </p>
                    </div>
                </div>
