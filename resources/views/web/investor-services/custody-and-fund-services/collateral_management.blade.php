...
@section('title', 'Collateral Management | Custody & Fund Services | Investor Services | Sunrise Fund Limited')
...
@section('content')
    @component('components.page-header', [
        ...
        'headerImage' => url('assets/img/banner49.jpg'),
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <p class="paragraph">
                            @lang('public.collateral management 1')
                            <br><br>
                            <span class="font-bold"><strong>@lang('public.collateral management 2')</strong></span>
                            <br>
                            @lang('public.collateral management 3')
                            <br>
                            @lang('public.collateral management 4')
                            <br>
                            @lang('public.collateral management 5')
                            <br><br>
                            <span class="font-bold"><strong>@lang('public.collateral management 6')</strong></span>
                            <br>
                            @lang('public.collateral management 7')
                            <br>
                            @lang('public.collateral management 8')
                            <br>
                            @lang('public.collateral management 9')
                            <br><br>
                            <span class="font-bold"><strong>@lang('public.collateral management 10')</strong></span>
                            <br>
                            @lang('public.collateral management 11')
                            <br>
                            @lang('public.collateral management 12')
                            <br>
                            @lang('public.collateral management 13')
                            <br>
                            @lang('public.collateral management 14')
                            <br><br>
                            <span class="font-bold underline"><strong>@lang('public.collateral management 15')</strong></span>
                            <br>
                            @lang('public.collateral management 16')
                            <br><br>
                        </p>
                    </div>
                </div>
