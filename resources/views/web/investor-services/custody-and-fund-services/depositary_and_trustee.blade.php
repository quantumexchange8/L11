...
@section('title', 'Depositary & Trustee | Custody & Fund Services | Investor Services | Sunrise Fund Limited')
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <p class="paragraph">
                            ...
                            <br><br>
                            <span class="font-bold"><strong>@lang('public.approach')</strong></span>
                            <br><br>
