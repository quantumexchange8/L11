...
@section('title', 'Custody | Custody & Fund Services | Investor Services | Vanward International')

@section('content')
    @component('components.page-header', [
        'title' => __('public.custody'),
        'url' => 'investor-services/custody-and-fund-services',
        'sub2' => __('public.custody & fund services'),
        'headerImage' => url('assets/img/banner42.jpeg'),
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <p class="paragraph">
                            @lang('public.custody 1')
                            <br><br>
                            <span class="font-bold"><strong>@lang('public.custody 2')</strong></span>
                            <br>
                            @lang('public.custody 3')
                            <br><br>
                            <span class="font-bold"><strong>@lang('public.custody 4')</strong></span>
                            <br>
                            @lang('public.custody 5')
                            <br><br>
                            <span class="font-bold"><strong>@lang('public.custody 6')</strong></span>
                            <br>
                            @lang('public.custody 7')
                        </p>
                    </div>
                </div>
