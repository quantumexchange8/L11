...
@section('title', 'Fund Accouting | Custody & Fund Services | Investor Services | Vanward International')
...
@section('content')
    @component('components.page-header', [
        ...
        'headerImage' => url('assets/img/banner44.jpg'),
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <p class="paragraph">
                            ...
                            <br><br>
                            <span class="font-bold"><strong>@lang('public.fund accounting 2')</strong></span>
                            <br><br>
                            @lang('public.fund accounting 3')
                            <br><br>
                            <span class="font-bold"><strong>@lang('public.fund accounting 4')</strong></span>
                            <br><br>
