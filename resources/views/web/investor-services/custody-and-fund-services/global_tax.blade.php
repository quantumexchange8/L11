                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <p class="paragraph">
                            ...
                            <br><br>
                            <span class="font-bold"><strong>@lang('public.global tax 2')</strong></span>
                            <br><br>
                            @lang('public.global tax 3')
                            <br><br>
                            <span class="bold"><strong>@lang('public.global tax 4')</strong></span>
                            <br><br>
