...
@section('title', 'Fund Order & Custody | Custody & Fund Services | Investor Services | Vanward International')

@section('content')
    @component('components.page-header', [
        'title' => __('public.fund order & custody'),
        'url' => 'investor-services/custody-and-fund-services',
        'sub2' => __('public.custody & fund services'),
        'headerImage' => url('assets/img/banner46.jpeg'),
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <p class="paragraph">
                            @lang('public.fund order & custody 1')
                            <br><br>
                            <span class="font-bold"><strong>@lang('public.fund order & custody 2')</strong></span>
                            <br>
                            @lang('public.fund order & custody 3')
                            <br>
                            @lang('public.fund order & custody 4')
                            <br>
                            @lang('public.fund order & custody 5')
                            <br>
                            @lang('public.fund order & custody 6')
                            <br>
                            @lang('public.fund order & custody 7')
                        </p>
                    </div>
                </div>
