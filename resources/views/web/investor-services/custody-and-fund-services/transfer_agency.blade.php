...
@section('title', 'Transfer Agency | Custody & Fund Services | Investor Services | Vanward International')

@section('content')
    @component('components.page-header', [
        'title' => __('public.transfer agency'),
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <p class="paragraph">
                            @lang('public.transfer agency 1')
                            <br><br>
                            @lang('public.transfer agency 2')
                            @lang('public.global service model')
                            @lang('public.transfer agency 3')
                            @lang('public.distribution intelligence')
                            <br><br>
                            @lang('public.transfer agency 4')
                            <br><br>
                            <span class="font-bold"><strong>@lang('public.transfer agency 5')</strong></span>
                            <br><br>
                            @lang('public.transfer agency 6')
                            <br><br>
                            <span class="font-bold"><strong>@lang('public.transfer agency 7')</strong></span>
                            <br><br>
                            @lang('public.transfer agency 8')
                            <br><br>
                            <span class="font-bold"><strong>@lang('public.transfer agency 9')</strong></span>
                            <br><br>
                            @lang('public.transfer agency 10')
                            @lang('public.infomediary')
                            @lang('public.transfer agency 11')
                            <br><br>
                            <span class="font-bold"><strong>@lang('public.transfer agency 12')</strong></span>
                            <br><br>
                            @lang('public.transfer agency 13')
                        </p>
                    </div>
                </div>
