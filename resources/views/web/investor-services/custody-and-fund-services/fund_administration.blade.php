                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <p class="paragraph">
                            ...
                            <br>
                            @lang('public.fund administration 3')
                            <br><br>
                            @lang('public.fund administration 4')
                            <br><br>
                            @lang('public.fund administration 5')
                            <br><br>
                            @lang('public.fund administration 6')
                            <br><br>
                            <span class="capitalize">@lang('public.our')</span>
                            @lang('public.global service model')
                            @lang('public.fund administration 7')
                            <br><br>
                        </p>
                    </div>
                </div>
