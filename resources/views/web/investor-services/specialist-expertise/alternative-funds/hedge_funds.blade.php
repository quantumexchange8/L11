...
@section('title', 'Hedge Funds | Alternative Funds | Specialist Expertise | Investor Services | Sunrise Fund Limited')

@section('content')
    @component('components.page-header', [
        'title' => __('public.hedge funds'),
        'url' => 'investor-services/specialist-expertise/alternative-funds',
        'sub2' => __('public.alternative funds'),
        'headerImage' => url('assets/img/banner90.jpg'),
