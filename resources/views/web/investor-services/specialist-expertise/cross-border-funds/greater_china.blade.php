...
@section('title', 'Greater China | Cross-Border Funds | Specialist Expertise | Investor Services | Sunrise Fund Limited')

@section('content')
    @component('components.page-header', [
        'title' => __('public.greater china'),
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <p class="paragraph">
                            ...
                            <br><br>
                            @lang('public.greater china 2')&nbsp;<a class="link-effect" href="{{ route('web.investor-services.specialist-expertise.cross_border_funds') }}">@lang('public.cross border funds') @lang('public.servicing specialist')</a>
                            @lang('public.greater china 3')
                            <a class="link-effect" href="{{ route('web.investor-services.specialist-expertise.cross-border-funds.global_service_model') }}">@lang('public.global service model')</a>.
                            <br><br>
                            @lang('public.greater china 4')
                            <a class="link-effect" href="javascript:void(0)">@lang('public.hong kong domiciled')</a>, @lang('public.greater china 5')
                            <br><br>
                            ...
                            <a class="link-effect" href="{{ route('web.investor-services.custody-and-fund-services.depositary_and_trustee') }}">@lang('public.Trustee services')</a> @lang('public.greater china 12').
                        </p>
                    </div>
                </div>
