...
@section('content')
    @component('components.page-header', [
        'title' => __('public.corporate advisory'),
        'url' => 'private-banking/corporate-advisory-and-banking',
        'headerImage' => url('assets/img/banner29.jpg'),
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <p class="paragraph">
                            @lang('public.corporate advisory 1')
                                <br><br>
                                @lang('public.corporate advisory 2')
                                <br><br>
                                @lang('public.corporate advisory 3')
                                <br><br>
                                @lang('public.corporate advisory 4')
                                <br><br>
                                @lang('public.corporate advisory 5')
                                <br><br>
                                @lang('public.corporate advisory 6')
                                <br><br>
