...
@section('content')
    @component('components.page-header', [
        ...
        'headerImage' => url('assets/img/banner9.jpg'),
        // 'url' => '/our-firm',
                        ...
                        <div class="maso-item cat-2 cat-3">
                            <div class="cnt-box cnt-box-top boxed">
                                ...
                                <div class="caption">
                                    ...
                                    <a href="{{ route('web.private-banking.private_wealth_management') }}" class="btn-text">@lang('public.details')</a>
                                </div>
                            </div>
                        </div>
                        <div class="maso-item cat-1 cat-3">
                            <div class="cnt-box cnt-box-top boxed">
                                ...
                                <div class="caption">
                                    ...
                                    <a href="{{ route('web.private-banking.corporate_advisory_and_banking') }}" class="btn-text">@lang('public.details')</a>
                                </div>
                            </div>
                        </div>
                        <div class="maso-item cat-1">
                            <div class="cnt-box cnt-box-top boxed">
                                ...
                                <div class="caption">
                                    ...
                                    <a href="{{ route('web.private-banking.private_equity') }}" class="btn-text">@lang('public.details')</a>
                                </div>
                            </div>
                        </div>
                        {{-- <div class="maso-item cat-2 cat-3">
