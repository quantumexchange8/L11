...
@section('content')
    @component('components.page-header', [
        'title' => __('public.global equity'),
        'url' => 'investment-management/public-equity',
        'sub2' => __('public.public equity'),
        'headerImage' => url('assets/img/banner37.jpeg'),
                ...
                <div class="row">
                    <div class="col-md-12">
                        <p class="paragraph">
                            @lang('public.pe13')
                            <br><br>
                            <span class="font-bold"><strong>@lang('public.pe14')</strong></span>
                            <br>
                                @lang('public.pe15')
                            <br><br>
                            <span class="font-bold"><strong>@lang('public.pe16')</strong></span>
                            <br>
                                @lang('public.pe17')
                            <br><br>
                            <span class="font-bold"><strong>@lang('public.pe18')</strong></span>
                            <br>
                                @lang('public.pe19')
                            <br><br>
                            <span class="font-bold"><strong>@lang('public.pe20')</strong></span>
                            <br>
                                @lang('public.pe21')
                            <br><br>
                                @lang('public.pe22')
