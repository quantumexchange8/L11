...
@section('title', 'Ongoing Learning | Total Rewards | Careers | Vanward International')

@section('content')
    @component('components.page-header', [
        'title' => __('public.ongoing learning'),
        'url' => '/careers/total-rewards',
        'sub2' => __('public.total rewards'),
        'headerImage' => url('assets/img/banner73.jpg'),
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <p class="paragraph">
                            <p>@lang('public.ongoing learning 1')</p>
                            <br>
                            <p><strong>@lang('public.signature programs'): </strong>@lang('public.ongoing learning 2') </p>
                            <br>
                            <p><strong>@lang('public.ongoing learning 3') </strong>@lang('public.ongoing learning 4')</p>
                            <br>
                            <p><strong>@lang('public.ongoing learning 5') </strong>@lang('public.ongoing learning 6')</p>
                            <br>
                            <p><strong>@lang('public.ongoing learning 7') </strong>@lang('public.ongoing learning 8')
                            </p>
                            <br>
                            <p><strong>@lang('public.ongoing learning 9') </strong>@lang('public.ongoing learning 10')
                            </p>
                        </p>
                    </div>
                </div>
