...
@section('title', 'Thrive Financially | Benefits, Wellness & Compensation | Total Rewards | Careers | Vanward International')

@section('content')
    @component('components.page-header', [
        'title' => __('public.thrive financially'),
        'url' => ('careers/total-rewards/benefits-wellness-and-compensation'),
        'sub2' => __('public.benefits, wellness and compensation'),
        'headerImage' => url('assets/img/banner71.jpg'),
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <p class="paragraph">
                            <p>
                                @lang('public.thrive financially 1')
                            </p>
                            <div style="padding-left: 30px;">
                                @lang('public.thrive financially 2')

                            </div>
                            <br>
                            <p><strong>@lang('public.thrive financially 3')</strong></p>
                            <p>@lang('public.thrive financially 4')</p>
                            <div style="padding-left: 30px;">
                                @lang('public.thrive financially 5')
                            </div>
                        </p>
                    </div>
                </div>
