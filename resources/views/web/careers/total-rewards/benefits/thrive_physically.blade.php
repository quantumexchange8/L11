...
@section('title', 'Thrive Physically | Benefits, Wellness & Compensation | Total Rewards | Careers | Vanward International')

@section('content')
    @component('components.page-header', [
        'title' => __('public.thrive physically'),
        ...
        <section class="section-base">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-8">
                        <p>
                            <strong>@lang('public.thrive physically')</strong>
                        </p>
                    </div>
                    {{-- <div class="col-lg-4">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <p class="paragraph">
                            @lang('public.thrive physically 1')
                            <div style="padding-left: 30px;">
                                @lang('public.thrive physically 2')
                            </div>
                        </p>
                    </div>
                </div>
