...
@section('title', 'Thrive Personally | Benefits, Wellness & Compensation | Total Rewards | Careers | Sunrise Fund Limited')
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <p class="paragraph">
                            <p>
                                @lang('public.thrive personally 1')
                            </p>
                                <br>
                            <div style="padding-left: 30px;">
                                @lang('public.thrive personally 2')
