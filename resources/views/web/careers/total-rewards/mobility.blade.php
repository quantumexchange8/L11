...
@section('title', 'Mobility | Total Rewards | Careers | Sunrise Fund Limited')
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <p class="paragraph">
                            <p>
                                @lang('public.mobility 1')
                            </p>
                            <br>
                            <p><strong>@lang('public.mobility 2')</strong></p>
                            <br>
                            <p>@lang('public.mobility 3')
                            </p>
                            <div style="padding-left: 30px">
                                @lang('public.mobility 4')
                            </div>
                        </p>
                    </div>
                </div>
