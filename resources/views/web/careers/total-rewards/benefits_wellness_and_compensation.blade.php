...
@section('title', 'Benefits, Wellness & Compensation | Total Rewards | Careers | Vanward International')

@section('content')
    @component('components.page-header', [
        'title' => __('public.benefits, wellness and compensation'),
        'url' => '/careers/total-rewards',
        'sub2' => __('public.total rewards'),
        'headerImage' => url('assets/img/banner70.jpg'),
        ...
        <section class="section-base">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-8">
                        <p>
                            {{-- <strong>@lang('public.benefits wellness & compensation')</strong> --}}
                        </p>
                    </div>
                    {{-- <div class="col-lg-4">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <p class="paragraph">
                            <strong>@lang('public.benefits wellness compensation 1')</strong>
                            <br>
                            @lang('public.benefits wellness compensation 2')
                            <br><br>
                            <li><a class="link-effect" href="{{ route('web.careers.thrive_financially') }}">@lang('public.thrive financially')</a></li>
                            <li><a class="link-effect" href="{{ route('web.careers.thrive_personally') }}">@lang('public.thrive personally')</a></li>
                            <li><a class="link-effect" href="{{ route('web.careers.thrive_physically') }}">@lang('public.thrive physically')</a></li>
                        </p>
                    </div>
                </div>
