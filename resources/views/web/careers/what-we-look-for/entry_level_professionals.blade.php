...
@section('title', 'Entry Level Professionals | What We Look For | Careers | Sunrise Fund Limited')
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="paragraph">
                            @lang('public.entry level 1')
                            <div class="paragraph" style="padding-left: 30px;">
                                <li>@lang('public.entry level 2')</li>
                                <li>@lang('public.entry level 3') </li>
                                <li>@lang('public.entry level 4')</li>
                                <li>@lang('public.entry level 5')</li>
                                <li>@lang('public.entry level 6')</li>
                                <li>@lang('public.entry level 7')</li>
                            </div>
                            <br>
                            @lang('public.entry level 8')
