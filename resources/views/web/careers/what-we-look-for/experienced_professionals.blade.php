...
@section('title', 'Experienced Professionals | What We Look For | Careers | Vanward International')

@section('content')
    @component('components.page-header', [
        'title' => __('public.experienced professionals'),
        'url' => '/careers/what-we-look-for',
        'sub2' => __('public.what we look for'),
        'headerImage' => url('assets/img/banner68.jpg'),
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <p class="paragraph">
                            <p>@lang('public.experienced 1')</p>
                                <br>
                            <p>@lang('public.experienced 2')</p>
                                <br>
                            <p>@lang('public.experienced 3')</p>
                                <br>
                            <p>@lang('public.experienced 4')</p>
                            <p>@lang('public.experienced 5')</p>
                            <div style="padding-left: 30px;">
                                <li>@lang('public.experienced 6')</li>
                                <li>@lang('public.experienced 7')</li>
                                <li>@lang('public.experienced 8')</li>
                                <li>@lang('public.experienced 9')</li>
                            </div>
                            <br>
                            <p>@lang('public.experienced 10')</p>
                        </p>
                    </div>
                </div>
