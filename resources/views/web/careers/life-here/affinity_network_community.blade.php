...
@section('title', 'Affinity Network Community | Life Here | Careers | Vanward International')
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <p class="paragraph">
                            <p><em>@lang('public.affinity network community 1') </em>
                                <strong>– @lang('public.affinity network community 2'), @lang('public.affinity network community 3')
                                </strong>
                            </p>
                            <br>
                            <p>@lang('public.affinity network community 4')</p>
                            <br>
                            <p>@lang('public.affinity network community 5') @lang('public.affinity network community 6')
                                    @lang('public.affinity network community 7')&nbsp;
                            </p>
                        </p>
                    </div>
                </div>
