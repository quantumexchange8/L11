...
return [
    ...
    "invest reminder 1"                     => "MITTE FDA KINNITATUD",
    "invest reminder 2"                     => "PUUDUB PANGA GARANTII",
    "invest reminder 3"                     => "VÕIB KAOTADA VÄÄRTUST",
    "insights"                              => "Ülevaated",
    "approach"                              => "Lähenemine",
    "infoAction"                            => "InfoAction",
    "infomediary"                           => "Infomediaator",
    "content unavailable"                   => "Sisu pole hetkel saadaval. Palun proovi hiljem uuesti.",
    "fx disclosure statement"               => "Valuutavahetuse avaldus",
    "fx terms and conditions"               => "Valuutavahetuse tingimused",
    "and"                                   => "ja",
    "or"                                   => "või",
    "our"                                   => "meie",
    "we provide"                            => "Me pakume",
    "administration"                        => "haldamine",
    "as of december 2021"                   => "*seisuga detsember 2021.",
    "as of december 2019"                   => "*seisuga detsember 2019.",
    "short pride"                           => "Uhkus",
    "short diverse abilities"               => "Erinevate võimete liitlased",
    "short womens"                          => "Naiste",
    "learn more"                            => "Lisateave",
    "please"                                => "Palun",
    "with questions"                        => "küsimuste korral.",
    ...
    "global tax services"                   => "Globaalsed maksuteenused",
    "investment operations & technology"    => "Investeerimistoimingud ja tehnoloogia",
    "data & connectivity solutions"         => "Andme- ja ühenduslahendused",
    "middle office"                         => "Keskmine kontor",
    "servicing specialist"                  => "teeninduse spetsialist",
    "Trustee services"                      => "Usaldusteenused",
    "japan"                                 => "Jaapan",
    "irish"                                 => "Iiri",
    ...
    // top navbar
    "client login"                                  => "Kliendi sisselogimine",
    "our firm"                                      => "Meie ettevõte",
    "careers"                                       => "Karjäär",
    "sustainability"                                => "Jätkusuutlikkus",
    "contact us"                                    => "Võta meiega ühendust",
    "private banking"                               => "Erakliendi pangandus",
    "investment management"                         => "Investeeringute haldamine",
    "investor services"                             => "Investoriteenused",
    "private wealth management"                     => "Eraklientide varahaldus",
    "investment advisory"                           => "Investeerimisnõustamine",
    "wealth planning"                               => "Varade planeerimine",
    "philanthropic advisory"                        => "Filantroopia nõustamine",
    "trust services"                                => "Usaldusteenused",
    "private client lending"                        => "Erakliendi laenamine",
    "center for women & wealth"                     => "Naiste ja varanduse keskus",
    "corporate advisory & banking"                  => "Ärinõustamine ja pangandus",
    "corporate advisory"                            => "Ärinõustamine",
    ...
    "public equity"                                 => "Avalik aktsiaturg",
    "US large cap equity"                           => "USA suurkapitali aktsiad",
    "global equity"                                 => "Globaalsed aktsiad",
    "US small & mid-cap equity"                     => "USA väike- ja keskmise kapitaliga aktsiad",
    "fixed income"                                  => "Fikseeritud sissetulek",
    "taxable fixed income strategies"               => "Maksustatavad fikseeritud sissetuleku strateegiad",
    "tax-exempt fixed income strategy"              => "Maksuvabad fikseeritud sissetuleku strateegiad",
    "US TIPS strategy"                              => "USA TIPS strateegia",
    "open account"                                  => "Ava konto",
    "custody & fund services"                       => "Hoiuteenused ja fonditeenused",
    "custody"                                       => "Hoiuteenused",
    "depositary & trustee"                          => "Hoiuteenused ja usaldusisik",
    "fund accounting"                               => "Fondide arvestus",
    "fund administration"                           => "Fondihaldus",
    "transfer agency"                               => "Ülekandeagentuur",
    "global tax"                                    => "Globaalne maksustamine",
    "collateral management"                         => "Tagatisvara haldus",
    "fund order & custody"                          => "Fondide tellimus ja hoiuteenused",
    "specialist expertise"                          => "Ekspertteadmised",
    "cross border funds"                            => "Rahvusvahelised fondid",
    "US funds"                                      => "USA fondid",
    "consultants and advisors"                      => "Konsultandid ja nõustajad",
    "distribution and intelligence"                 => "Jaotus ja intelligentsus",
    "distribution intelligence"                     => "Jaotusintelligentsus",
    "alternative funds"                             => "Alternatiivsed fondid",
    "exchange traded funds"                         => "Börsil kaubeldavad fondid",
    "insurance"                                     => "Kindlustus",
    "regulatory intelligence"                       => "Regulatiivne intelligentsus",
    "markets"                                       => "Turud",
    "foreign exchange"                              => "Valuutavahetus",
    "active fx execution"                           => "Aktiivne valuutavahetus",
    "infofx"                                        => "InfoFX",
    ...
    "middle office outsourcing"                     => "Keskmebüroo allhanke teenused",


    // private banking sidebar
    "conversations on women, wealth & leadership"   => "Vestlused naiste, varanduse ja juhtimise teemadel",
    "defining legacy and the future of the business"=> "Pärandi ja ettevõtte tuleviku määratlemine",
    "building a support team"                       => "Toetava meeskonna loomine",
    "succession planning – management and ownership"=> "Järelkasvu planeerimine - juhtimine ja omand",
    "capital policies"                              => "Kapitali poliitikad",
    "employment policies"                           => "Tööpoliitikad",
    "governance and communications"                 => "Valitsemine ja suhtlus",
    "distributions and family liquidity"            => "Jaotused ja pere likviidsus",
    "balancing competing interests"                 => "Konkureerivate huvide tasakaalustamine",


    // investment management sidebar
    "ESG approach"                                  => "ESG lähenemine",

    //investor services sidebar
    "greater china"                                     => "Suur-Hiina",
    "latin america"                                     => "Lõuna-Ameerika",
    "japan"                                             => "Jaapan",
    "dublin"                                            => "Dublin",
    "luxembourg"                                        => "Luksemburg",
    "global service model"                              => "Globaalne teenusemudel",
    "real assets"                                       => "Reaalsed varad",
    "real assets & infrastructure"                      => "Reaalsed varad ja infrastruktuur",
    "hedge funds"                                       => "Hedge-fondid",
    "syndicated and originated debt"                    => "Sünteetilised ja päritud võlad",
    "tokyo fixing rates"                                => "Tokyo fikseeritud määrad",
    "terms and conditions"                              => "Kasutustingimused",
    "regulatory reporting requirements"                 => "Reguleerivate aruandluskohustuste nõuded",
    "fx disclosure"                                     => "Valuutavahetuse avaldus",
    "data connectivity & applications via infomediary"  => "Andmesidus ja rakendused infomediaatori kaudu",
    "global custody direct"                             => "Globaalne hoiuteenus otse",
    "account operator direct for US depositories"       => "Konto operaator otse USA hoiukogudesse",
    "targeted technology solutions via infomediary"     => "Sihipärased tehnoloogilised lahendused infomediaatori kaudu",
    "inforecon"                                         => "InfoRecon",
    "infonav"                                           => "InfoNAV",
    "hosted operations & reporting"                     => "Hostitud operatsioonid ja aruandlus",
    "investment accounting & enterprise data support"   => "Investeerimisraamatupidamine ja ettevõtte andmete tugi",

    //careers sidebar
    "what we look for"                  => "Mida me otsime",
    "undergraduate internships"         => "Bakalaureuseõppe praktikad",
    "entry level professionals"         => "Algtaseme spetsialistid",
    "experienced professionals"         => "Kogenud spetsialistid",
    "restart"                           => "Taaskäivitus",
    "total rewards"                     => "Tasude kogusumma",
    "benefits, wellness and compensation" => "Hüved, heaolu ja kompensatsioon",
    "thrive physically"                 => "Heaolu füüsiliselt",
    "thrive financially"                => "Heaolu rahaliselt",
    "thrive personally"                 => "Heaolu isiklikult",
    "career management"                 => "Karjäärijuhtimine",
    "ongoing learning"                  => "Pidev õppimine",
    ...
    "asia link network"                 => "Aasia ühendusvõrgustik",
    "black affinity network"            => "Mustade sugulusvõrgustik",
    "diverse ability allies network"    => "Mitmekülgsete võimete liitlase võrgustik",
    "global employee network"           => "Globaalne töötajate võrgustik",
    "latino cultural network"           => "Latino kultuurivõrgustik",
    "military veterans network"         => "Sõjaveteranide võrgustik",
    "parenting network"                 => "Vanhemate võrgustik",
    "pride network"                     => "Uhkuse võrgustik",
    "womens network"                    => "Naiste võrgustik",
    "young professionals network"       => "Noorte spetsialistide võrgustik",
    "cares"                             => "Hoolitsemine",

    "the partnership"                   => "Koostööpartnerlus",
    "our mission & profile"             => "Meie missioon ja profiil",
    "philanthropy"                      => "Filantroopia",
    "policies & disclosures"            => "Poliitikad ja avalikustused",
    "important statements & disclosures"=> "Olulised avaldused ja avalikustused",
    "data protection notice"            => "Andmekaitse teade",
    "online security"                   => "Internetiturvalisus",
    "BCP statement"                     => "Ärikriisi lahendamise avaldus (BCP)",
    "regulation E"                      => "Eeskiri E",
    "additional disclosures"            => "Lisavad avalikustused",
    "confidential ethics reporting"     => "Konfidentsiaalne eetikakorraldus",
    "legal"                             => "Õiguslik",
    "privacy policy"                    => "Privaatsuspoliitika",
    "cookie policy"                     => "Küpsisekasutuse poliitika",
    "manage cookies"                    => "Halda küpsiseid",
    "personal information request"      => "Isikliku teabe taotlus",
    "new account policy"                => "Uue konto poliitika",
    "USA patriot act"                   => "USA PATRIOT-i seadus",
    ...
    "investment management 1"           => "Sunrisei missioon on olla oma klientidele parim pikaajalise kapitali säilitamise ja kasvu osas. Keskendume skalpeeritavatele investeerimisstrateegiatele, kus meie filosoofia, metodoloogia ja kogemused võivad anda erilisi tulemusi. Sunrise Investment Management on haldanud omakapitali ja fikseeritud tulu investeeringuid, ja meie eriliseks teeb meie investeerimisstrateegia.
                                            ...
                                            <br><br>",
    "investment management 2"           => "Meie investeerimise põhimõtted:",
    "investment management 3"           => "keskenduvad varahoidmisele",
    "investment management 4"           => "Väärtuspõhine strateegia",
    "investment management 5"           => "altpoolt üles suunatud põhjalik uurimus",
    "investment management 6"           => "pikaajaline vaade",
    ...
    "our firm caption 2" => "Meie klientide finantsolukorra kaitsmiseks",
    "our firm caption 3" => "Rikastades meie kliente, meie inimesi ja meie kogukondi positiivsete panustega",
    "our firm caption 4" => "Näidates kaastunnet kogukonna vastu, samal ajal luues tugevaid suhteid meie kolleegidega.",
    ...
    "private wealth management 5" => "Meie oskus tegutseda teie ja teie pere hüvanguks usaldusisikuna või teostajana on meie teenuste keskmes.",
    "private wealth management 6" => "Pakume teile ja teie perele paindlikku tagatud krediiti isikliku laenu ja krediidiulatuste vormis.",
    "private wealth management 7" => "Investeerimise, planeerimise ja filantroopilised ressursid naistele, kes soovivad oma varandust mõistlikult investeerida.",
    ...
    "private equity 6" => "Ettevõtted, mis näitavad meie pühendumust distsiplineeritud investeerimisstrateegiale ja meie valmidust partnerlusteks erakordsete ettevõtetega.",
    ...
    "investment advisory 8"  => "Altpoolt üles suunatud põhjalikud uurimused",
    "investment advisory 9"  => "Investeerime strateegiatesse, mis prognoosivad iga potentsiaalse investeeringu väärtust põhjaliku põhjaliku analüüsi abil.",
    "investment advisory 10" => "Väärtuspõhine lähenemine",
    "investment advisory 11" => "Otsime strateegiaid, mis investeerivad väärtpaberitesse, mis kauplevad allpool meie hinnangulist sisemist väärtust*, pakkudes portfellile ohutusvaru.**",
    "investment advisory 12" => "Pikaajaline vaade",
    "investment advisory 13" => "Usume, et kõige usaldusväärsem viis atraktiivse investeeringutootluse saavutamiseks on mitte lasta ennast mõjutada lühiajalisest turu volatiilsusest ning kannatlikult oodata investeeringu väärtuse realiseerumist.",
    "investment advisory 14" => "Unikaalne riskipilt",
    "investment advisory 15" => "Usume, et teie finantsalase tervise suurim oht on kapitali püsiv kaotamine, mitte turu volatiilsus. Usume, et turu volatiilsus pakub võimalusi omandada kvaliteetseid varasid allahindlusega nende turuväärtusest.",
    "investment advisory 16" => "Distsipliin ja visadus",
    "investment advisory 17" => "Oleme kannatlikud investorid. Kui miski ei vasta meie investeerimiskriteeriumitele, hoiame sularaha ja meil on veendumus müüa, kui investeering enam ei paku vastuvõetavaid tootlusi riski suhtes.",
    "investment advisory 18" => "*Põhinedes meie analüüsil nii materiaalsetest kui ka ebamateriaalsetest teguritest, esindab sisemine väärtus meie arvates väärtpaberi väärtust. **Ohutusvara olemasolu tähendab, et meie arvates on ostuhetkel sisemise väärtuse suhtes märkimisväärne allahindlus – püüame osta võrdse hinnaga või alla 75% meie arvutatud sisemisest väärtusest.",

    // wealth planning
    "wealth planning 1"  => "Meie kogenud varaplaneerijad töötavad tihedas koostöös teie õigusnõustajate ja maksunõustajatega, et kujundada ja rakendada varade ja varade planeerimist, mis on juhitud teie isiklikest eesmärkidest ja väärtustest ning kooskõlas teie üldise investeerimisstrateegiaga. See integreeritud lähenemine võimaldab meil teile ette näidata sobivad planeerimisvõimalused, kui teie vara kasvab, teie pere muutub aja jooksul ja seadusandlik ja finantsmaastik muutub.",
    "wealth planning 2"  => "Varaplaneerimise nõustamisteenused",
    "wealth planning 3"  => "Isiklikud ja perekondlikud eesmärgid",
    "wealth planning 4"  => "planeerimine nii lähedaste kui ka pikaajaliste isiklike ja finantsiliste eesmärkide jaoks",
    "wealth planning 5"  => "perekondlik juhtimine ja järgmise põlvkonna haridus",
    "wealth planning 6"  => "perekondlike ettevõtete järglaskonna planeerimine",
    "wealth planning 7"  => "Varade ja varade planeerimine",
    "wealth planning 8"  => "maksuefektiivne varade üleandmise planeerimine",
    "wealth planning 9"  => "kindlustus ja likviidsuse planeerimine",
    "wealth planning 10" => "varade omand ja asukoht: perekonna usaldused, LLC-d ja partnerlused",
    "wealth planning 11" => "testamendi ja varade planeerimise kujundamine ja rakendamine",
    "wealth planning 12" => "tulumaksu planeerimine",
    "wealth planning 13" => "tähtajalise vara planeerimine",
    "wealth planning 14" => "Heategevuslikud huvid",
    "wealth planning 15" => "abi perekonnafondi kujundamisel, loomisel ja haldamisel",
    "wealth planning 16" => "nõustamine sobivate varade osas heategevuslike annetuste tegemiseks",
    "wealth planning 17" => "heategevuslike annetuste eesmärkide saavutamiseks sobivate heategevuslike vahendite tuvastamine",

    // philanthropic advisory
    "philanthropic advisory paragraph 1" => "Heategevus võib olla viis tagasi anda, teisi ja oma kogukonda aidata, oma perele eeskuju näidata või pärandi jätta. Kuna heategevus on nii isiklik ja ainulaadne igale inimesele ja perele, hõlmab see tavaliselt mitmeid kaalutlusi erinevatel teemadel, nagu missiooni sõnastamine, parima õigusliku struktuuri kindlakstegemine ja toetuse saajate valimine ning mõju hindamine.",
    "philanthropic advisory paragraph 2" => "Aitame oma klientidel käsitleda kõiki oma heategevusplaane ja eesmärke, olenemata sellest, kus nad oma heategevuslikul teekonnal asuvad, et nad saaksid oma põhjustele, kogukondadele ja lähedastele positiivse ja püsiva mõju avaldada.",
    "philanthropic advisory paragraph 3" => "Alustamine",
    "philanthropic advisory paragraph 4" => "Teekonna kaardistamine",
    "philanthropic advisory paragraph 5" => "Struktuur ja loomine",
    "philanthropic advisory paragraph 6" => "Nõuanded tegevuste struktureerimiseks lähtuvalt teie praegusest olukorrast ja teie heategevuse taga olevatest jõududest.",
    "philanthropic advisory paragraph 7" => "Juhtimine ja haldamine",
    "philanthropic advisory paragraph 8" => "Toetus sobiva juhtimiskorralduse, vastavuse ja muude halduspoliitikate ning -menetluste kindlakstegemisel.",
    "philanthropic advisory paragraph 9" => "Strateegia, elluviimine ja mõju",
    "philanthropic advisory paragraph 10" => "Juhised strateegilise heategevuse ja elluviimise kohta, sealhulgas strateegilise plaani koostamine, tõhusa meeskonna loomine, annetuste kujundamine ja mõju mõõtmine.",
    "philanthropic advisory paragraph 11" => "Üle annetamise",
    "philanthropic advisory paragraph 12" => "Abi teie heategevuse missiooni ühtlustamisel teie otseste seotustega heategevuslikes organisatsioonides.",
    ...
    "trust services 4"  => "usalduse ja varade haldus",
    "trust services 5"  => "testamendi täitmise rakendamine",
    "trust services 6"  => "usaldusisiku tulumaksu deklaratsiooni ettevalmistamine",
    "trust services 7"  => "Delaware usaldusteenused",
    "trust services 8"  => "fondi juhtimine ja haldamine",
    ...
    "private client lending 2"  => "Laenamine eraklientidele",
    "private client lending 3"  => "Hoiusteenused",
    "private client lending 4"  => "Valuutavahetus ja valuutareservi kontod",
    "private client lending 5"  => "Kodused ja rahvusvahelised elektroonilised rahakanded",
    "private client lending 6"  => "Modulaarsed laenuteenused",
    "private client lending 7"  => "Investeerimislimiidid",
    "private client lending 8"  => "Üleminekulaenud ja sildalaenud",
    "private client lending 9"  => "Muud isiklikud laenud",
    "private client lending 10" => "Tagatisega laenude eelised",
    "private client lending 11" => "Pakume soodsaid edasiantavaid intressimäärasid laenudele, mis on tagatud ulatuslikult omatavate ja vabalt kaubeldavate väärtpaberitega.",
    "private client lending 12" => "Finantsaruanded ja maksudeklaratsioonid pole piisavalt tagatud laenude korral vajalikud.",
    "private client lending 13" => "Klient võib maksuküsimuste või ajastusprobleemide tõttu soetada kinnisvaralaene.",
    "private client lending 14" => "Maksueelsete intresside deklareerimiseks või ajastamise probleemide lahendamiseks võivad kliendid eelistada väärtpaberite asemel neid laenata.",

    // center for women and wealth
    "center for women and wealth caption 1" => "Naiste ja varanduse keskus® (CW&W) on pühendunud naiste kaasamisele ja abistamisele varanduse loomise ja haldamise protsessides. Pakume naistele investeerimis-, planeerimis- ja heategevusressursse, mis pärinevad meie eraklientide aastakümnete pikkusest kogemusest. CW&W püüab luua isikliku ja veebipõhise kogukonna, kus naised saavad jagada oma kogemusi ja pakkuda juhiseid tulevastele naistele juhtidele.",
...
"center for women and wealth caption 3" => "CW&W on põnevil, et teha koostööd mõttekoja ja sotsiaalse ettevõtte New America algatuse Better Life Lab'iga. Better Life Lab on osaline rahvuslikus dialoogis soorollide ja normide, perepoliitika ning töö ja eluviisi arengu kohta. Nad kasutavad oma töös uurimusi, andmeid ja raporteerimist, et oma tööd juhtida ning edastada lugusid, mis motiveerivad, valgustavad ja inspireerivad muutusi.",
    ...
    "investment profile 5"  => "tugevad juhtimismeeskonnad ja investorid, kes jagavad meie huvisid.",
    "investment profile 6"  => "märkimisväärsed konkurentsieelised, kaitstud turupositsioonid ja laialdane tooteaktsepteerimine",
    "investment profile 7"  => "finantseerimisstruktuurid, mis sisaldavad piisavat veamarginaali",
    "investment profile 8"  => "investeerimishüpoteesid, mis on läbivaatuse käigus kontrollitavad",
    "investment profile 9"  => "tuvastatavad ostjad ka vähem soodsates töökeskkondades",
    "investment profile 10" => "Kuigi meil on peakontor Põhja-Ameerikas, võivad ettevõttel olla rahvusvahelised tegevused.",
    "investment profile 11" => "Investeeringu suurus:",
    "investment profile 12" => "10 miljonit kuni 125 miljonit dollarit",
    "investment profile 13" => "Märkimisväärselt suuremad summad investeeritakse kaasinvesteeringute ja piiratud partnerite abil.",
"investment profile 14" => "Tehingutüübid:",
    "investment profile 15" => "juhtimisväljaostud",
    "investment profile 16" => "arengualgatused",
    "investment profile 17" => "kapitali ümberkorraldused (sh dividendide tagastamine)",
    "investment profile 18" => "bilansi ümberkorraldused",
    "investment profile 19" => "omaniku ja põlvkondade vahetused",
    "investment profile 20" => "osta-ja-ehitada tehnikad",
    "investment profile 21" => "ühinemised ja tööstusharude konsolideerimine",
    "investment profile 22" => "Ettevõtte mõõtmine:",
    "investment profile 23" => "ettevõtte väärtus 10 miljonit kuni 500 miljonit dollarit",
    "investment profile 24" => "Struktuur:",
    "investment profile 25" => "mitmesugused väärtpaberid, mis võivad sisaldada aktsiaid, alamvõlakirju või nende kombinatsiooni",
    "investment profile 26" => "alamvõlakirjadesse investeerime ainult siis, kui oleme olulised aktsionärid.",
    "investment profile 27" => "Mittearvestatud:",
    "investment profile 28" => "Energiatooted, iduettevõtted, kinnisvara rahastamine, finantsasutused või maaklerid ning projektifinantseerimine.",
...
"investment strategy and transaction types 8" => "Me oleme ainus institutsionaalne investor, kellel on vähemusosalus omanik-juhitud ettevõttes; vastasel juhul oleksime märkimisväärne vähemusinvestor ettevõttes, kus on institutsionaalsed investorid, kes otsivad uut finantspartnerit:",
    "investment strategy and transaction types 9" => "Tavaliselt struktureerime investeeringud eelisseadete või tavaliste aktsiatena või aktsiate ja alamvõlakirjade kombinatsioonina.",
    "investment strategy and transaction types 10" => "Meie investeeringud on ideaalsed kapitali vajavatele eraettevõtetele või perefirma omanikele, kes soovivad säilitada majandusliku kontrolli.",
    "investment strategy and transaction types 11" => "Koostöö tegevjuhtide või investoritega:",
    "investment strategy and transaction types 12" => "Pere investeerimisbüroo või fondita sponsor, kellel on olemasolev portfelliettevõte või uus investeerimisvõimalus, mille jaoks on vaja peamist kapitalipakkujat, saab meilt aktsiate ja alamvõlakirjade kombinatsiooni.",
    "investment strategy and transaction types 13" => "Pakume kapitali tegevjuhtidele, et lõpule viia ettevõtte juhtimise või võimendatud väljaost, mille ettevõte või me ise oleme tuvastanud.",
    // select portfolio companies
    "select portfolio companies 1" => "Westrock Coffee Holdings",
    "select portfolio companies 2" => "Little Rock, AR",
    "select portfolio companies 3" => "Westrock Coffee Holdings pakub kohvi hankimise ja rahastamise, tarneahela juhtimise, röstimise, pakendamise ja jaotamise teenuseid.",
    "select portfolio companies 4" => "Precision Terminal Logistics",
    "select portfolio companies 5" => "Pittsburgh, PA",
    "select portfolio companies 6" => "Precision Terminal Logistics opereerib, ehitab ja omandab transloading terminalid üle kogu Ameerika Ühendriikide. PTLi terminalid pakuvad transpordiettevõtetele terviklikku logistikalahenduste komplekti, sealhulgas materjalide käitlemine, logistika- ja transloading-teenused, turvaline suuremahuline kauba ladustamine ning rajatiste ehitus.",
    "select portfolio companies 7" => "Bradford Airport Logistics",
    "select portfolio companies 8" => "Houston, TX",
        "select portfolio companies 9" => "Bradford Airport Logistics on juhtiv keskse vastuvõtu- ja jaotuskeskuse (CRDC) teenuste pakkuja USA kaubanduslikes lennujaamades. Need kõrgelt turvalised ajutised ladustamis- ja läbilaskevõimsused teenindavad kaupu, mis on mõeldud lennujaama järelturvalisuse, kuid enne lennukit asuvas osas.",
    "select portfolio companies 10" => "700 Valve Supply, LLC",
    "select portfolio companies 11" => "Stafford, TX",
    "select portfolio companies 12" => "700 Valve Supply on spetsialiseeritud tööstusklappide mesterdistribuutor MRO rakendusteks erinevates tööstus- ja energiaga seotud tööstusharudes. Ettevõte esindab tõhusalt oma tootjapartnerite tootesarju, samal ajal olles klientide jaoks väärtuslik ressurss, kasutades oma ülemat tehnilist klappide tundmist.",
    "select portfolio companies 13" => "Ethos Veterinary Health LLC",
    "select portfolio companies 14" => "Woburn, MA",
    "select portfolio companies 15" => "Ethos Veterinary Health LLC on üks suurimaid sõltumatuid erialase veterinaarmeditsiini tervishoiuteenuste pakkujaid, näiteks erakorraline abi 24 tundi päevas, seitse päeva nädalas, kirurgilised protseduurid, radioloogiateenused ja sisemeditsiin.",
    "select portfolio companies 16" => "Noble Systems Corp.",
    "select portfolio companies 17" => "Atlanta, GA",
    "select portfolio companies 18" => "Noble Systems Corporation arendab, turustab ja pakub toetust tarkvarapõhistele tootlikkusvahenditele, mida kasutatakse tarnekeskustes tarbijatevaheliste suhtluse, sealhulgas suhtlemise vahel tarnekeskuse agentide ja isikute vahel telefoni, e-posti, teksti, jututoa ja veebi kaudu.",
    "select portfolio companies 19" => "Utility Pipeline, Ltd.",
    "select portfolio companies 20" => "Canton, Ohio",
    "select portfolio companies 21" => "Utility Pipeline, Ltd. on loodusliku gaasi ja sellega seotud teenuste pakkujaid Ohio, Pennsylvania, Indiana, Virginia ja West Virginia maapiirkondades ja eeslinnades.",
    "select portfolio companies 22" => "American Physician Partners",
    "select portfolio companies 23" => "Brentwood, Tennessee",
    "select portfolio companies 24" => "American Physician Partners pakub erakorralise osakonna ja haiglakujulise administratsiooniteenuseid meditsiini- ja kirurgilistele haiglatele Ameerika Ühendriikides.",
    "select portfolio companies 25" => "Haven Behavioral Healthcare, Inc.",
    "select portfolio companies 26" => "Nashville, Tennessee",
    "select portfolio companies 27" => "Haven Behavioural Healthcare, Inc. on käitumisravi ettevõte, millel on seitsmest erialahaiglast koosnev võrgustik, mis on peamiselt keskendunud täiskasvanute ja geriaatriliste patsientide depressiooni, ärevuse, psühhoosi ja muude raskete käitumisprobleemide ägeda sümptomaatika stabiliseerimisele ja ravile.",
    "select portfolio companies 28" => "PrimeRevenue, Inc.",
    "select portfolio companies 29" => "Atlanta, GA",
    "select portfolio companies 30" => "PrimeRevenue, Inc. on pilvepõhiste finantstarnete ahela optimeerimise lahenduste pakkuja rahvusvahelistele korporatsioonidele.",
    "select portfolio companies 31" => "EdgeConneX, Inc.",
    "select portfolio companies 32" => "Herndon, VA",
    "select portfolio companies 33" => "EdgeConneX, Inc. on IaaS (infrastruktuur-teenusena) pakkumise spetsialist, mis on spetsialiseerunud andmekeskuste ja võrguühenduse teenustele.",
    "select portfolio companies 34" => "Microban International, Ltd.",
    "select portfolio companies 35" => "Huntersville, NC",
    "select portfolio companies 36" => "Microban International, Ltd., Inc. on turuliider kõrgtehnoloogiliste, kaubamärgiga antimikroobsete koostisosade lahenduste arendamisel, insenerinduses, testimises ja propageerimises tarbijatele, tööstustoodetele ja meditsiinitoodetele.",
    
    // center for family business
    "center for family business 1" => "Kuidas saab edukalt juhtida, laiendada ja üle anda ettevõtet, samal ajal hoolitsedes pere ja selle pärandi eest? Oleme aidanud suurt hulka pereettevõtteid, kes tegelevad selle igivanase küsimuse lahendamisega. Olgu meie kliendid pereettevõtte algatajad või järgmise põlvkonna omanikud, seisavad nad silmitsi keeruka küsimuste kogumiga, mis on unikaalsed nii pere kui ka pereettevõtte omandi seisukohalt, vastavalt meie kogemusele.
                                        <br><br>
                                        Pereettevõtte keskuse missioon on aidata pereettevõtetel ja nende omanikel saavutada oma eesmärgid ning tegeleda pere ja äri ristumiskohas esile kerkinud küsimustega. Pakume pereettevõtetele nõuandeid, teadmisi ja ressursse mitmesugustel teemadel, mis puudutavad pereettevõtte omandit, lähtudes meie aastatepikkusest sügavatest teadmistest ja vastutustundlikust suhtumisest institutsiooni juhtimisse, mis sai alguse üle kaks sajandit tagasi pereettevõttena. Meie peamiste huvide hulka kuuluvad järgmised aspektid:
                                        <br><br>",
    "center for family business 2" => "Pärandi määratlemine ja ettevõtte tulevik",
    "center for family business 3" => "Lisateave selle kohta, kuidas aitame klientidel määratleda oma visiooni, säilitada pärandit, kujundada ettevõtte tulevikku ja arendada pere eesmärke.",
    "center for family business 4" => "Toetustiimi loomine",
    "center for family business 5" => "Lisateave selle kohta, kuidas aitame klientidel tuvastada, hinnata ja tugevdada nende usaldusväärsete nõustajate meeskondi.",
    "center for family business 6" => "Pärimiskava - juhtimine ja omand",
    "center for family business 7" => "Lisateave selle kohta, kuidas aitame klientidel ette valmistuda juhtimise ja omandi vahetuseks.",
    "center for family business 8" => "Kapitalipoliitika",
    "center for family business 9" => "Lisateave selle kohta, kuidas aitame klientidel määrata kapitalipoliitikat, mis tasakaalustab ettevõtte ja pere vajadusi.",
    "center for family business 10" => "Tööpoliitika",
    "center for family business 11" => "Lisateave selle kohta, kuidas aitame klientidel välja töötada perele sõbralikke tööpoliitikaid.",
    "center for family business 12" => "Valitsemine ja suhtlus",
    "center for family business 13" => "Lisateave selle kohta, kuidas aitame klientidel luua ja parandada formaalseid juhtimis- ja suhtluskonstruktsioone nende ettevõtete ja perekondade jaoks.",
    "center for family business 14" => "Jaotused ja pere likviidsus",
    "center for family business 15" => "Lisateave selle kohta, kuidas aitame klientidel kehtestada tulu jaotamise poliitikaid, aktsiate ülekandeid ja lunastamisi ning tootlusoootuste kommunikatsiooni.",
    "center for family business 16" => "Konkureerivate huvide tasakaalustamine",
    "center for family business 17" => "Lisateave selle kohta, kuidas aitame klientidel luua raamistikke ja protseduure konkureerivate ärihuvide harmoneerimiseks.",
    // corporate advisory
    "corporate advisory 1" => "Corporate Advisory meeskond koosneb vanematest ettevõtte rahanduse ekspertidest, kellel on ulatuslik kogemus koostööst ettevõtte omanike juhtidega M&A ja finantseerimise tehingute osas. Oleme pühendunud objektiivsele ja teostatavale nõustamisele, et aidata meie klientidel saavutada nende ainulaadsed ärilised ja isiklikud eesmärgid. Meie peamised teenused hõlmavad:",
    "corporate advisory 2" => "Abi ettevõtte ja pere/omanike eesmärkide tasakaalu saavutamisel",
    "corporate advisory 3" => "Oluliste ettevõtte väärtuse määramise tegurite kindlaksmääramine",
    "corporate advisory 4" => "Strateegiliste võimaluste ja laienemisalgatuste hindamine",
    "corporate advisory 5" => "Korraldame ettevõtte nõustajate tuvastamise ja valiku",
    "corporate advisory 6" => "Abi sobivate kapitalipakkujate tuvastamisel ja hindamisel",
    ...
    // balancing
    "balancing 1" => "Perekondlikud ettevõtted on unikaalsed selles mõttes, et perekond on üks peamisi osapooli, samas kui enamus ettevõtteid seisab mingil hetkel silmitsi väljakutsega tasakaalustada vastastikku konkureerivaid osapoolte huve. Kuigi vastanduvad huvid võivad olla vältimatud, on oluline luua protokoll nende käsitlemiseks ja suhtlemise edendamiseks kõigi asjaomaste osapoolte vahel, et probleeme lahendada. Kui üksmeelele ei jõuta, võib väljastpoolt osapoolte kaasamine arutelude hõlbustamiseks ja objektiivse nõuandjana tegutsemiseks viia lahenduseni.
                        <br><br>
                        Aidates perekondlikke ettevõtteid vastastikku konkureerivate huvidega tegelemisel, arutame järgmist:
                        <br><br>",
    "balancing 2" => "Kuidas lahendatakse tavaliselt perekondlikud vaidlused seoses ettevõtte omandi ja/või juhtimisega?",
    "balancing 3" => "Millised vahendamistehnikad on välja töötatud konfliktide lahendamiseks?",
    "balancing 4" => "Milliseid samme on perekond astunud kolmandate osapoolte kaasamiseks konfliktide lahendamiseks ja suhtluse ning otsuste tegemise hõlbustamiseks?",
    "balancing 5" => "Eraettevõtte juhtimise dünaamika: vestlus Kerry Sulkowicz, M.D.-ga, Boswell Group'i asutajaga",
    "balancing 6" => "Selles Owner to Owneri väljaande artiklis arutleb Boswell Group'i asutaja Kerry Sulkowicz, M.D. ettevõtte juhtidele esile kerkivate väljakutsete üle, juhtimise keerukusest era- ja perekondlikes ettevõtetes ning parimate juhtide seas täheldatud ühistest tunnustest.",
...
"building 4" => "Kuidas saavad ettevõtjad tuvastada isikud, kes suudavad pakkuda mitmekülgset vaatenurka neile endile, nende perekonnale ja nende ettevõttele?",
"building 5" => "Millised on nõustajate huvid? Kas tasu kokkulepped on hästi mõistetavad?",
...
"building 7" => "Milliseid teenusepakkujaid on ettevõtjad palganud abi saamiseks nii oma ettevõtete kui ka perekondade juhtimisel?",
    ...
    "capital 1" => "Kapitalipoliitikad on igas organisatsioonis oluline osa. Need poliitikad käsitlevad olulisi küsimusi perekondlikele ettevõtetele, näiteks kapitali jaotamist, omakapitali kaasamise lubatavust ja sellega kaasnevat omandi lahjendamist, finantsvõimendust, aktsiate müümist ja tagasiostmist ning aktsionäride väljamakseid. Kui kapitali pakkuja ja perekondlike ettevõtete nõustajana enam kui kahe sajandi vältel ning ise eraettevõttena, on Sunriseil ulatuslik kogemus koostööst perekondlike ettevõtetega nende poliitikate kujundamisel.
                    ...
                    <br><br>",
    "capital 2" => "Kui sageli peaks ettevõtte kapitalinõudeid hindama? Kes vastutab selle protsessi eest sisemiselt?",
    "capital 3" => "Kuidas ettevõte teavitab perekonna omandigruppi oma kapitalinõuetest?",
    "capital 4" => "Kuidas on see protseduur seotud perekonna väljamaksete planeerimisega?",
    // defining
   "defining 1" => "Paljud edukad pered loovad pärandi. Peredes, kes juhivad mitmepõlvkondlike perekondlike ettevõtete tegevust, kultiveeritakse pärandit sageli, seda parandatakse ja see pärandatakse edasi järgmisele põlvkonnale. Perekondlike ettevõtete omanike jaoks tähendab pärand rohkemat kui lihtsalt pere liikme olemist. See hõlmab ka rolli, mida perekondlik ettevõte mängib oma töötajatele ja kogukondadele, kus see tegutseb.
                    <br><br>
                    Me töötame koos oma klientidega, et aidata neil arvestada kõige asjakohasemate küsimustega seoses nende pärandi ja ettevõtte tulevikku defineerimisega, näiteks:
                    <br><br>",
    "defining 2" => "Milline on praeguse põlvkonna visioon ettevõtte tulevaste põlvkondade suhtes? Kas praegune ja tulevased põlvkonnad on sellega visiooniga nõus?",
    "defining 3" => "Mis on perekondliku ettevõtte eesmärk/eesmärged? Miks kuulub ettevõte perekonnale?",
    "defining 4" => "Mis on peamised eesmärgid perekondliku ettevõtte säilitamisel? Kas see on perekonna pärandi loomine või säilitamine? Töökohtade loomine? Õitsengu loomine? Kogukondade toetamine, kus ettevõte tegutseb?",
    "defining 5" => "Kuidas suhtutakse mitte-perekondlikku omandusse või juhtimisse?",
    ...
    "distributions 1" => "Paljudel perekondlikel ettevõtetel on mitte-töötavat perekonnaliiget, kes omavad aktsiaid. Seetõttu on oluline luua ja edastada poliitikaid likviidsuse loomiseks aktsionäride jaoks. Perekonna aktsionärid soovivad teada, kas nad saavad väljamakseid ja kas nad saavad oma aktsiaid lunastada või üle kanda. Samuti soovivad nad öelda sõna aktsiaomandi sisemiste tootlusoootuste osas. Edukad ettevõtted kiidavad sageli pikaaegse omandi eeliseid perekonnaliikmetele ning kannatliku kapitali väärtuse suurendavat mõju ettevõttele ja perekonnale aja jooksul. Kui juba sajandeid kestnud eraettevõte on Sunrise, siis mõistab ta kapitali taasinvesteerimise ja omanike tootluse delikaatset tasakaalu.
                            ...
                            <br><br>",
    "distributions 2" => "Kuidas on perekonna ootused määratletud tootluse ja väljamaksete osas? Kas peres on üksmeel?",
    "distributions 3" => "Milline mehhanism on loodud aktsiate korrapäraseks lunastamiseks? Kuidas hinnatakse aktsiaid ja kui sageli seda tehakse?",
    "distributions 4" => "Millist rolli mängib perekond perekondliku ettevõtte võla tasemete, riskiparameetrite jne määramisel?",
    "distributions 5" => "Kas praegused juhid arutavad likviidsust kõigi aktsionäridega avatud aruteluna?",
    // employment
    "employment 1" => "Kõigil teatud suurusega ettevõtetel peaksid olema tööhõivepoliitikad. Perekondlike ettevõtete tööhõivepoliitikad, eriti suurte mitmepõlvkondlike perekondade omanduses olevatel ettevõtetel, on nüansirikkamad. Perekonnaliikmed, kes ettevõttes töötavad, ja tingimused, mille alusel nad seda teevad, on oluline tegur, mida perekondlikud ettevõtted peavad arvestama. Sobiva poliitika kehtestamine ettevõtte ja pere jaoks ning selle edastamine viib parimate kandidaatide värbamiseni iga ametikoha jaoks. See soodustab teadlikkust sellest, mida ettevõttes töötamiseks ja selles edukaks olemiseks vaja on.
                        <br><br>
                        Me töötame koos perekondlike ettevõtte klientidega nende töökorralduste hindamisel ja vastame hulgale põhilistele tööhõivepoliitika küsimustele, sealhulgas:
                        <br><br>",
    "employment 2" => "Kes teeb otsuseid perekonnaliikmete töölevõtmise ja/või edutamise osas ning milliseid kriteeriume kasutatakse? Millised on perekonnaliikmete töölevõtmise poliitikad?",
    "employment 3" => "Milline mehhanism on olemas siiraste tagasiside andmiseks ja vastuvõtmiseks perekonnaliikmete vahel?",
"employment 4" => "Kuidas pereliikmed on värvatud, koolitatud ja koheldud töötajatena? Kas on määratud juhendajad?",
    // governance
    "governance 1" => "Aastate jooksul õitsevate perekondlike ettevõtete aktsionäride arv, kes on pärit erinevatest põlvkondadest, kipub suurenema. Sageli ei tööta enamik aktsiaid omavatest perekonnaliikmetest ettevõttes. Siiski on paljud neist kui perekonnaliikmetest ja aktsionäridest huvitatud ettevõtte seisukorrast. Lisaks on neil õigus saada aktsionärina teavet oma osaluse kohta ja ettevõtte tulemuslikkuse kohta. Seetõttu on oluline suhelda ka nende perekonnaliikmetega, kes ei kuulu ettevõtte organisatsiooni. Paljud perekondlikud ettevõtted otsivad objektiivset välist nõu kolmandatelt osapooltelt või perekonnaliikmetelt ning moodustavad nõuandvaid perekonnakoosolekuid või juhatuse liikmetest nõukogusid. Erapooletu nõu saamise eelis mitte ainult ei paranda suhtlust perekonnaaktsionäride ja ettevõtte vahel, vaid võib samuti kaasa tuua suurema tootlikkuse ja rahulolu.
                        <br><br>
                        Me töötame perekondlike ettevõtetega, et arendada nende suhtlemise ja juhtimise struktuure ning palume neil arvestada mitmete oluliste küsimustega, näiteks:
                        <br><br>",
    "governance 2" => "Kes määrab juhatuse liikmete koosseisu? Kuidas juhatuseliikmeid valitakse, värvatakse ja volitatakse? Kuidas juhatuseliikmed suhtlevad pereomanikega?",
    "governance 3" => "Milliseid kaalutlusi on omanikud teinud perekonnanõukogu (ja võimaliku perekonnaassamblee) loomiseks, et korraldada perekonna omandit ja võimalikult esindada perekonda juhatuses?",
    "governance 4" => "Milline on ettevõtte info jagamist reguleeriv kommunikatsioonipoliitika perekonna sees ja väljas?",
    "governance 5" => "Kas perekond korraldab regulaarselt perekonna koosolekuid? Kes määrab osalejad?",
    "governance 6" => "Kuidas kaasatakse ettevõttesse perekonnaliikmeid, kes praegu ei tööta?",
    // succession
    "succession 1" => "Enamik kauakestvaid ettevõtteid arutab ja planeerib juhtimise järgnevust. See teema võib olla eriti oluline perekondlikele ettevõtetele, eriti kui juhtkond peab valima mitme perekonnaliikme ja mitteliikme vahel tulevase tegevjuhina. Perekondlikele ettevõtetele on juhtimise järgnevuse planeerimine tavaliselt keerulisem, kuna see peab tasakaalustama eduka plaani väljakutsed perekonnaettevõtte iseloomulike perekondlike dünaamikatega.
                        <br><br>
    ...
    "succession 4" => "Milliseid vestlusi on peetud järgmise põlvkonnaga seoses ettevõtte juhtimise ja/või omandiõigusega? Kuidas kvalifitseeritakse perekonnaliikmeid juhirollidele?",
    "succession 5" => "Kuidas tehakse otsuseid juhtimise järgnevuse kohta? Kas nii perekonna- kui mitteperekondlikud juhid on menetlusega kursis?",
    "succession 6" => "Kas on olemas meetod tulevaste põlvkondade omanike/juhid koolitamiseks ja väljaõpetamiseks?",
    "succession 7" => "Millised reeglid reguleerivad aktsiaomandit ja omandi ülekandeid?",
...
Me usume, et keskkonna-, sotsiaal- ja juhtimiskriteeriumide (ESG) kaasamine meie investeerimisprotsessi parandab meie võimet riski juhtida ja saavutada pikaajalisi eesmärke. Usume, et keskkonna-, sotsiaal- ja juhtimiskriteeriumid on meie aktsiate ja võlakirjade investeerimisprotsesside lahutamatu osa.
                            <br><br>
Meie investeerimisstrateegias on ESG kriteeriumid selgelt arvesse võetud ja neid juhib kogum põhimõtteid, mis kehtivad meie investeerimisportfellide kogu ulatuses. Koos moodustavad need usaldusväärse strateegia, mis on taganud pikaajalised kliendisuhted ja eristanud meid konkurentidest.
                            <br><br>",
    "esg approach 2" => "Meie investeerimise põhimõtted:",
    "esg approach 3" => "keskenduda varade säilitamisele",
    "esg approach 4" => "teostada põhjalikku uurimust, keskendudes põhjalikule analüüsile",
    "esg approach 5" => "investeerida pikaajalise väljavaatega",
    "esg approach 6" => "olla otsusekindel ja kannatlik",
    "esg approach 7" => "rakendada väärtuspõhist strateegiat",
    "esg approach 8" => "ESG tegurite hindamine meie investeerimisuuringute protsessi osana võimaldab meil tõhusalt hinnata meie ettevõtete ja krediiditööde pikaajalist jätkusuutlikkust ja vastupidavust:",
    "esg approach 9" => "Keskkondlik - organisatsioonid, kes on säästlikud ressursside kasutamisel, teadlikud kliimariskidest ja piisavalt teadlikud oma keskkonnamõjust, võivad saavutada efektiivsuse, mis aitab kaasa nende kasumlikkusele. Neil on vähem tõenäoline tekkida ettenägematuid kohustusi, mis võivad vähendada ettevõtte väärtust.",
    "esg approach 10" => "Sotsiaalne - kõrgete standardite säilitamine sise- ja väliskäitumises võib aidata organisatsioonidel luua tugeva kultuuri, mis toob kõigile sidusrühmadele paremaid pikaajalisi tulemusi ja piirab negatiivset reguleerivat tegevust.",
    "esg approach 11" => "Juhtkonna kvaliteedi, juhtimisstruktuuride ja reeglite, tavade ja stiimulite raamistiku analüüsimine on pikaajalise jätkusuutlikkuse olulised osad. Meie vaade on, et hästi juhitud ettevõtted, kelle juhtkonnad käituvad omanikena, on tõenäolisemalt ressursse tõhusalt juhtida, luua pikaajaline väärtus aktsionäridele, kaitsta võlausaldajate õigusi ja säilitada juurdepääs krediiditurgudele. Need on ettevõtete olulised omadused, mida me valime oma klientide huvides omada.",
    "esg approach 12" => "ESG integreerimine: meie põhjaliku lähenemise oluline osa:",
    "esg approach 13" => "Meie umbes 50-liikmeline aktsiate ja võlakirjade investeerimisprofessionaalide meeskond vastutab kriitiliste ESG kriteeriumide integreerimise eest meie investeerimisanalüüsi ja otsuste tegemise protsessi.",
    ...
    "fixed income 2" => "Meie investeerimise eetika põhineb järgmistel juhtpõhimõtetel:
                            ...
                            <br>
                            • Krediidihinnangute volatiilsus ületab nende aluseks olevate aluspõhimõtete põhjendatust, luues soodsa keskkonna aktiivseks haldamiseks.
                            <br>
                            • Me usume, et ülimad tootluste saamiseks on vaja kannatlikku ja pikaajalist lähenemist.",
    "fixed income 3" => "Meie strateegia keskendub võlakirjade emiteerijatele olulistes turusektorites, näiteks:
                            <br>
                            • Ettevõtete võlakirjad
                            <br>
                            • Investeerimine varaga tagatud väärtpaberitesse
                            <br>
                            • Investeeringud kommertshüpoteegi tagatud väärtpaberitesse
                            <br>
                            • Omavalitsuste kohustused
                            <br>
                            • Inflatsiooniindeksiga seotud väärtpaberid
                            <br>
                            • Föderaalasutused
                            <br>
                            • Asutuse tagatud hüpoteekvõlakirjad
                            <br>
                            • USA riigivõlakirjad",
    "fixed income 4" => "Iseseisev krediidiuuring, mis tuvastab erakordse väärtuse fikseeritud sissetuleku sektorites.",
    "fixed income 5" => "Altpoolt üles ehitatud krediidiuuring, mille eesmärk on tuvastada USA omavalitsuste võlakirjaturu alamsektorid tugeva väärtusega.",
    ...
    "public equity 2" => "Meie juhendavad põhimõtted hõlmavad:
                     ...
                     <br>
                     • Ostmise ajal tuleb investeeringud soetada allahindlusega meie sisemise väärtuse hinnangule (nt ohutusmarginaal aktsia hinnas).
                     <br>
                     • Investeerida väikesesse ettevõtete arvu, et minimeerida ettearvamatute ettevõttespetsiifiliste probleemide mõju, ja investeerida ainult ettevõtetesse, mis vastavad rangetele äri- ja hindamiskriteeriumitele.
                     <br>
                     • Mõelda nagu omanikud ja administraatorid, hoides osalusi ettevõtetes pikka aega, et suurendada rikkust ja vähendada tehingukulusid.",
    ...
    "global equity 4" => "Äriomadused",
    "global equity 5" => "Olulised kaubad ja teenused",
    "global equity 6" => "Lojaalsed kliendid",
    "global equity 7" => "Juhtiv positsioon kasumlikus tööstuses või turusegmendis",
    "global equity 8" => "Jätkusuutlikud konkurentsieelised",
    "global equity 9" => "Juhtimisomadused",
    "global equity 10" => "Tugevad juhid, kellel on moraalne iseloom",
    "global equity 11" => "Soosivad kapitali jaotused",
    "global equity 12" => "Oluline osaluse omamine",
    ...
    "us large cap equity 5" => "Olulised kaubad ja teenused",
    "us large cap equity 6" => "Lojaalsed kliendid",
    "us large cap equity 7" => "Juhtiv positsioon kasumlikus turusegmendis või tööstuses",
    "us large cap equity 8" => "Jätkusuutlikud konkurentsieelised",
    "us large cap equity 9" => "Juhtimisomadused",
    "us large cap equity 10" => "Tugevad juhid, kellel on moraalne iseloom",
    "us large cap equity 11" => "Soosivad kapitali jaotused",
    "us large cap equity 12" => "Oluline osaluse omamine",
    "us large cap equity 13" => "Finantsomadused",
    ...
    "us small and mid cap equity 1" => "Sunrisei Small-to-Mid-Cap Equity investeerib valitud arvule ebasoodsas olukorras ja/või vähe jälgitavatele väike- ja keskmise turuväärtusega ettevõtetele ilma võimendust kasutamata või lühikeseks müümata. Strateegia investeerib tavaliselt kaheksasse kuni viieteistkümnesse ettevõttesse, mille hoidmisperiood on kolm kuni viis aastat. Investeeringud müüakse tavaliselt siis, kui nende hinnatõus ületab nende sisemise väärtuse hinnanguid.
                                   ...
                                   <br><br>",
    "us small and mid cap equity 2" => "Investeerimiskriteeriumid",
    "us small and mid cap equity 3" => "Usume, et ettevõtted, kellel on järgmised äri-, juhtimis-, finants- ja hindamisomadused, on hästi positsioneeritud aktsionäride väärtuse loomiseks olenemata majanduslikust ja turuolukorrast.",
    "us small and mid cap equity 4" => "Äriomadused",
    "us small and mid cap equity 5" => "Olulised kaubad ja teenused",
    "us small and mid cap equity 6" => "Suurepärane klientide lojaalsus",
    "us small and mid cap equity 7" => "Jätkusuutlikud konkurentsieelised",
    "us small and mid cap equity 8" => "Kõrged korduvad tulud",
    "us small and mid cap equity 9" => "Kõrged kapitali tootluse määrad",
    "us small and mid cap equity 10" => "Juhtimisomadused",
    "us small and mid cap equity 11" => "Tugevad juhid, kellel on moraalne iseloom",
    "us small and mid cap equity 12" => "Soosivad kapitali jaotused",
    "us small and mid cap equity 13" => "Finantsomadused",
    ...
    "tax exempt fixed income strategy 5" => "Ülim turupositsioon",
    "tax exempt fixed income strategy 6" => "Finantsstabiilsus",
    "tax exempt fixed income strategy 7" => "Tugev käitumismudel hinnakujunduse paindlikkusega",
    "tax exempt fixed income strategy 8" => "Toetatud kontrollitud tulude allikaga",
    "tax exempt fixed income strategy 9" => "Tugev katvus ja võlakirjade turvalisus",
    "tax exempt fixed income strategy 10" => "Ajakohased rahalised esitused",
    "tax exempt fixed income strategy 11" => "Kui asjakohane, kaalume ka järgmisi juhtimisomadusi:",
    "tax exempt fixed income strategy 12" => "Poliiitiline tahe intresside sõltumatuse harjutamiseks",
    ...
    "taxable fixed income strategies 5" => "Lähtuda pikaajalisest lähenemisviisist",
    "taxable fixed income strategies 6" => "Edendada läbipaistvuse, protsessi distsipliini ja avatud arutelu kultuuri",
    "taxable fixed income strategies 7" => "Investeerimiskriteeriumid",
    "taxable fixed income strategies 8" => "Ehitame meie maksustatavaid fikseeritud tulumääraga portfelle võlakirja haaval, filtreerides turu potentsiaalselt veenvate väärtuste jaoks kasutades põhjalikku analüüsi ja unikaalset hindamisraamistikku. Seejärel ostame krediiti turvalisuse marginaaliga*, mis varieerub võlakirja tüübi ja reitingu järgi ning määratleb hinna amordumise, millest me arvame, et see määratleb pikemas perspektiivis atraktiivse hinna võlakirjale, arvestades krediiditurul tsüklilisust. Kordame oma investeerimisprotsessi, et ehitada vastupidavate krediitide portfelle, mis kauplevad atraktiivsete tootlustega.",
    "taxable fixed income strategies 9" => "Püüame osta vastupidavaid krediite, mis vastavad järgmistele investeerimiskriteeriumidele:",
    "taxable fixed income strategies 10" => "Vastupidavus",
    "taxable fixed income strategies 11" => "Nõuame, et meie portfellides olevatel emiteerijatel oleks vastupidav tulu mudel ja/või tagatis. Hindame ka ettevõtte võimet vastu seista erinevatele reguleerimisstsenaariumidele ja majandusšokkidele.",
    "taxable fixed income strategies 12" => "Läbipaistvus:",
    "taxable fixed income strategies 13" => "Emiteerija peab toimima ärimudelil ja finantstruktuuril, mida me saame tuvastada ja mõista. Mida keerulisem on ärimudel või ebausutavam kapitali struktuur, seda vähem tõenäoline on, et me emiteerijasse investeerime.",
    "taxable fixed income strategies 14" => "Juhtimine",
    "taxable fixed income strategies 15" => "Tugev juhtimine on vastupidava krediidilisuse määramisel kriitiline, ja me tuvastame juhtimismeeskonnad, kes hoiavad tasakaalustatud lähenemisviisi kõikidele kapitali pakkujatele.",
    "taxable fixed income strategies 16" => "Struktuur:",
    "taxable fixed income strategies 17" => "Emiteerija võime genereerida piisavat sisekapitali toetamaks tema kapitali struktuuri on kriitiline. Kinnitame, et emiteerija ei kanna liigset võlga, arvestades rahavoogude aluseks olevat volatiilsust, ega toetu liigselt kapitaliturgudele rahastamiseks.",
    "taxable fixed income strategies 18" => "* Me usume, et turvalisuse marginaal eksisteerib siis, kui me suudame leevendada nii äririski (meie äri-, finants- ja juhtimiskriteeriumid on täidetud; olemas on jätkusuutlikud konkurentsieelised) KUI KA hinnariski (kui me usume, et ostuhetkel on märkimisväärne allahindlus sisemisele väärtusele <br>
                                         - me püüame osta 75% meie sisemise väärtuse hinnangust või vähem). <br>
    ...
    "us tips strategy 5" => "Kasutades eksklusiivseid kvantitatiivseid mudeleid, püüab meie investeerimismeeskond tuvastada reaalsete määra tasemeid ja kurvisid, mis võivad olla ajalooliselt kooskõlastamata praeguste majanduslike alustega. Perioodiliselt määrab see analüüs ja meie investeerimismeeskonna ekspertiis indeksi suhtes mõõduka kestuse või tootluskõvera positsioonid.",
    "us tips strategy 6" => "Mitte-direktiivsed metoodikad:",
    "us tips strategy 7" => "Meie uurimistöö on tuvastanud mitmeid püsivaid ja korduvaid ebatõhususi USA TIPS turul ning meie investeerimismeeskond paigutab sageli meie portfelli, et saada neist ebatõhusustest tulenevat suhtelist ülejäägitootlust. Oksjonitsüklid, hooajalised mustrid, jõudluse indeksi laiendused, inflatsiooniakrualid ja allalõikepõhi on nende turuebatõhususte panustajad.",
    "us tips strategy 8" => "Oportunistlikud strateegiad:",
    "us tips strategy 9" => "Need strateegiad hõlmavad USA riigivõla turu ja välismaiste riikide inflatsioonindeksiga turgude indeksivälist positsiooni.",
    ...
    "custody & fund services 1" => "Sunrise pakub varahaldusteenuste lahenduste komplekti, mis on mõeldud institutsionaalsetele klientidele rahvusvaheliste investeeringute teostamiseks ja navigeerimiseks. Spetsialiseerudes uutele ja keerukatele valdkondadele, oleme võitnud maailma kõige keerukamate varahaldajate usalduse, tagades õigeaegse arvelduse, täpse hoiustamise ja aruandluse ning veatud keerukate fondide ja varatüüpide halduse.
                                        ...
                                        <br><br>
Kliendid saavad kasu meie globaalsest teenusmudelist ja integreeritud tehnoloogiaplatvormist, mis on loodud mõõdetavalt ülemaailmse kliendikogemuse tagamiseks ning tagab 100% kliendirahulolu.",
    "custody & fund services 2" => "Tagades õigeaegse arvelduse, täpse hoiustamise ja aruandluse meie ülemaailmsele kliendibaasile.",
    "custody & fund services 3" => "Pakume põhjalikke hoiustamisteenuseid Luxembourg, Iiri, Kaimanisaarte ja Hongkongi päritoluga fondidele.",
    "custody & fund services 4" => "Toetame keerukaid investeeringutüüpe, tasude arvutamist ja teenindusmudeleid mitmesuguste fondide päritolumaades ja -jurisdiktsioonides.",
    "custody & fund services 5" => "Pakume ulatuslikku haldusteenuste komplekti, mis toetab meie klientide vajadusi paindliku lähenemisviisiga.",
    ...
    "specialist expertise 1" => "Sunrise keskendub spetsialiseerunud ekspertteadmise pakkumisele, et saavutada sügavamad ja püsivamad suhted klientidega valdkondades, kus me arvame, et saame kõige rohkem väärtust lisada.
                                    ...
                                    <br><br>
                                    Meie eksperdid lisavad reaalset väärtust seal, kus see loeb, olgu selleks parem järelevalve nõu, kiirem aeg uute toodete turule toomiseks, operatiivlahendused, mis viivad madalamate muutuvkuludeni, või uuenduslikud tehnoloogialahendused, mis viivad madalamate fikseeritud kuludeni.
                                    <br><br>
                                    Töötame klientidega selle nimel, mis neile kõige rohkem oluline on, et aidata neil eristuda ja kasvatada oma äri üha enamastumisel olevas turukeskkonnas.",
    "specialist expertise 2" => "Töötame koos ülemaailmsete varahaldajatega nende globaalsete investeerimiseesmärkide ja üle piiri laienemise eesmärkide saavutamiseks.",
    "specialist expertise 3" => "Töötame koos varahaldajatega, et pakkuda kõikehõlmavaid moodulil põhinevaid lahendusi USA fondidele, mis vastavad nende arenevatele vajadustele keskmises ja tagumises kontoris.",
    "specialist expertise 4" => "Koostöö partneritega klientide paremaks teenindamiseks.",
    "specialist expertise 5" => "Pakkudes jaotusintelligentsust, et aidata varahaldajatel välja töötada ja ellu viia jaotusstrateegiaid.",
    "specialist expertise 6" => "Pakkudes põhjalikke fonditeenuseid kõigile peamistele alternatiivsetele varaklassidele ja strateegiatele.",
    "specialist expertise 7" => "Töötame koos erineva taustaga varahaldajatega, et tutvustada ja haldada globaalseid ja piirkondlikke ETF-tooteid.",
    ...
    "depositary & trustee 2" => "Sunrise rakendab riskipõhist, pidevat järelevalve- ja jälgimis lähenemist. Põhjalik hindamine fondi strateegia ja fondihalduri organisatsiooni olemuse, ulatuse ja keerukusega seotud riskide kohta määrab järelevalveprotseduuride kohase ulatuse ja sageduse, mida rakendatakse.
                            ...
                            <br><br>
                            Osaledes aktiivselt erinevates hoiustajate tööstuse foorumites ja töörühmades, saame tõlgendada reguleerivate nõuete ja turuinformatsiooni teadmisi praktilisteks teadmisteks, et aidata klientidel navigeerida pidevalt muutuvas reguleerivas keskkonnas.",
...
// fund accounting
    ...
    "fund administration 3" => " • Finantsaruandlus
                            ...
                            <br>
                            • Portfelli vastavustugi
                            <br>
                            • USA maksutoetus
                            <br>
                            • Ettevõtte sekretäri regulatiivne tugi",

    "fund administration 4" => "Turundus- ja regulatiivne ekspertiis",
    "fund administration 5" => "Turutrendide ja fonditööstust mõjutavate regulatiivsete muudatuste mõistmine ja kursis hoidmine pole kunagi olnud olulisem. Lisaks selge ja täpse finants-, regulatiivse ja juhatuse aruandluse koostamisele, mis toetab meie klientide eesmärke ja eesmärke, on meie teenindusmeeskonnad koolitatud kriitiliselt mõtlema keskkonnast, milles meie kliendid tegutsevad, ja proaktiivselt teavitama meie kliente oodatavatest arengutest, mis võivad mõjutada nende ärimudeleid.",
    "fund administration 6" => "Koostööl põhinev lähenemisviis ja teenindusmudel",
    "fund administration 7" => "ning ühendamine ettevõtte meeskondade ja tehnoloogidega on kesksel kohal meie eesmärgil pakkuda ületavat kliendikogemust. Olenemata kliendi asukohast või fondi päritoluriigist, on meie teenindusmeeskondadel juurdepääs samadele süsteemidele ja reaalajas teabele, pakkudes kiire päringu esitamiseks ühtset platvormi ja pidevat parandamist. Meie platvorm võimaldab klientidel saada teavet oma ärilise päeva avamisel, olenemata nende asukohast.
<br><br>
Teenindades finantsteenuste valdkonna valitud segmente, keskendume investeeringutele meie infrastruktuuri ja klientidele pakutava teabe tõhususe, läbipaistvuse ja kättesaadavuse parandamisele, mitte mitme töökeskkonna integreerimisele.",
    ...
    "transfer agency 6" => "Investeerime paindlikesse turuliidri tehnoloogiatesse, et vastata klientide ja investorite nõuetele ning pidevalt kasvavatele regulatiivsetele muudatustele.",
    ...
    "fund order & custody 1" => 'Sunrise Fondi tellimuse ja valduse teenus pakub teenuseid Sunrisei hooldusklientidele, kes ostavad ja hoiavad investeerimisfonde. See hõlmab tellimuste töötlemist meie omamaise veebplatvormi Fund WorldView® kaudu.
                                ...
                                <br><br>
                                Erinevus seisneb meie kliendirahulikus pakkumises, ekspertiisis ja kiirel turuletulekul. Pakume "nutikat tellimuste suunamist", unikaalset võimalust turul, mis võimaldab tellimuste suunamist vastavalt investeeringule ja tellivatele klientidele nii fondidele kui ka vahendajatele. See vähendab riske, parandab tõhusust ja võimaldab parimat lähenemist tellimuste suunamisele.
                                <br><br>
                                Finantsasutuste kliendid saavad fondiostjatena laia ja õigeaegse juurdepääsu fondidele kogu maailmas ning kasutada operatiivset ja kuluefektiivsust. See tulemuseks on parem teenindus nende alusstrateegiatele, aidates luua konkurentsieelist ja kasvatada nende äri.',
    "fund order & custody 2" => "Fondi tellimuse ja valduse teenused hõlmavad:",
    "fund order & custody 3" => "• Tellimuste töötlemine ja automatiseerimine meie omamaise veebplatvormi Fund WorldView kaudu",
    "fund order & custody 4" => "• Parim tellimuste suunamine - „nutikas tellimuste suunamine“",
    "fund order & custody 5" => "• Konsolideeritud valdus ja asjaajamine kõigi fondide ja turgude osas",
    "fund order & custody 6" => "• Juurdepääs suurele ja kasvavale fondide valikule",
    "fund order & custody 7" => "• Kohandatud raportid",
    ...
    "hosted operations & reporting 5" => "pakub juurdepääsu kohalikele teenindusmeeskondadele ja teadmiste ekspertidele ning samuti skaleeritavaid, tõhusaid tehnoloogilisi lahendusi. Kliendid kasutavad meie jagatud infrastruktuuri ja kulusid, kui nad rakendavad oma kasvustrateegiaid ja jaotusalaseid eesmärke kauplemisstrateegiate ja instrumentide tüüpide osas.",
    "hosted operations & reporting 6" => "Ettevõtted",
    // infonav
    "infonav 1" => "InfoNAV® on skaalautuv, sõltumatu sekundaarne NAV-i arvutustööriist, mis võimaldab varahalduritel jälgida
               NAV-i tootmisprotsessi kõikide haldurite juures. Rakendus pakub klientidele läbipaistvust nende globaalsesse
               toodete, geograafiate ja raamatupidamise pakkujate valikusse.",
    "infonav 2" => "Mõju mõistmine",
    "infonav 3" => "Kliendid saavad tõhusalt dokumenteerida kontrolli ja rakendada oma erinevatele raamatupidamise pakkujatele
               parimat kontrollipraktikat. InfoNAV® impordib kriitilised NAV-i komponentide andmed meie klientide teenusepakkujatelt
               ja genereerib võrdluseks sekundaarse NAV-i esmase NAV-i suhtes. Seejärel saavad kliendid lihtsalt saada juhtmetriks, analüütikaks
               ja aruandluseks nõukogudele ja huvitatud pooltele läbi juhtpaneeli.",
    "infonav 4" => "Lisahüved",
    ...
    "inforecon 1" => "Sunrise Infomediary® pakub mitmeid eksklusiivseid modulaarseid rakendusi, mille kohal on sõnumside ja
                 ...
                 <br><br>
                 InfoRecon'i eelised saadakse kolmes peamises valdkonnas: tehnoloogia, tööstusharu parimad tavapärased praktikad ja
                 ületav klienditeenindus:",
    "inforecon 2" => "Tehnoloogia",
    "inforecon 3" => "Kohandatav ja tõestatud andmete kogumise ja normaliseerimise mootor, Infomediary",
    "inforecon 4" => "Vastupidav lepitamise tarkvaraplatform andmetöötluseks ja erandite haldamiseks",
    ...
    "investment accounting & enterprise data support 1" => "Kapitaliturgude, investeerimistoodete ja regulatiivse keskkonna järjest kasvav keerukus nõuab suuremat selgust ja reaalajas ülevaadet investeerimistegevusest. Ajakohase otsustamise väärtus on suur, hõlmates kauplemissüsteeme, raamatupidamisandmeid (ABOR), kuid idee säilitada OMS/ABORi praegune olek on vananenud ja sisaldab puudujääke.
                                                            <br><br>
                                                            OMS/ABOR-lahenduse edendamine holistiliseks investeerimise raamatu rekordiks (IBOR), mis on optimeeritud tänapäevaseks investeerimiskeskkonnaks, on keeruline, kuid vältimatu ettevõtmine. Ühtne raamatupidamise registreerimine võimaldab hinnata varahalduri andmehalduse strateegia praegust olekut ja formuleerida täiustusi.",
    "investment accounting & enterprise data support 2" => "IBOR-strateegia",
    "investment accounting & enterprise data support 3" => "Front office otsib teavet reaalajas sularaha, väärtpaberite ja tuntud tulevaste väärtpaberite sündmuste kohta kõikides varaklassides - näiteks avalikud ja erakapitali osalused ning tuletisinstrumendid - läbi mitmesuguste väljenduslinkide ja ülemaailmsete maaklerite ja hoiustaja raamistike. Varahaldurite jaoks koosneb edukas IBOR-strateegia järgmistest komponentidest:",
    "investment accounting & enterprise data support 4" => "Andmehalduse strateegia",
    ...
    "targeted technology solutions via infomediary 5" => "Lisaks oma põhitehnoloogiale pakkub Infomediary eksklusiivseid modulaarseid rakendusi nagu:",
    "targeted technology solutions via infomediary 6" => "mitme teenusepakkuja automatiseerimine kogu ürituste elutsükli jooksul",
    "targeted technology solutions via infomediary 7" => "dünaamiline valuuta alternatiiv, mis ühendab kvaliteetse täitmise kulude tõhususe ja selge, kõikehõlmava aruandlusega - kõik täielikult automatiseeritud, tõhusa töövooga",
    ...
    "data connectivity & applications via infomediary 5" => "Lisaks oma põhitehnoloogiale pakkub Infomediary eksklusiivseid modulaarseid rakendusi nagu:",
    "data connectivity & applications via infomediary 6" => "mitme teenusepakkuja automatiseerimine kogu ürituste elutsükli jooksul",
    "data connectivity & applications via infomediary 7" => "dünaamiline valuuta alternatiiv, mis ühendab kvaliteetse täitmise kulude tõhususe ja selge, kõikehõlmava aruandlusega - kõik täielikult automatiseeritud, tõhusa töövooga",
    ...
    "active fx execution 5" => "Me oleme tarnimise ja levitamise suhtes ükskõiksed, mis võimaldab klientidel meiega ühendust võtta mitmel viisil, sealhulgas otsehelistamine müügikauplejaga või läbi kolmandate osapoolte platvormide, näiteks Bloomberg, FlexTrade, FXall või FXConnect.",
    "active fx execution 6" => "Tugev toetus maailma juhtivatelt asjatundjatelt",
    "active fx execution 7" => "Oleme tööstusesse kuuluv juhtiv turuosaline suurtes ja arenevates turgudes ning omame ekspertiisi varahaldurite segmendis, nagu näitab 18 järjestikuse aasta vältel esikohta USA Greenwichi kvaliteediindeksi välisvaluuta uuringus.",
    "active fx execution 8" => "Meie klientidel on juurdepääs tipptasemel valuutateaduste uurimisrühmale, kes pakub kommentaare valuutade, majandus- ja geopoliitiliste arengute kohta, samuti pühendunud FX arenevate turgude rühmale, kes mõistab arenevate turgude keerulisi nõudeid ja kuidas need võivad kehtida globaalsetele varahalduritele.",
    "active fx execution 9" => "Märkus: Greenwich Associates kasutab ulatuslikke andmeid maakleritelt, avalikult kättesaadavatest allikatest ja nende enda uurimustest, et tuvastada kõige suuremad ja aktiivsemad institutsionaalsed välisvaluutakliendid kogu maailmas, sealhulgas fondihaldurid, klientide pangad, hedge-fondid, kindlustusseltsid ja ettevõtted.
                                <br><br>
                                2017. aasta uuringu jaoks viis Greenwich Associates läbi intervjuud 2355 välisvaluuta kasutaja seas kogu maailmas, millest 1458 olid esmaklassilised kontod, suurte korporatsioonide ja finantsasutuste juures. Ameerika Ühendriikides viis Greenwich Associates läbi intervjuud 383 FX kasutaja seas, millest 292 olid esmaklassilised. Esmaklassiliseks tunnistamiseks peab ettevõte olema kas keskpank, valitsusasutus, hedge-fond, fondihaldur, FT100 ülemaailmne ettevõte, ettevõte, millel on teatatud üle 10 miljardi dollari suurune kauplemismaht või ettevõte, millel on teatatud müügist üle 5 miljardi dollari. Intervjuud viidi läbi Põhja-Ameerikas, Ladina-Ameerikas, Euroopas, Aasias ja Jaapanis septembrist novembrini 2014. aastal. Klientidele edastatud tulemused kajastavad ainult uurimuse osalejate poolt Greenwich Associatesile edastatud vaateid. Need ei kujuta endast Greenwich Associatesi või selle töötajate arvamusi ega soovitusi. Küsitletuid võidakse küsida nende finantsproduktide ja teenuste kasutamise ning investeerimispraktikate kohta asjakohastes finantsturgude küsimustes. Greenwich Associates koondab saadud andmed, teostab statistilise analüüsi ja ülevaatuse esitluste eesmärgil, et koostada lõplikud tulemused.
                                <br><br>
                                Igal neist klientidest on sihitud intervjuu ühega Greenwich Associatesi professionaalsetest juhtivatest intervjuumeeskondadest.
                                <br><br>
                                Intervjuu käigus vastavad kliendid üksikasjalikele kvalitatiivsetele ja kvantitatiivsetele küsimustele maaklerite kohta, keda nad kasutavad erinevate FX toodete jaoks, ning nende maaklerite suhtelisi tugevusi ja nõrkusi müügis, turu tegemisel, uurimises ja tagalas. Kliendid annavad ka üksikasjalikku teavet oma kauplemistegevuse, praeguse ja oodatava toote kasutamise, maaklerite valikukriteeriumide ning muude turuga seotud küsimuste kohta.",
    "active fx execution 10" => "Ettevõtted",
    "active fx execution 11" => "Ettevõtted",
    ...
    "infofx 5"  => "Meie interaktiivse platvormi kaudu saavad kliendid valida valuutatehingute täitmise aja või seda muuta
              valitud turgudel ning lahendada võimalikke tehinguvea olukordi enne nende tekkimist.",
    "infofx 6"  => "Piiratud Turgude Ekspertiis",
    "infofx 7"  => "Meie kohalik turuekspertiis saab pakkuda väärtuslikke teadmisi klientidele, kes soovivad oma hooldajatest
              tehinguid teha turgudel, mida seni peeti hooldajate poolt hõivatuks. InfoFX toetab praegu kuut piiratud
              turgu: Brasiilia, Indoneesia, Korea, Malaisia, Taiwan ja Tai.",
    "infofx 8"  => "360° Läbipaistvus",
    "infofx 9"  => "InfoFX kliendid saavad reaalajas vaadata neto enne-tehingute ekspositsiooni, üksikasjalikke enne-tehingute
              korraldusteavet ja järeltehingute analüütikat interaktiivse veebiplatvormi kaudu. Pakume klientidele asjakohaseid
    ...
    "securities lending 5"  => "Tänu suuremahulise laenuprogrammi puudumisele saab Sunrise teostada väärtustele orienteeritud
                            ...
                            <br><br>
                            Meie kauplemissüsteem maksimeerib tulu suhteliselt väikese hulga tehingute kaudu, mis pakuvad
                            kõige olulisemat tootlust. Selleks on meil globaalne kauplemissüsteem Londonis, Bostonis ja Hongkongis,
    ...
    "securities lending 7"  => "Enne tehingut pakub Sunrise Securities Lending DealBoard-i, mis võimaldab meie klientidel näha
                            ...
                            reaalajas, jälgida tulusid ja turgusid, mis seda genereerivad.",
    "securities lending 8"  => "Ettevõtted",
    "securities lending 9"  => "Ettevõtted",
    "securities lending 10" => "Ettevõtted",
    // fx disclosure
...
Kas kauplemislepepool on Kanada kohalik vastapool.
   ...
   "alternative funds 1"  => "Sunrise on juhtiv ülemaailmne teenusepakkuja alternatiivsetele fondidele. Hetkel teenindame üle 275 miljardi dollarilise varahulga alternatiivsetes varaklassides, pakkudes terviklikku hoiumise, administreerimise ja sellega seotud teenuseid kõigile peamistele alternatiivsetele varaklassidele ja strateegiatele kolme laia kategooria raames:",
    ...
    "alternative funds 13"  => "Ettevõtted",
    "alternative funds 14"  => "Ettevõtted",
    "alternative funds 15"  => "Ettevõtted",
    ...
    "cross border funds 5"  => "Oleme välja töötanud spetsialistide oskusteabe Euroopasse ja sealt väljumise toetamisel,",
    "cross border funds 6"  => "piirkonda,",
    "cross border funds 7"  => "Ameerika Ühendriikidesse ja",
    "cross border funds 8"  => "Meie pakkumine põhineb kolmel põhieesmärgil:",
    "cross border funds 9"  => "Brändikaitse",
    "cross border funds 10"  => "Bränd on juhtiv tegur juhtide jaotusstrateegias.
                                <br><br>
                                Meie organisatsiooniline struktuur on võimaldanud meil välja töötada ainulaadse globaalse teenindusmudeli. Ühe ülemaailmse tehnoloogia platvormi ja ühendatud globaalsete meeskondade abil kujundame meie teenindusvõimekused vastavalt fondi domeenile, investeerimisjuhi asukohale ja jaotusturgudele.
                                <br><br>
                                Me keskendume kohaliku tasandi alluvate klientide vajaduste toetamisele ning nende brändi kaitsmisele ja edendamisele ülemaailmselt.",
    "cross border funds 11"  => "Komplekssuse juhtimine",
    "cross border funds 12" => "Toetades mõnda maailma kõige keerukamaid varahaldureid, kellest paljud jaotavad oma tooteid enam kui 20 globaalsel turul ja mitmes ajavööndis, mõistame ristpiiri tootevalikute teenindamise keerukust.
                                <br><br>
                                Meie fookus ja oskusteave aitavad klientidel navigeerida ristpiiri jaotusele mõjuvate regulatsioonide ja tootetrendide keskkonnas. Meie ülemaailmne teenindusmudel, mida toetab üks ülemaailmne tehnoloogia platvorm, loob tugeva taristu, mis võimaldab meie klientidel müüa oma fonde ülemaailmselt.",
    "cross border funds 13" => "Investeerimine klientide kasvu",
    "cross border funds 14" => "Oleme erakapitalil põhinev organisatsioon, mis on pühendunud ristpiiri fondide teenindamisele kui pikaajalisele kasvuturule, mis võimaldab meil investeerida oma klientide kasvule pikaajaliselt.
                                <br><br>
                                Oluliste investeeringutega inimestesse, taristusse ja tehnoloogiasse pakume raamistikku, mis aitab meie klientidel täita oma kasvueesmärke nii praegu kui ka tulevikus.",
    "cross border funds 15" => "Ettevõtted",
    "cross border funds 16" => "Ettevõtted",
    ...
    "distribution intelligence 11" => "sisaldab omanäolist investeerimisfondi tellimuste ja töötlemise platvormi, Fund WorldView®, mis aitab ühendada globaalseid varahaldureid kohalike finantsasutustega, kes ostavad ja hoiavad fonde.",
...
Sunrise aitab ettevõtetel neid prioriteete täita, samal ajal juhtides keerukust pidevalt muutuval turul. Ühendame toote-, turu- ja regulatiivse ekspertiisi tõestatud tehnoloogia ja teeninduse suurepärasusega, et pakkuda erilahendusi, mis vastavad meie klientide erilistele ärivajadustele.",
    ...
    "regulatory intelligence 1" => "Regulatiivsed muudatused on organisatsioonide strateegilise planeerimisprotsessi oluline osa. Et aidata klientidel reageerida regulatiivsetele muutustele, omab Sunrise pühendunud Regulatiivse Inteligentsi meeskond.
                                    ...
                                    <br><br>
                                    Meie eksperdid töötavad tihedalt koos klientidega, osaledes regulatiivsetes küsimustes erinevate tööstusühenduste, konverentside, ürituste ja kohtumiste kaudu. Meeskond pakub klientidele ka viimaseid teadmisi ja ülevaateid regulatiivsetest arengutest läbi mõtteliidripositsiooni.",
...
                      <br> <br>
                      Meil on pühendunud ekspertide meeskond, kes kasutab ära meie põhitegevuse võimekust, et pakkuda globaalse panga institutsionaalseid standardeid ja võimekust koos spetsialistide administraatori teeninduskvaliteediga.",
"hedge funds 2" => "Meie globaalne teenindusmudel",
"hedge funds 3" => "võimaldab meil kohandada teenindust juhtimisega seotud vajadustele, paigutades meeskonnad erinevatesse ajavöönditesse ja asupaikadesse.
                      <br> <br>
                      Pöörame erilist tähelepanu aktsionäride kaasamisele ja jätkuvale teenindamisele, teades, et see on põhiline varahalduri maine tagamiseks selle alljärgnevatele klientidele. Selliselt aitab see ehitada ja kaitsta brändi - üha olulisem varahalduri levitamisstrateegia juht. ",
    // "hedge funds 4" => "Ettevõtted",
...
                      <br> <br>
                      Kuna erasektor meelitab ligi üha rohkem institutsionaalset raha, muutub institutsionaalse taseme
                      fonditeenuste pakkumine kriitilise tähtsusega, aidates halduritel säilitada ja suurendada oma mainet
                      investorite seas ülemaailmselt.
                      <br> <br>
                      Kasutades spetsialiseeritud erasektori riskifondide haldusplatvormi, on meie pühendunud meeskondadel kogemusi suurte kohandatud keeruliste struktuuride vajaduste rahuldamisel, mida neid haldureid tüüpiliselt kasutavad. Meie kliendid hindavad meie lähenemist, kus on üks kontaktisik, kes aitab neil lihtsustada nende fondide igapäevaseid operatiivvajadusi.",
"private equity specialist 2" => "Ettevõtted",
...
spetsialiseerunud alternatiivse varahaldusega haldurid kaaluvad sellise investeeringu jaoks.
<br> <br>
Pakume klientidele spetsialiseeritud võlgade töötlemise teenust, mis hõlmab juhtivat Wall Street Office'i süsteemi.
...
"syndicated and originated debt 4" => "Ettevõtted",
    // dublin
    ...
    "dublin 3"  => "Sunrise on Iiri turul alates 1995. aastast ning on toetanud Iiri fonditööstuse kasvu selle loomisest saadik. Oleme nüüd üks riigi juhtivaid teenusepakkujaid, pakkudes oma täielikku varahaldusteenuste paketti Dublinis asuvatele UCITS-ile ja mitte-UCITS-ile.
                    ...
                    <br><br>
                    Meie maine üht ülemistest teenusepakkujatest Dublinis tuleneb meie tihedatest suhetest klientide, kohalike regulaatorite, tööstusühenduste ja teiste oluliste osalejatega. Osaleme aktiivselt mitmetes tööstusfoorumites ja töörühmades, sealhulgas Irish Funds Association (IF) ja Department of An Taoiseach Government Funds Working Group.",
    // global
    ...
    "global 5"  => "Meie ühtne globaalne tehnoloogiaplatvorm ja äriteenuste ja tehnoloogide intelligentne integreerimine on keskne meie eesmärgil pakkuda ülimat kliendikogemust.
                    <br><br>
                    Sõltumata kliendist või fondi asukohast, on meie teenindusmeeskondadel juurdepääs samadele süsteemidele ja reaalajas teabele, pakkudes kiireid vastuseid päringutele ja pidevat parendamist. Meie platvorm võimaldab klientidel saada teavet nende äripäeva alguses, olenemata nende asukohast.
                    <br><br>
                    Teenindades finantsteenuste tööstuse valitud segmente, keskenduvad meie investeeringud igale meie platvormi rakendusele, muutes selle kliendile äärmiselt asjakohaseks ja meie konkurentidest reageerivamaks ja läbipaistvamaks.",
    // greater china professionals
    "greater china 1" => "Hiina avab oma kapitaliturge dramaatilises tempos, kusjuures piiriülesed rahavoogud riiki ja riigist välja arenevad uuteks juurdepääsukohtadeks, mis omakorda pakuvad võimalusi maailma ja piirkondlikele varahalduritele.",
    "greater china 2"   => "Kui ",
 ...
 hoolduspanga ja juhtivate Hiina varahaldurite QDII toetajad.
    ...
    "luxembourg 3"  => "Turul alates 1989. aastast, toetades oma kliente esimese UCITS fondide käivitamisest alates, on Sunrise nüüd üks tippkolmanda osapoole hoidjaid ja administraatoreid Luxembourgis. Pakume oma täielikku varahaldusteenuste paketti Luxembourgis asuvatele UCITS-idele ja mitte-UCITS-idele.
                        ...
                        <br><br>
                        Meie maine üht ülemistest väärtpaberiteenuste pakkujatest suurhertsogiriigis tuleneb meie tihedatest suhetest klientide, kohalike regulaatorite ja teiste tööstuse osalejatega. Osaleme aktiivselt mitmetes tööstusfoorumites ja töörühmades, sealhulgas Luxembourg Fund Association (ALFI), Luxembourg Banking Association (ABBL) ja Luxembourg Private Equity Association (LPEA).",
    ...
    "cares 5"   => "kodu- ja toiduküttide teenindamine",
    "cares 6"   => "toitu, koolitarbeid, riideid ja mänguasju annetamine pühade ajal",
    "cares 7"   => "kodude ehitamine madala sissetulekuga peredele",
    "cares 8"   => "finantsteadlikkuse ja tehniliste oskuste koolitus",
    "cares 9"   => "juhtimisoskuste õpetamine",
    ...
    // TASE 2 - Meie ettevõte
    // partnerlus
    "the partnership 1" => "Meie partnerlus on tuntud oma tasase hierarhia, koostöö ja läbipaistvuse poolest. See toimib organisatsioonilise struktuurina, mis soodustab innovatsiooni ja paindlikkust, tagades parimate ideede kiire tekkimise.
                            <br><br>
    ...
    "philanthropy 3"    => "Elanikele meie lähedalasuvates kogukondades põhivajaduste tagamine elukvaliteedi parandamiseks, nagu:",
    "philanthropy 4"    => "kodutute toitlustamine",
    "philanthropy 5"    => "toitainete ja kingituste annetamine talvise pühade hooaja ajal",
    "philanthropy 6"    => "madala sissetulekuga perede kodude ehitamine",
    "philanthropy 7"    => "linnasüdamete koristusalgatused",
    "philanthropy 8"    => "koolide ilustamine",
    "philanthropy 9"    => "Haridus",
    "philanthropy 10"   => "Ressursside ja oskuste pakkumine, mis aitavad inimestel edu saavutada, sealhulgas:",
    "philanthropy 11"   => "raamatute ja koolitarvete jagamine",
    "philanthropy 12"   => "abi maksudeklaratsioonide ettevalmistamisel",
    "philanthropy 13"   => "kirjaoskuse komplektide koostamine",
    "philanthropy 14"   => "juhtimisoskuste õpetamine",
    "philanthropy 15"   => "lugemine koolilastele",
    "philanthropy 16"   => "abi CV kirjutamisel",
    // poliitika ja avaldused
    ...
    "legal 21"   => "Alljärgnevad täiendavad sätted kehtivad Veebiteenuste kaudu antud juhiste suhtes:<br>
                    ...
                    (b) Aeg-ajalt võib Online-teenuste poolt nõutavate kolmandate osapoolte sidevahendite või arvutisüsteemide ajutine kättesaamatus põhjustada juhiste töötlemise viivituse. Sellisel juhul ei vastuta me teile ega ühelegi kolmandale osapoolele viivituse tõttu tekkinud Kahjude eest.",
    "legal 22"   => "ELEKTROONILISED DOKUMENDID",
    "legal 23"   => "Perioodilisi avaldusi, avalikustusi, teateid ja muid dokumente võime teile teha elektrooniliselt kättesaadavaks (sealhulgas, kuid mitte ainult, Veebiteenuste kaudu) ja seadusega nõutavate kohaletoimetamise ja kättesaamise tõendamise menetluste kohaselt nõustute selliseid dokumente vastu võtma elektrooniliselt (sealhulgas, kuid mitte ainult, Veebiteenuste kaudu) ja kontrollima avalduste täpsust. Kui usute, et mingi avaldus sisaldab ebatäpset teavet, peate järgima asjakohaste Kliendilepingute tingimustes sätestatud menetlusi.",
    "legal 24"   => "MUUD TEATISED",
    "legal 25"   => "Pangateated",
    "legal 26"   => "(a) Hoiusteta investeerimistooted <br>
                    Hoiustetõendid, investeerimisfondid, annuiteedid ja muud investeerimistooted võivad olla meie kaudu saadaval. NEED TOOTED EI OLE HOIUSED EGA MUUD KOHUSTUSED MEILE VÕI MEIE SIDUSETTEVÕTETELE EGA OLE MEIE VÕI MEIE SIDUSETTEVÕTETE POOLT GARANTEERITUD, NING NENDE VÄÄRTUS VÕIB KÕIKUDA JA NEED ON SEOTUD INVESTEERIMISRISKIDEGA, SEALHULGAS VÕIMALIKU PÕHIPREEMIA KAOTUSEGA. LISAKS EI OLE NEED TOOTED EGA KA MEIEGA PAIGALDATUD HOIUSED TAGATUD AMEERIKA ÜHENDRIIKIDE FÖDERAALSE HOIUSTE KINDLUSTUSE KORRALDUSE POOLT EGA OLE EHITISKAITSME TÜÜBIGA MISTAHES MUU LIIGI HOIUSTUSE KINDLUSTUSEGA KAITSTUD.<br>
                    (b) Regulatsioon E <br>
                    Föderaalreservi juhatuse määrus E sätestab meie tarbijaklientide õigused, kohustused ja vastutuse teatavate elektrooniliste rahandustoimingute teenuste kasutamisel. Regulatsioon E ei kohaldu traatülekannetele. Lisateabe saamiseks Regulatsioon E kohta palun vaadake seda linki ja asjakohaseid Kliendilepinguid:",
    ...
    "legal 32"   => 'ONLINE TEENUSED JA KOGU INFO, TARKVARA JA MUU MATERJAL, MIS ON EDASTATUD ONLINE TEENUSTE KAUDU, ON ESITATUD "NAGU ON" JA "NAGU SAADAVAL" ALUSEL ILMSELT VÕI VÄLJENDLITAVALT, OLENEMATA MIS TAHES OTSESEST VÕI KAUDSEST GARANTIIST. MEIE JA MEIE TARNIJAD LOOBUME SELGELT KÕIGIST MÜÜDAAVUSE, INTELEKTUAALSE OMANDI MITTEVASTUTUSE, KVALITEEDI VÕI VASTAVUSE GARANTIIDEST MINGIL KINDLAL OTSTARBEL. ME EI GARANTEERI ONLINE TEENUSTE TURVALISUST EGA SEDA, ET TEIE KONTOINFO VÕI ANDMED EI KAOTSIGE EGA MUUTUB VÕI NENDELE PUUDETTA; SAMUTI EI GARANTEERI ME, ET ONLINE TEENUSED ON VABAD VIIRUSTEST, USSIDEST EGA MUUDEST KAHJULIKEST KOOSTISOSADEST. ME EI TEE ÜHTEGI ESINDUST EGA GARANTIID SEOTULT ONLINE TEENUSTE KASUTAMISE VÕI MITTEKASUTAMISE VÕI ONLINE TEENUSTE KASUTAMISEGA KAASNEVATE VIGADE, PUUDUSTE, TEENUSE KATKEMISTE, FAILIDE KAOTAMISE, SISU VÕI ANDMETE KAOTAMISE VÕI MUUTUMISE, VIGADE, PUUDUSTE, VALEDE AADRESSIDE, TEENUSE TOIMIMISE VÕI EDASTAMISE VIIVITUSTE, ARVUTIVIIRUSE, KOMMUNIKATSIOONIVÕRGU KATKEMISE VÕI SISU VÕI ANDMETE KAOTUSE VÕI MUUTUMISE EEST, ISEGI KUI MEID ON TEAVITATUD SELLISTE KAHJUDE VÕIMALIKKUSEST. ÜKSKÕIK KAS PIIRATUD VÕI MITTEPIIRATUD ASJAOLUDEST TULENEVATE KAHJUDE OSAS, EI VÕTA MEIE, MEIE SIDUSÄRITOVAIDETE, PARTNERITE, PÕHIPARTNERITE, LITSENTSEERIJATE, TARNIJATE, TÖÖTAJATE, AGENTIDE EGA TÖÖTAJATE POOLT TEIE VÕI TEIE VARA VÕI ASJADE EEST VASTUTUST NENDE KAHJUDE EEST. ÜKSKI KOLMAS OSAPOOLE POOLT EI OLE KÄESOLEVATE TINGIMUSTE KOHTA MINGIT ÕIGUST EGA NÕUET.',
    "legal 33"   => "INDEMNISEERIMINE",
    "legal 34"   => "Te nõustute hüvitama, kaitsma ja vabastama meid ja meie tarnijaid mistahes kahju, mille kandmine on tingitud nende tingimuste rikkumisest või Online Teenuste sisu volitamata kasutamisest. Ilmselgete kahtluste vältimiseks tunnistate te siinkohal, et kohaldatavate Kliendi lepingutega seotud sätted, mis puudutavad teie hüvitisnõuet meie vastu ja meie vastutuse ja kohustuste piiranguid teile, kehtivad ka teie Online Teenuste kasutamise ja nende tingimuste suhtes ning on siinkohal nõuetekohaselt sisse viidud. Käesoleva lõigu sätted kehtivad kohaldatava Kliendi lepingu lõppemise korral.",
    "legal 35"   => "MUUDATUSED",
...
"privacy policy 5" => '<p>Käesolev privaatsuspoliitika kehtib meie privaatsuseeskirjadele seoses teie kasutusega wgaml.com ja teistel
                        meie poolt opereeritavatel veebisaitidel, mille kaudu te sellele privaatsuspoliitikale juurdepääsete
                        (edaspidi ühiselt nimetatud "Saidid"), samuti meie veebisaitidel pakutavatele online-teenustele ja meie
                        äriproduktidega seotud teenustele (edaspidi "Teenused"). Kirjeldame ka teie õigusi ja seda, kuidas saate meiega
                        ühendust võtta seoses meie privaatsuseeskirjadega.</p>
                    ...
                    <p>Sunrise on isikuandmete töötleja, kelleks me kogume infot läbi Saidide. Samuti oleme isikuandmete töötlejad
                        ...
                        kontaktandmed käesoleva poliitika lõpus olevast <strong>Kuidas meiega ühendust võtta</strong> osast.</p>
                    <p>Palun lugege käesolevat poliitikat hoolikalt. Teie Saidide ja/või Teenuste kasutamine, sealhulgas igasugune
                        isikuandmete avaldamine Saididesse ja/või Teenustesse, on käesoleva poliitika kohaldamisalas ja allub sellele.</p>',
"privacy policy 6" => "Mida katab see privaatsuspoliitika",
"privacy policy 7" => "Käesolev privaatsuspoliitika hõlmab:",
"privacy policy 8" => "<li>Teie kohta kogutud isikuandmed;</li>
                        <li>Tundlikud andmed;</li>
                        <li>Kuidas me kasutame ja jagame isikuandmeid;</li>
                        <li>Kuidas me isikuandmeid edastame ja salvestame;</li>
                        <li>Kui kaua me säilitame isikuandmeid;</li>
                        <li>Teie õigused;</li>
                        <li>Lastekaitse;</li>
                        <li>Jõustumiskuupäev ja poliitika muudatused; ja</li>
                        <li>Kuidas meiega ühendust võtta.</li>",
    ...
    "privacy policy 13" => "Teie poolt meile otse esitatud isikuandmete kogumine on ilmne kontekstist, milles te seda esitate, näiteks:",
    ...
    "rohkem teavet" => "for more information",
...
<p>Üksikutes juhtumites, kui me sellist teavet siiski kogume, teeme seda vastavalt kohaldatavatele andmekaitse seaduste nõuetele.</p>',
    "privacy policy 21" => "Kuidas me kasutame ja jagame isikuandmeid",
    "privacy policy 22" => "Teie käest kogutud teave",
    "privacy policy 23" => "Võime kasutada teile antud isikuandmeid mitmel põhjusel, sealhulgas, kuid mitte ainult:",
   "privacy policy 24" => "<li>Vastamiseks päringutele või teeninduspäringutele ja selliste vastuste jälgimiseks;</li>
                            <li>Teabe edastamiseks ja turustamiseks meie toodete või Teenuste kohta, mida me arvame, et võivad olla
                            teile huvipakkuvad. Selle hulka kuuluvad kohandatud toote- ja sündmusekommunikatsioonid.</li>
                            <li>Saidide haldamine ja parendamine ning nende kasutuse ja tõhususe hindamine;</li>
<li>Oma äri arendamiseks ja turundusstrateegia koostamiseks, eelkõige turunduskampaaniate
efektiivsuse jälgimiseks;</li>
                            <li>Meie pakutavate Teenuste kasutamise hindamiseks;</li>
                            <li>Oma äritegevuse juhtimiseks vastavalt tööstusharu standarditele ja kohaldatavale seadusele, mis
võib hõlmata lisaks Teenuste toetamisele ka vastuste andmist päringutele ja taotlustele, pettuste
ennetamist, suhtluse jälgimist ja arhiveerimist;</li>
                            <li>Kliendi kontode haldamiseks, sealhulgas rahapesu, sanktsioonide ja pettuste kontrollimiseks.</li>",
    "privacy policy 25" => "<p>Isikuandmeid kasutatakse eespool kirjeldatud eesmärkidel, kuna meil on õigustatud huvi meie äri
tegevuse toimimiseks ja parendamiseks, mis ei kaalu üles teie huvisid, õigusi ega vabadusi teie isikuandmete
kaitsmiseks. Saadame teile otseturundusmaterjale ainult siis, kui olete andnud selleks nõusoleku, välja arvatud
juhul, kui nõusolekut ei nõuta, mille korral saate võimaluse keelduda otseturundusmaterjalide vastuvõtmisest.</p>
<p><em>Teave, mida me kogume automaatselt</em></p>
<p>Kasutame teatud piiratud isikuandmeid, mida kogume automaatselt küpsiste, küpsiseta põhinevate
märkide, veebimärkide ja muude automatiseeritud vahendite abil sellistel eesmärkidel nagu külastajate
kogemuse kohandamine ja parendamine Saididel, Saidide kasutamise hõlbustamine, statistika kogumine teie
külastuste kohta Saididel ning meie külastajate Saididel sirvimise viiside mõistmine. Samuti kasutame teavet
tehniliste ja teenusprobleemide diagnoosimiseks, Saidide haldamiseks ning mõnel juhul Saididel tellimuse
esitanud külastajate tuvastamiseks. Kasutame klõpsutamise andmeid, et teha kindlaks, kui palju aega
külastajad veedavad Saidide veebilehtedel, kuidas külastajad Saididel navigeerivad ja kuidas saame
Saididel vastata paremini meie külastajate vajadustele. Isikuandmeid kasutatakse eespool kirjeldatud
eesmärkidel, kuna meil on õigustatud huvi Saidide toimimise ja parendamise suhtes, mis ei kaalu üles teie
huvisid, õigusi ega vabadusi teie isikuandmete kaitsmiseks. Vaadake meie",
    "privacy policy 26" => "Kogume isikuandmeid ka siis, kui te osalete meie e-kirjade suhtluses. See hõlmab teavet
avatud ja klõpsatud e-kirjade kohta ning kõikide vastuste kohta meie sündmusekommunikatsioonidele. Kasutame
isikuandmeid neil eesmärkidel, kuna meil on õigustatud huvi oma äri kasvatamise ja turundusstrateegia
arendamise vastu. Vaadake meie",
    "privacy policy 27" => "<p><em>Muud isikuandmete kasutused</em></p>
                            <p>Kasutame kogutud isikuandmeid ka pettuste, nõuete ja muude kohustuste vastu kaitseks ja
                                ärahoidmiseks ning vastavate õigusaktide, tööstusharu standardite ja meie poliitikate ja
                                tingimuste täitmiseks või jõustamiseks. Kasutame isikuandmeid nendel eesmärkidel, kui see on
                                vajalik meie õiguste kaitseks, teostamiseks või kaitsmiseks või kui seda nõuab kohaldatav meile
                                kohalduv seadus.</p>
                            <p><em>Mobiiltelefoni teave</em></p>
                            <p>Teatud meie toodete ja teenuste osas võime autentida teie poolt esitatud juhiseid, mis
                                väidetavalt pärinevad teilt, helistades tagasi teie varasemalt meile esitatud telefoni
                                numbrile. Esitades meile tagasihelistamise eesmärgil mobiiltelefoni numbri või edastades juhise,
                                annate (iseenda ja igale volitatud isikule) loa vastava operaatori (AT&T, Sprint, T-Mobile,
                                U.S. Cellular, Verizon või mõni muu kaubamärki omav operaator) volitatud esindajatele
                                avaldada meile ja meie kolmandatele teenusepakkujatele mobiiltelefoni numbri, võrgu oleku,
                                kliendi tüübi, kliendi rolli, arveldustüübi, mobiilseadme tuvastusnumbrid (IMSI [rahvusvaheline                                mobiiliabonendi identiteet] ja IMEI [rahvusvaheline mobiilseadme identiteet]) ja muud tellija
                                oleku ning seadme üksikasjad, kui need on saadaval, ainult kõnealuse helistaja isiku tuvastamiseks
                                ja pettuste ärahoidmiseks kogu suhte jooksul. Pange tähele, et seda teavet kasutatakse ainult
                                tagasihelistamisprotseduuri osana teie juhise tuvastamiseks, ning pärast verifitseerimise lõppu
                                me seda teavet ei säilita.</p>
                            <p>Lisaks eespool kirjeldatud kasutustele võime kasutada teile esitatud või meie poolt kogutud
                                isikuandmeid ka muudel eesmärkidel. Kui see nii on, anname teile täiendava teatise, milles
                                kirjeldatakse isikuandmete kasutamise eesmärke ja selleks meie õiguslikku alust.</p>
                            <p><em>Isikuandmete jagamine</em></p>
                            <p>Me ei müü teie kohta kogutud isikuandmeid. Me ei avalikusta meie praeguste ega endiste
                                klientide kohta mingeid isikuandmeid kellelegi, välja arvatud käesolevas poliitikas kirjeldatud
                                juhtudel, lepingu või seadusega lubatud juhtudel ning kohaldatavates jurisdiktsioonides kohalduvate
                                konfidentsiaalsuskohustustega.</p>
                            <p>Võime avalikustada või jagada meie klientide kohta käivate isikuandmeid meie sidusettevõtetele
                                vastavalt seadusega lubatud viisil, et sidusettevõtted saaksid osutada teenuseid. Jagame teie
                                isikuandmeid ka teenusepakkujatega, kes osutavad teenuseid meie nimel, nagu majutusteenuse
                                pakkujad ja nõustajad. Kõik teenusepakkujad on sõlminud õiguslikult siduvad lepingud, mis
                                nõuavad neilt isikuandmete kasutamist või avalikustamist ainult teenuste osutamiseks meie nimel
                                või kohaldatavate õigusnõuete täitmiseks. Võime jagada isikuandmeid meie sidusettevõtete ja
                                teenusepakkujatega mitmel põhjusel, sealhulgas:</p>",
    "privacy policy 28" => "<li>Olete palunud teavet meie sidusettevõtete toodete ja teenuste kohta;</li>
<li>Toetume meie sidusettevõtete ja teenusepakkujate osutatavatele teenustele, et teile pakkuda nõutavaid
teenuseid;</li>",
    "privacy policy 29" => "<p>Lisaks võime avalikustada teie isikuandmeid (i) panga või muu järelevalveasutuse taotlusel
või meie läbivaatamise korral panga või muude kontrollorite poolt; (ii) meie sisemistele või välistele audiitoritele
või advokaatidele; (iii) kui usume, et avalikustamine on vajalik või sobiv füüsilise kahju või finantskahju
ennetamiseks; (iv) kui meil on selleks kohustus või luba vastavalt seadusele või õigusprotsessile, näiteks kohtumäärus
või taotlus õiguskaitseasutuselt; (v) kui avalikustamine on vajalik kellegi oluliste huvide kaitsmiseks; või (vi)
...
likvideerimine).</p>",
    ...
    "privacy policy 31" => "<p>Sunrise on ülemaailmne organisatsioon; me kogutud isikuandmeid võidakse rahvusvaheliselt edastada
                                ...
                                kehtivate seaduste järgimiseks. Isikuandmete salvestus või töötlemine välismaal võib olla juurdepääsetav
                                vastavalt õiguspärasele korraldusele selles jurisdiktsioonis.</p>
                            <p>Kui viibite Euroopa Majanduspiirkonnas (EMP), Ühendkuningriigis või Šveitsis, täidame kohaldatavaid
                                õigusnõudeid, tagamaks isikuandmete edastamisele vastuvõtjatele EMP-st, Ühendkuningriigist ja
                                Šveitsist piisava kaitse. Kõigil sellistel juhtudel edastame teie isikuandmeid ainult juhul, kui:</p>",
    "privacy policy 32" => "Isiklikku teavet edastav riik on saanud",
    "privacy policy 33" => "Euroopa Komisjoni piisavuse otsus",
    "privacy policy 34" => "Isikliku teabe saaja asub USA-s ja on sertifitseeritud",
    "privacy policy 35" => "EU-USA privaatsuskihi raamistik",
    "privacy policy 36" => "Oleme rakendanud sobivaid kaitsemeetmeid edastamise osas, näiteks",
    "privacy policy 37" => "EU mudellepingud",
    "privacy policy 38" => "<li>Isikliku teabe saaja on vastu võtnud sidusrühmadele kehtivad sidusettevõtete eeskirjad;</li>
                            <li>Edastamine on muul viisil lubatud kohaldatavate õigusnõuete kohaselt.</li>",
    "privacy policy 39" => "Isikuandmete edastamisega seotud kaitsemeetmete koopia saamiseks võite meiega ühendust võtta, nagu on kirjeldatud allpool jaotises Kuidas meiega ühendust võtta.",
    "privacy policy 40" => "Kui kaua me isikuandmeid säilitame",
    "privacy policy 41" => "<p>Isikuandmete säilitamise aeg sõltub sellest, mis eesmärgil me neid kogume. Kõikidel juhtudel
                                säilitame neid nii kaua, kui on vaja täita neid eesmärke, milleks me neid kogusime. Seejärel
                                kustutame või anonüümime isikuandmed, välja arvatud juhul, kui meil on seaduslik kohustus neid
                                säilitada või kui me peame neid säilitama, et täita oma seaduslikke kohustusi (näiteks maksu-
                                ja raamatupidamise eesmärgil).</p>
                            <p>Tingimuste kohaselt säilitame isikuandmeid tavaliselt järgmiselt:</p>",
    "privacy policy 42" => "<li>Isikuandmed, mille te meile esitate meie saitide kaudu: säilitame need isikuandmed nii kaua,
                                kui on vaja vastata teie päringule, ja lühikest aega edasi juhul, kui saadate meile edasisi
                                päringuid.</li>
                            <li>Isikuandmed, mille te meile esitate otseturunduse kommunikatsioonide saamiseks registreerudes:
                                säilitame enamiku neist isikuandmetest teiega suhte kestel, kuni te otsustate tulevaste
                                turunduskommunikatsioonide saamisest loobuda või kuni meil ei ole teiega pikka aega mingit
                                kontakti.</li>
                            <li>Analüütikat eesmärgil kogutud isikuandmed: säilitame need isikuandmed lühikest aega, mis on
                                vajalik meie analüüsiks. Pärast nende isikuandmete kasutamist analüüsiks anonüümime või
                                koonduvõime neid.</li>
                            <li>Veebisaidi logid: säilitame meie saitide auditipäevikuid, milles võib olla teie isikuandmeid,
                                mitu kuud. Need logid sisaldavad juurdepääsu logisid (meie saitide turvalisuse jälgimiseks ja
                                säilitamiseks), tõrkelogisid (vigade jälgimiseks ja registreerimiseks) ja turvalisuselogisid
                                (turvalisusega seotud sündmuste jälgimiseks ja registreerimiseks, nagu volitamata ligipääsu
                                katseid).</li>",
    "privacy policy 43" => "Teie õigused",
    "privacy policy 44" => "Kui olete isik, kes esitab meile isikuandmeid, võite uurida, milliseid isikuandmeid me säilitame ja/või töötleme. Teile antakse mõistlik juurdepääs teie isikuandmetele, mida me säilitame, ja vajaduse korral võimalus neid üle vaadata ja parandada ebatäpsusi. Me koostööd tehes tagame sellise juurdepääsu. Kõik sellised juurdepääsupäringud võib esitada kirjaliku päringuna aadressile:",
    "privacy policy 45" => "Kui viibite EMP-s või Šveitsis, võite oma isikuandmetega seoses omada järgmisi õigusi:",
    "privacy policy 46" => "<li>Nõuda kinnitust selle kohta, kas me töötleme teie isikuandmeid ja vajaduse korral saada koopia nendest isikuandmetest;</li>
                            <li>Nõuda, et me parandaksime või uuendaksime teie isikuandmeid, mis on ebatäpsed, mittetäielikud või vananenud;</li>
                            <li>Nõuda, et me kustutaksime teie isikuandmed teatud asjaoludel, näiteks juhul, kui me kogusime isikuandmed teie nõusoleku alusel ja te tõmbate oma nõusoleku tagasi;</li>
                            <li>Nõuda, et me piiraksime teie isikuandmete kasutamist teatud asjaoludel, näiteks seni, kuni me kaalume mõnda muud teie poolt esitatud taotlust, näiteks taotlust teie isikuandmete uuendamiseks;</li>
                            <li>Kui olete andnud meile nõusoleku oma isikuandmete töötlemiseks, siis nõuda oma nõusoleku tagasivõtmist; ja</li>
                            <li>Nõuda, et me annaksime teile teie isikuandmetest koopia struktureeritud, tavaliselt kasutatavas ja masinloetavas vormingus teatud asjaoludel.</li>",
    "privacy policy 47" => "<p>Teie privaatsuse kaitsmiseks ja turvalisuse tagamiseks võime võtta mõistlikke samme teie isikutuvastuse kontrollimiseks enne teie taotluse täitmist. Vastame sellisele teie poolt esitatud mõistlikule taotlusele pärast teie isiku tuvastamist kohaldatava õigusega nõutud ajavahemiku jooksul.</p>
                            <p>Samuti on teil õigus esitada kaebus oma riigi andmekaitse järelevalveasutusele.</p>",
    "privacy policy 48" => "Laste privaatsus",
    "privacy policy 49" => "Tunnistame vajadust pakkuda lastelt kogutud isikuandmete suhtes erilist privaatsuskaitset. Meie saitide ja teenuste eesmärk ei ole suunatud ega mõeldud lastele.",
    "privacy policy 50" => "Jõustumise kuupäev ja poliitika muudatused",
    "privacy policy 51" => "<p>Iga kord, kui kasutate meie saite, kehtib kehtiv privaatsuspõhimõte. See poliitika võib aeg-ajalt muutuda. Ülaloleva poliitika „Viimati uuendatud“ jaotis näitab, millal poliitika viimati uuendati. Kui me seda muudame, avaldame praeguse privaatsusteate sellel lehel. Mis tahes muudatused selles teates jõustuvad avaldamise päeval. Saite kasutades aktsepteerite muudetud privaatsuspõhimõtet.</p>
                            <p>Kui pole öeldud teisiti, kehtib meie praegune privaatsuspõhimõte kõikidele teie kohta käivatele andmetele. Me ei muuda oluliselt oma poliitikat ja tavasid, et need oleksid teie privaatsuse suhtes vähem kaitsevõimelised, ilma teie nõusolekuta.</p>",
    "privacy policy 52" => "Kuidas meiega ühendust võtta",
    "privacy policy 53" => "Kui teil on küsimusi või kommentaare seoses käesoleva privaatsuspõhimõttega või teie isikuandmete töötlemisega, võite meiega ühendust võtta:",
    "privacy policy 54" => "E-posti teel aadressil:",
    ...
    "privacy policy 67" => "<li><strong>Tunnused:</strong> tunnused, nagu tegelik nimi, hüüdnimi, postiaadress, unikaalne isiklik identifikaator (näiteks seadme identifikaator; küpsised, märgistused, pikslimärgised, mobiilseadmete reklaamiidentifikaatorid ja sarnane tehnoloogia; kliendi number, unikaalne pseudonüüm või kasutajanimi; telefoninumber ja muud püsivad või tõenäolised identifikaatorid), veebiidentifikaator, internetiprotokolli aadress, e-posti aadress, kontonimi, sotsiaalkindlustuse number, juhiluba, passinumber ja muud sarnased identifikaatorid
                            ...
                            <li><strong>Lisanduvad andmed, mis kuuluvad Cal. Civ. Code § 1798.80 kohaselt:</strong> allkiri, osariigi identifitseerimiskaardi number, kindlustuspoliisi number, haridus, pangakonto number, krediitkaardi number, deebetkaardi number ja muu finantsinformatsioon, meditsiiniinformatsioon
                            </li>
                            <li><strong>Kaitstud klassifikatsioonid: </strong>California või föderaalseaduse alusel kaitstud klassifikatsioonide tunnused, näiteks päritolumaa, vanus, sugu, suguidentiteet, seksuaalne sättumus, abielus olek, tervislik seisund, puue, kodakondsus ja sõjaveteranistaatus
                            </li>
                            <li><strong>Kaubanduslik teave:</strong> kaubandusteave, sealhulgas isikliku vara, ostetud, saadud või kaalutud toodete või teenuste kirjed ning muud ostu- või tarbimisajaloo või -tendentsidega seotud andmed
                            </li>
                            <li><strong>Veebikäitumine:</strong> Interneti ja muu elektroonilise võrgutegevuse teave, sealhulgas, kuid mitte ainult, sirvimisajalugu, otsinguajalugu ja teave teie suhtlemise kohta veebisaitide, rakenduste või reklaamidega
                            </li>
                            <li><strong>Geolokatsiooniandmed</strong>
                            </li>
                            <li><strong>Tajuandmed:</strong> audioandmed
                            </li>
                            <li><strong>Tööalane teave:</strong> kutsealane või tööga seotud teave
                            </li>
                            <li><strong>Haridusinfo:</strong> haridusteave, mis ei ole avalikult kättesaadav isiku tuvastatav informatsioon Family Educational Rights and Privacy Act (20 U.S.C. Sec. 1232g; 34 C.F.R. Part 99) tähenduses
                            </li>
                            <li><strong>Järeldused:</strong> järeldused, mis on tehtud mistahes ülalnimetatud andmetest, et luua teie kohta profiil, mis peegeldab teie eelistusi, tunnuseid, psühholoogilisi suundumusi, eelsoodumusi, käitumist, hoiakuid, intelligentsust, võimeid ja oskusi
                            </li>",
    "privacy policy 68" => "Võime kasutada (ja võime kasutada 12 kuu jooksul enne käesolevate avalikustuste jõustumist) teie isikuandmeid meie privaatsuspõhimõttes kirjeldatud eesmärkidel ja järgmistel CCPA-s täpsustatud ärieesmärkidel:",
    "privacy policy 69" => "<li>Teenuste osutamine, sealhulgas kontode haldamine või teenindamine, klienditeeninduse pakkumine, tellimuste ja tehingute töötlemine või täitmine, kliendiandmete kontrollimine, maksete töötlemine, reklaam- või turundusteenuste pakkumine, analüütikateenuste pakkumine või sarnaste teenuste pakkumine
                            </li>
                            <li>Audit, mis on seotud teiega toimuva praeguse suhtluse ja samaaegsete tehingutega, sealhulgas, kuid mitte ainult, reklaami mõjude loendamine ainulaadsetele külastajatele, reklaami paigutuse ja kvaliteedi kontrollimine ning auditeerimine vastavuse osas
                            </li>
                            <li>Turvarikkumiste avastamine, pahatahtliku, eksitava, pettuse või ebaseadusliku tegevuse vastu kaitsmine ja selle eest vastutavate isikute kohtu alla andmine
                            </li>
                            <li>Tõrgete lahendamine olemasoleva kavandatud funktsionaalsuse kahjustamiseks
                            </li>
                            <li>Sisemise teadus- ja arendustegevuse läbiviimine tehnoloogilise arendamise ja näitustegevuse jaoks
                            </li>
    ...
    "privacy policy 72" => "<li>Otseselt teilt, näiteks kui sisestate oma isikuandmed meie veebisaidile või võtate meiega ühendust
                            ...
                            <li>Teie seadmed, näiteks teie veebikäitumine meie veebisaidi külastamisel, sealhulgas teie suhtlemine meie veebisaidiga
                            </li>
                            <li>Meie tütarettevõtted
                            </li>
                            <li>Müüjad, kes osutavad teenuseid meie nimel
                            </li>
                            <li>Meie ühis turunduspartnerid
                            </li>
                            <li>Online-reklaamiteenused ja reklaamivõrgustikud
                            </li>
                            <li>Andmeanalüütika pakkujad
                            </li>
                            <li>Valitsusasutused
                            </li>
                            <li>Operatsioonisüsteemid ja platvormid
                            </li>
                            <li>Sotsiaalsed võrgustikud
                            </li>
                            <li>Andmevahendajad</li>",
    "privacy policy 73" => "Isikuandmete jagamine",
    "privacy policy 74" => "Sõltuvalt teie suhtest meiega võime 12 kuu jooksul enne käesolevate avalikustuste jõustumist järgmiste isikuandmete kategooriate osas avaldada teie kohta isikuandmeid ärilisel eesmärgil järgmiste kolmandate osapoolte kategooriatele:",
    "privacy policy 75" => "Isikuandmete kategooria",
    "privacy policy 76" => "Kolmanda osapoole kategooria",
    "privacy policy 77" => "Tunnused",
    "privacy policy 78" => "Andmeanalüütika pakkujad, valitsusasutused, operatsioonisüsteemid ja platvormid",
    "privacy policy 79" => "Lisateave Cal. Civ. Code § 1798.80 seaduse alusel",
    "goverment entities" => "Valitsusasutused",
    "privacy policy 80" => "Kaitstud klassifikatsioonid",
    "privacy policy 81" => "Kaubanduslik teave",
    "privacy policy 82" => "Veebitegevus",
    "privacy policy 83" => "Andmeanalüütika pakkujad, operatsioonisüsteemid ja platvormid",
    "privacy policy 84" => "Tajuteave",
    "privacy policy 85" => "Tööalane teave",
    "privacy policy 86" => "Haridusalane teave",
    "privacy policy 87" => "Järeldused",
    "privacy policy 88" => "<p>Nagu on märgitud meie põhiseaduses, ei müü me ühtegi isikuandmeid, sealhulgas kuid mitte ainult alaealiste (alla kuueteistkümne aasta vanuste) isikuandmeid.</p>
                            <p><strong>4. Erinevad õigused CCPA kohaselt</strong></p>
                            <p>CCPA alusel on California elanikel teatud konkreetseid õigusi seoses nende isikuandmetega. Allpool kirjeldatakse neid õigusi:</p>
                            <p><em>Õigus teabe küsimiseks</em></p>
                            <p>Teil on õigus kaks korda 12-kuulise perioodi jooksul nõuda, et me avaldaksime teile viimase 12 kuu jooksul kogutud, kasutatud, avaldatud ja müüdud isikuandmed.</p>
                            <p><em>Õigus isikuandmete kustutamiseks</em></p>
                            <p>Teil on ka õigus nõuda, et me kustutaksime teie juures kogutud teatud isikuandmed. </p>
                            <p><em>Müügist loobumine</em></p>
                            <p><em>Teil on õigus loobuda oma isikuandmete müügist. </em>Nagu on märgitud meie põhiseaduses, ei müü me ühtegi isikuandmeid, sealhulgas kuid mitte ainult alaealiste (alla kuueteistkümne aasta vanuste) isikuandmeid.</p>
                            <p><em>Kuidas õigusi kasutada</em></p>
                            <p>Pakume kolme meetodit, kuidas saate esitada taotluse teabe või isikuandmete kustutamise kohta:</p>",
    "privacy policy 89" => "Saate esitada taotluse, kasutades selleks",
    ...
    "privacy policy 94" => "<p>Pange tähele, et meie vastavaks tegevuseks peame teie isikusamasuse kinnitama. Teie taotluse kinnitamise menetlus varieerub sõltuvalt teie taotluse laadist ja teie suhtest meiega, kuid hõlmab tavaliselt vajadust esitada meile kaks või enam isikuandmeid sisaldavat identifitseerimisandmete osa, mis vastavad teie isikuandmetele, mis on juba meie andmekogudes olemas. Lisaks, kui palute meil esitada teile konkreetseid isikuandmete osi, võime nõuda, et allkirjastaksite avalduse tõe vande all, et olete tarbija, kelle isikuandmete kohta taotlus käib. Teavitame teid, kui me ei suuda teie taotlust CCPA nõuetele vastavalt kinnitada.</p>
                            ...
                            <p>Me ei kohalda teie suhtes diskrimineerivaid meetmeid seetõttu, et olete kasutanud oma õigusi CCPA kohaselt. Seda hõlmab muuhulgas teile kaupade või teenuste keeldumist, erinevate hindade või määradega kaupade või teenuste pakkumist, erineva taseme või kvaliteediga kaupade või teenuste pakkumist või vihjete andmist, et teile võidakse pakkuda erinevat hinda või määra kaupade või teenuste või erineva taseme või kvaliteediga kaupade või teenuste eest, kuna olete kasutanud oma õigusi CCPA kohaselt.</p>",
    "privacy policy 95" => "Kontaktandmed",
    "privacy policy 96" => "Kui teil on küsimusi või muresid meie privaatsuspoliitika ja -käitumise kohta, võtke meiega ühendust, nagu kirjeldatud peatükis „Kuidas meiega ühendust võtta” meie põhiseaduses.", 
    // new account policy
   "new account policy 1" => "Oluline teave uue konto avamise menetluse kohta",
    "new account policy 2" => "Valitsuse abistamiseks terrorismi rahastamise ja rahapesu vastu võitlemisel nõuab föderaalseadus, et kõik finantsasutused koguksid, kontrolliksid ja salvestaksid teavet, mis tuvastab iga isiku, kes avab konto. Seetõttu palume teil konto avamisel esitada oma nimi, aadress, sünnikuupäev ja muud teave, mis võimaldab meil teid tuvastada. Võime samuti paluda isikut tõendavaid dokumente.",
    "new account policy 3" => "Teade ärikontodele",
    "new account policy 4" => "Kui olete ärilist klienti, siis olge teadlik, et teil on keelatud osaleda igasuguses tegevuses või äris, mis on seadusevastane vastavalt 2006. aasta ebaseadusliku internetipanuste vastuvõtmise seadusele (UIGEA), 31 USC 5361 jt. Te ei tohi oma kontot ega muid teenuseid, mida pakume, kasutada ühegi rahalise ülekande, krediidi, instrumendi ega tulude saamiseks, mis tulenevad tegevusest, mis on UIGEA järgi ebaseaduslik. Kui keegi palub meil töödelda tehingut, mille me arvame olevat UIGEA järgi piiratud, võime tehingu blokeerida ja võtta UIGEA järgi muid mõistlikke meetmeid.",
    ...
    // center for women and wealth
    "center for women and wealth caption 1" => "Naisi rikkuse loomise ja haldamise protsessis kaasava ja abistava keskuse (Centre for Women and Wealth® - CW&W) eesmärk on pakkuda naistele investeerimis-, planeerimis- ja filantroopilisi ressursse meie erakliendite aastakümnete pikkuse kogemuse põhjal. CW&W soovib luua isikliku ja veebipõhise kogukonna, kus naised saavad jagada oma kogemusi ja pakkuda juhiseid tulevastele naiste juhtide põlvkondadele.",
    "center for women and wealth caption 2" => "New America: Better Life Lab",
    ...
    "conversations on women wealth and leadership past event 8 caption" => "Camille Preston, AIM Leadershipi tegevjuht ja asutaja, juhtis elavat arutelu ajapõhisest majandusest tulemustepõhise majanduse juurde ülemineku ja produktiivsemaks, loovamaks ja rahuldatumaks saamise teemal.",
    "conversations on women wealth and leadership past event 9" => "Rockefelleri kollektsiooni eratuur Christie'sis",
    "conversations on women wealth and leadership past event 9 caption" => "CW&W koostöös Christie'siga pakkus klientidele eraviisilist vastuvõttu ja tuuri maailma suurimas kunstikogus, Peggy ja David Rockefelleri kollektsioonis.",
    "conversations on women wealth and leadership past event 10" => "YPO: Raising Financially Savvy Daughters",
    "conversations on women wealth and leadership past event 10 caption" => 'YPO poolpäevane üritus "Raising Financially Savvy Daughters", kus esinesid Adrienne Penta ja Ellen Perry. Rõhutati laste igas vanuses finantsvastutuse õpetamise tähtsust ja varanduse väärtuse mõistmise tähtsust.",
...
"conversations on women wealth and leadership past event 16 caption" => "Sunrise'i perekonnad ja kliendid osalesid teisel aastasel Next Generation Summitil, mis oli kaasahaarav sündmus. Arutati tõhusat suhtlemist, ettevõtlust, investeerimist, töö-elu tasakaalu juhtimist ja finantsalase aluse loomist tulevikuks.",
    ...
    "entry level 1" => "Kas oled hiljuti lõpetanud ja otsid ideaalset alguspunkti oma professionaalsele karjäärile?
                    ...
                    eetiliselt tegutsemisele ja tipptaseme saavutamisele. Otsime kandidaate, kes on valmis
                    uurima uuenduslikke lähenemisviise, et aidata meie klientidel saavutada oma eesmärke.
                    <br><br>
                    Kui sul on tugev pühendumus tõhusale koostööle teistega, kõrgele eetilisele standardile
                    ja pidevale püüdlusele silma paista oma töös, julgustame sind kaaluma liitumist meie meeskonnaga.
                    Väärtustame inimesi, kes soovivad kaheldamatute arusaamade väljakutset ja leida loovaid lahendusi
                    meie klientide eesmärkide toetamiseks.
                    <br><br>
                    Saades osaks meie organisatsioonist, saad panustada meie klientide edu, pakkudes uusi vaatenurki
                    ja pidevalt otsides uusi viise nende vajaduste rahuldamiseks. Pakume toetavat keskkonda, mis soodustab
                    professionaalset kasvu, võimaldades sul õppida kogenud spetsialistidelt ja täiendada oma oskusi.
                    <br><br>
                    Kui oled motiveeritud, kirglik ja valmis alustama tasuvat karjääri finantsteenuste tööstuses, kutsume
                    sind kandideerima ja uurima võimalusi meie meeskonnaga liitumiseks.
                    <br><br>
                    Sisenemistaseme kandidaadina tähendab see:",
    "entry level 2" => "soovi võtta vastu uusi väljakutseid",
    "entry level 3" => "ettevõtlikku lähenemist",
    "entry level 4" => "loovat mõtlemist",
    ...
    "experienced 4" => "Liitudes Sunriseiga, saad osa dünaamilisest ja toetavast keskkonnast, mis ühendab suure ettevõtte
                    ...
                    panuse anda.",
    "experienced 5" => "Tippjuhtidel on edu määratletud võimega juhtida võitvaid meeskondi ja kujundada strateegiat. See tähendab:",
    "experienced 6" => "komplekssete probleemide lahendamist uute ideede väljatöötamise ja integreerimise teel",
    "experienced 7" => "olles kõige usaldusväärsem, väärtuslikum ja eristuvam partner igale meie teenindatud kliendile",
    "experienced 8" => "oma seisukohtade väljaütlemist, kuulamist ja arusaamist erinevatest vaadetest",
    "experienced 9" => "teisi inspireerimist koostööle suunatud mõtteviisi kaudu",
    "experienced 10" => "Juba meie ustest sisse astudes annab sulle võimaluse luua suhteid ja vabaduse kujundada oma karjäärirada.",
    // restart
    "restart 1" => "Kas sina või keegi sinu tuttavatest kaalub naasmist tööjõusse pärast pausi ettevõtlusmaailmast?",
    "restart 2" => " võimaldab kandidaatidel, kes on olnud tööjõust eemal vähemalt kaks aastat, naasta tasustatud Restart Assignment'i kaudu ettevõtluskeskkonda. Osalejate oskused ja huvid sobitatakse äri vajadustega, et luua edukad tulemused ja püsivad partnerlused. Lisaks väärtusliku kogemuse saamisele ja oskuste värskendamisele saavad osalejad koolitust ja juhendamist, et aidata neil tööle naasmise üleminekut hõlbustada. Positsioonid on saadaval erinevatel tasemetel meie Bostoni, New Jersey, New Yorgi ja Dublini kontorites.",
    ...
    "undergraduate 5" => "Kvalifikatsioonid:",
    "undergraduate 6" => "tugev akadeemiline saavutus, mida tõendab konkurentsivõimeline keskmine hinne (USAs) või hinne 4 (Euroopas)",
    "undergraduate 7" => "näidatud juhtimisoskused akadeemiliste ja huvitegevuste kaudu",
    "undergraduate 8" => "huvi äri vastu (eriti finantsvaldkonna vastu paljudes rollides)",
    "undergraduate 9" => "suurepärased kvantitatiivsed, analüütilised ja suhtlemisoskused",
    "undergraduate 10" => "koostöövalmidus, ettevõtlikkus, energilisus ja kohanemisvõime",
    "undergraduate 11" => "USA programm:",
    ...
    "undergraduate 14" => ' <p>
                            ...
                            <p>
                                Luxembourgis pakume täistööajaga praktikaprogrammi, mis kestab 6 kuni 12 kuud ja on koostöös ülikooli õppeprogrammidega. Need võimalused on peamiselt saadaval bakalaureuse- või magistriõppe üliõpilastele, kes õpivad finantsi, raamatupidamise ja äri erialadel ning peavad läbima praktika kraadi nõude täitmiseks. Pakume mitmesuguseid väljakutseid pakkuvaid ja tasustatud täistööajaga praktikakohti traditsioonilises ja alternatiivse fondide teeninduse valdkonnas, mis hõlmavad järgmisi valdkondi: suhted ja teenuste kvaliteet, fondide vastavus, ülemaailmne usaldushooldus ning fondiarvestus.",
                            </p>',
    ...
    "affinity network community 5"  => "CANC grupid on olulised meie ettevõtte",
    "affinity network community 6"  => "mitmekesisuse ja kaasatuse",
    "affinity network community 7"  => "strateegia edendamisel. Ootame meie CANC liikmetelt nõuandeid töötajatele töökohal esilekerkivate probleemide ja võimaluste kohta. Ettevõttevälistes kogukondades loovad CANC liikmed aktiivselt tähendusrikkaid suhteid vabatahtliku tegevuse, globaalsete ja kohalike organisatsioonidega sõlmitud ametlike partnerlussuhete ning kogukonnategelaste kaasamise kaudu kohalike ürituste korraldamisel.",
    // põhiväärtused
    ...
    "our culture 5" => "Meie klientide maine on meie maine ja miski pole tähtsam. Meie otsuste tegemine põhineb konsensusele, on suunatud pikaajalisele perspektiivile ja konservatiivsele riski käsitlusele. Töötajad kõigil tasanditel jagavad vastutustunde ja vastutust klientide ja ettevõtte jätkuvuse eest ning meie erakordselt kiirelt toimiv ärimudel võimaldab meil kiiresti kokkuleppeid saavutada. See on tugeva meelekindluse ja kiiruse võimas kombinatsioon.",
    "our culture 6" => "Ettevõtlik vaim",
    "our culture 7" => "Toetame ettevõtlikku vaimu ja koostööl põhinevat keskkonda, mis võimaldab sul lisaväärtust luua, kus iganes võimalik. Meie lame organisatsioonistruktuur tagab otsetoetuse teabele ja ekspertidele kõigis ärivaldkondades, tagades, et parimad ideed alati tõusevad esile. Panustamine oma igapäevasesse rolli on julgustatud, toetades meeskonnatööd, uusi lahendusi ja õigeaegset teostust. Me hindame inimesi, kes ütlevad oma arvamuse avalikult, kuulavad ja mõistavad seisukohti, mis erinevad nende omadest. Hierarhiliste struktuuride ja sisemise konkurentsi puudumine soodustab koostöö ja teenindusele orienteeritud kultuuri, kus kliendid on esikohal.",
    // Asia Link Network
    "asia link 1"   => "BANC võrgustikud on võimaldanud mul luua kutsealase arengu võimalusi meie liikmetele, samal ajal ühendades meiega kogu maailmast.",
    "asia link 2"   => "– Richard Ma, Asia Link juht",
    "asia link 3"   => "Asia Link Network töötab selle nimel, et tugevdada kultuurilist arusaamist ja parandada Aasia riikide, tavade ja finantsturgude maailmaalaste teadlikkust. Arutelude, loengusarjade ja sisulise dialoogi kaudu soodustame ideede vahetamist, mis viivad paremate lahendusteni meie töötajatele ja klientidele. Liikmed saavad võrgustumis-, mentorluse- ja teadmiste loomise võimalusi, mis aitavad suurendada nähtavust ja edendada karjääri kasvu. Meie prioriteet on pakkuda töötajatele võimalusi arendada juhtimis-, suhtlemis- ja meeskonnatöö oskusi, mida saab töökohal rakendada.",
    "asia link 4"   => "Kevadine festival",
    "asia link 5"   => "Lõunarühm võõrustas ülemaailmselt kevadist festivali, mis hõlmas Hiina looma-aasta teemalisi arutelusid, traditsioonilist lõvitantsumist, pidulikku toitu ja võistluslikku lauatennisturniiri. Võrgustik võõrustas ka erikülalisi, kes selgitasid tee tähtsust Aasia kultuuris.",
    "asia link 6"   => "Diwali tähistamine",
    "asia link 7"   => "Lõunarühm korraldas erilise õhtu Diwali auks, India tulede festival. Üritusel toimus Diwali tulede süütamise tseremoonia, esitlus, mis keskendus Diwali tähendusele mitmekultuurilises kontekstis, ning võrgustumisreception koos India toidu, Diwali maiustuste, muusika ja mängudega.",
    "asia link 8"   => "Aasia ja Vaikse ookeani pärandikuu (USA-s)",
    "asia link 9"   => "New Yorgi ja Jersey City Aasia Linki India osakond tähistas oma käivitamist Aasia ja Vaikse ookeani pärandikuu raames USAs. Värvifestivali tähistamine hõlmas Bollywoodi muusikaliga etendust nimega “Holi Hai”, mis andis osalejatele aimu festivali tähistamisest Indias.",
    ...
    "black affinity 13" => "„60 minutit“ on regulaarne üritus, mille eesmärk on anda töötajatele suurem teadlikkus erinevatest ettevõtte osakondadest. Osalejad saavad teavet kolleegide „päeva elus“ kohta. Hiljuti said nad teavet Valuutavahetuse süsteemide ja muudatuste haldamise kolleegidelt.",
    ...
    "diverse ability allies 7" => "Pimendajate kunst",
    "diverse ability allies 8" => "See töötuba andis töötajatele võimaluse kogeda nelja „Kommunikatsiooni põhimõtet pimendajatele“ - segadus, mitmetähenduslikkus, takistused ja konkurents. Diskussiooni ja meeskonnatöö tegevuste käigus õppisid osalejad, kuidas kasutada sensoorset suhtlemist efektiivsemateks suhtlejateks ja kuulajateks.",
    ...
    "latino cultural 5" => "LCN New Yorgi kontor korraldas raamatuarutelu „The Power of Latino Leadership: Culture, Inclusion, and Contribution“, mille autor on Juana Bordas. Osalejad jagasid oma perspektiive raamatu teemadel, mis käsitlesid mitmekesisuse omaksvõttu, inimeste hindamist ja tegutsemist.",
    "latino cultural 6" => "Hispaania pärandi kuu tähistamine Ameerika Ühendriikides",
    "latino cultural 7" => "LCN Jersey City osakond alustas Hispaania pärandi kuu tähistamist lipulaevaüritusega, kuhu kuulus vabatahtlik tegevus, peakõneleja, ladina meelelahutus ja võrgustumise vastuvõtt. Et austada teemat „Ameerika helge tuleviku kujundamine“, tähistas LCN Innovatsioonile Investeerijaid, kelle töö aitas meie riiki, pakkudes tehnoloogia ja ettevõtluse võimalusi alaesindatud kogukondadele.",
    "latino cultural 8" => "Koostöö PerScholasega",
    "latino cultural 9" => "ja LCN Jersey City partnerdasid PerScholas New Yorgi kontoriga, et üle vaadata CV-d ja korraldada proovitöövestluseid tudengitele, kes otsivad tööd infotehnoloogia valdkonnas. PerScholas on kool, mis aitab alaesindatud kogukondade esindajatel omandada oskusi, mis laiendavad nende kvalifikatsiooni infotehnoloogia töökohtade jaoks ning saavutada edu tehnilises tööstuses.",
    "latino cultural 10" => "Veini- ja tapaspidu",
    "latino cultural 11" => "Selle aasta Veini- ja tapasüritusel rääkis partner Maroa Velez sellest, kuidas tema ladina juured on mõjutanud tema karjääri. Maroa jagas, kuidas Jose Marti, Gabriel Garcia Marquezi ja teiste autorite teosed on teda mõjutanud. See õhtu andis töötajatele ja LCN-i liikmetele võimaluse koos tähistada Hispaania pärandi kuud.",
    ...
    "parenting 8" => "NY Vanemate Võrgustik korraldas ülemaailmse rahalise planeerimise arutelu, mis oli mõeldud eriti vanematele. Osalejad võtsid osa avatud arutelust teemadel nagu elukindlustus, töövõimetushüvitis, ülikooliõppemaks ja testamendi tegemine.",
    ...
    "pride 11" => "Bostoni Uhkuse Võrgustik korraldas paneeldiskussiooni LGBT+ kogukonna vananemiskriisist. Fenway Health'i esindaja juhtis arutelu selle keeruka küsimuse keerukusest ja selle lahendamiseks tehtud pingutustest. Osalejad said võimaluse õppida tundma LGBT+ vanemate täiskasvanute kultuuri, vajadusi ja muresid.",
    // naiste võrgustik
    "womens 1" => "„Minu osalemine Naiste Võrgustikus on andnud mulle suurepäraseid võimalusi luua pikaajalisi suhteid teiste liikmetega. See on aidanud mind professionaalselt ning samuti andnud mulle platvormi teistele abistamiseks. Paljud naised, kes on oma osalemise kaudu Naiste Võrgustikus näidanud erinevaid oskusi, on leidnud uusi ja ootamatuid võimalusi pangas.“",
    "womens 2" => "- Sarah Holmes, Naiste Võrgustiku kaasjuht",
    "womens 3" => "Naiste Võrgustik pakub naistele võimalusi edendada oma isiklikku ja erialast arengut, luua suhteid ja teha koostööd erineva taustaga, ekspertiisiga ja tasemetega töötajatega kogu ettevõttes. Meie eesmärk on inspireerida, harida ja kaasata oma liikmeid ürituste, suhtlusvõrgustike ja tööstusharu foorumite kaudu. Me pühendume kõikide töötajate teadlikkuse tõstmisele unikaalsetest viisidest naiste toetamiseks töökohal. Koostöös meie ärijuhtidega keskendume naiste meelitamisele, edendamisele ja hoidmisele tööjõus ning julgustame neid olema liidrid igas oma karjääri etapis.",
    "womens 4" => "Moldist välja murdmine",
    "womens 5" => "Bostoni Naiste Võrgustik võõrustas dr Patti Fletcheri, et arutada edukuse strateegiaid naistelt, kes murduvad traditsioonilistest raamidest. Tema sõnum osalejatele meie igaaastasel Naiste Võrgustiku kokkusaamisel oli: „Kui avad ukse enda jaoks, sillutad tee neile, kes järgnevad sinule.“",
    "womens 6" => "Muutuste päev",
    "womens 7" => "Jersey City Naiste Võrgustik tähistas „Muutuste päeva“, kus esinesid Wanda Durant, inspiratsioonikõneleja, filantroop ja Kevin Duranti, kahekordse NBA MVP meistrivõistlusega Golden State Warriorsi ema, samuti Eric Hutcherson, NBA personaliosakonna juhataja. Osalejad õppisid nii isiklikust kui ka erialasest muutumisest kahe inimese käest, kes on juhtinud muutust nii isiklikus kui ka organisatsioonilises plaanis.",
    "womens 8" => "Äriomandi arendamine",
    "womens 9" => "Krakówi Naiste Võrgustik korraldas hiljuti professionaalse arengu ürituse pealkirjaga „Äri-, finants- ja strateegiline arukus - karjäärinõuanded, mida tõenäoliselt ei saanud“. Osalejaid julgustati jagama kogemusi ja nõuandeid sellel informatiivsel üritusel.",
    "womens 10" => "Suur-Hiina Naiste Võrgustiku riiete kogumine",
    "womens 11" => "Suur-Hiina Naiste Võrgustik on edukaks kohandunud! Nad viisid hiljuti läbi riiete annetuskampaania, et aidata tööotsijaid, kes vajavad sobivat ametiriietust.",
    "womens 12" => "ESG investeerimise võim",
    "womens 13" => "Naiste Võrgustik ja",
    ...
    "young professionals 5" => "Sunrisei Noorte Spetsialistide Võrgustiku Dublini osakond tähistas ettevõtte 200. aastapäeva aastal 2018,
                            ...
                            märkimisväärselt suhtumise, ootuste ja väärtuste osas.",
    "young professionals 6" => "Loe täielikku raportit siit.",
    "young professionals 7" => "Linnai Aed",
    "young professionals 8" => "Cares ja YPN (Noorte Spetsialistide Võrgustik) New Yorgi osakond korraldas Urban Garden Rooftop ürituse.
                            Vabatahtlikud veetsid hommiku uute köögiviljade istutamise, umbrohu rohimise ja aia kastmisega. Aed aitab
                            kohalikke elanikke, kes õpivad, kuidas põllumajandust harida, toitu valmistada ja tervislikumaid eineid oma
                            perele pakkuda.",
    "young professionals 9" => "Kohtu noorim iirlane, kes on kunagi vallutanud Mount Everesti",
    "young professionals 10" => "YPN Dublin kutsus eriliseks külalisõpetajaks Rob Mortelli – noorim iirlane, kes on kunagi vallutanud Mount
                             Everesti! Rob jagas oma teadmisi ettevalmistustest ja väljakutsetest, millega tippu jõudmine kaasneb, ning
                             arutles, kuidas meeskonnad saavad edu saavutada maailma kõige karmimates tingimustes.",
    "young professionals 11" => "Investeeri endasse ja oma karjääri",
    "young professionals 12" => "YPN korraldas kaheosalise üritustesarja teemadel „Investeerimine iseendasse“ ja „Investeerimine oma karjääri“.
                             Arutelud uurisid, kuidas paneeliliikmed lõid oma unikaalsed võimalused sisemiseks karjääriliikuvuseks ning millised
                             on olnud nende karjääri jooksul saavutatud edusammud, väljakutsed ja huumor.",
    "young professionals 13" => "Põlvkondadevaheliste erinevuste mõistmine",
    "young professionals 14" => "YPN Boston kutsus kõnelema Talent Catalysti esindajad, et aidata osalejatel mõista, kuidas sildistada
                             põlvkondadevahelist lõhet, õppides, kuidas pidada tõhusaid vestlusi, seada ootusi ja luua suhteid tänapäeva
                             mitme põlvkonna tööjõus.",
    // benefits wellness compensation
    "benefits wellness compensation 1" => "Koos õitsedes",
    "benefits wellness compensation 2" => "<p>
Tervem sina on rõõmsam sina. Meie programm Thrive võimaldab sul tervist parandada, pakkudes ressursse ja tuge, mis aitavad teha parimaid elustiili valikuid - füüsiliselt, rahaliselt ja isiklikult. Heaolu tähendab erinevatele inimestele erinevaid asju erinevatel eluetappidel.</p>
                                                <br>
    ...
    "mobility 4" => "<li>saada edasijõudnud rahvusvahelisi oskusi ja kogemusi</li>
                    ...
                    <li>tutvuda uute kultuuridega</li>
                    <li>luua globaalseid võrgustikke</li>",
    "mobility 5" => "Ettevõtted",
    "mobility 6" => "Ettevõtted",
    ...
    // thrive financially
    "thrive financially 1" => "Meie töötajad on meie pikaajalise edu alustala ja oluline konkurentsieelis. Püüame tagada, et meie hüvitise ja finantssoodustuste programmid oleksid konkurentsivõimelised ja sobivalt seotud üksikisikute pingutustega ettevõtte üldise väärtuse ja tulemuslikkusega.",
    "thrive financially 2" => "<li>Konkurentsivõimeline palk</li>
                                <li>Soorituspõhine boonus</li>
                                <li>Pensioniplaan</li>
                                <li>Kasumijaotus</li>",
    ...
    "thrive financially 5" => "<li>Elu- ja puudekindlustus</li>
                                ...
                                <li>Soodustusprogrammid</li>
                                <li>Eelarve planeerimine</li>
                                <li>Adopsiooni ja asendusema kulude hüvitamine</li>
                                <li>Finants- ja pensioniplaneerimine</li>
                                <li>Võlgadega seotud nõustamine</li>
    ...
    "thrive personally 2" => "<li>Tasustatud puhkus</li>
                                ...
                                <li>Vabatahtlik puhkus</li>
                                <li>Sotsiaalsed tegevused ja klubid</li>
                                <li>Adoptsiooni/asendusema teenused</li>
                                <li>Töötaja abiprogrammid</li>
                                <li>Unehäired</li>
    ...
    "thrive physically 1" => "<p>Sunrisei prioriteediks on meie töötajate ja nende perede tervise ja heaolu tagamine. Sellepärast pakume kõikehõlmavat hüvitiste programmi, mis pakub ulatuslikku tervisekindlustust ja täiendavaid hüvitisi üldise heaolu toetamiseks.</p>
                                    ...
                                    <br>
                                    <p>Lisaks tervisekindlustusele pakume erinevaid programme ja ressursse heaolu ja proaktiivse tervisehalduse edendamiseks. Nende hulka võivad kuuluda tervisekontrollid, sõelumised ja harivad tööriistad, mis aitavad sul teha teadlikke otsuseid oma tervise kohta ja võtta ennetavaid meetmeid. Usume, et teadmiste ja ressurssidega varustades saame toetada sinu üldist heaolu ja tervislikku eluviisi.</p>
                                    <br>
                                    <p>Oleme pühendunud pakkuma hüvitiste programmi, mis mitte ainult ei taga ulatuslikku tervisekindlustust, vaid toetab ka sinu terviklikku heaolu. Sinu tervis ja sinu pere tervis on meile olulised, ning püüame pakkuda programme ja ressursse, mis võimaldavad sul juhtida tervislikku ja täiuslikku elu.</p>",
    "thrive physically 2" => "<li>Meditsiiniline, hamba- ja nägemiskindlustus</li>
                                <li>Haiguste ennetamine/sõelumised</li>
                                <li>Füüsiline aktiivsus</li>
                                <li>Toitumine</li>
                                <li>Tubakast loobumine</li>
                                <li>Biomeetrilised sõelumised</li>
    ...
    "data protection notice 6" => "1. Oma lepingu(d)e täitmiseks teiega; <br>
                                    2. Teiega suhtlemiseks ja meie ärisuhte säilitamiseks ja arendamiseks, sealhulgas meie toodete ja teenuste kohta teabe
                                    esitamiseks; ja <br>
                                    3. Kohaldatavate seaduste, reeglite ja määruste, sealhulgas kuid mitte ainult rahapesu, sanktsioonide sõelumise ja maksustamise
    ...
    "online security 7"  => "Kõik legitiimsed suhtlused Sunriseilt tulevad domeenist wgaml.com. Kõiki teisi suhtlusi tuleks kahtlustada. Kui teil on küsimusi Sunrisei veebisaidi või kahtlustate, et olete saanud kahtlase Sunrisei lingi või e-kirja, võite helistada oma Sunrisei suhtehaldurile või võtta ühendust Sunriseiga meie peamistes asukohtades.
                                    ...
                                    <br><br>
                                    Külastage oma kontosid regulaarselt ja jälgige võimalikke pettuseid.
                                    <br><br>
                                    Institutsionaalsed pangakliendid peaksid perioodiliselt läbi viima oma keskkonna vastavad kontrollid infoturbe riskide hindamiseks vastavalt nende institutsioonide kohaldatavatele programmidele.
                                    <br><br>
                                    Kõik avalikud Wi-Fi võrgud pole turvalised, eriti kohvikutes, hotellides ja lennujaamades. Õppige, millele tähelepanu pöörata
                                    ja kuidas end kaitsta nende võrkude kasutamisel.",
    "online security 8"  => "Meetmed enda kaitsmiseks",
    "online security 9"  => "Lisaks teadlikkusele võimalikest võrguturbeohtudest on mitmeid samme, mida saate võtta arvuti, võrgu või isiklike seadmete turvalisuse parandamiseks. Allpool on mõned punktid, mida peaksite kaaluma isikliku ja konfidentsiaalse teabe terviklikkuse kaitseks nendel seadmetel. Lisateabe saamiseks vaadake allolevat jaotist „Ole teadlik“.
                                    <br><br>
                                    Kõigi võrguga ühendatud seadmete puhul vaadake oma seadme turbe protokolle täieliku loetelu turbevaldkonna valikute kohta ja kaaluge järgmist:",
    "online security 10" => "Arvuti turvalisus",
    "online security 11" => "<li>Seadistage turvavarustuse automaatsed värskendused</li>
                                    <li>Seadistage isiklikud tulemüürid kasutaja ja interneti vahelise kaitsebarjäärina</li>
                                    <li>Tarkvaral peaks olema ajakohane operatsioonisüsteem</li>
                                    <li>Tarnija tarkvaralt tuleks regulaarselt värskendusi saada</li>
                                    <li>Veebilehitsejaid tuleks regulaarselt värskendada</li>
                                    <li>Veebilehitsejad tuleks konfigureerida, et kasutataks tugevaimat krüpteerimist</li>
                                    <li>Viirusetõrje ja nuhkvara tõrjetarkvara tuleks paigaldada ja regulaarselt värskendada</li>
                                    <li>Tuleks teha perioodilisi täielikke skanne</li>
                                    <li>Kus võimalik, peaks juurdepääsu seadmele piirama ainult vajalikele isikutele</li>",
    "online security 12" => "Traadita võrkude turvalisus",
    "online security 13" => "<li>Traadita võrgud tuleks seadistada kasutama tugevaimat krüpteerimist ja parooli kaitset</li>
                                    <li>Vanad, vananenud traadita seadmed tuleks asendada uuemate, turvalisemate mudelitega</li>
                                    <li>Rajamaapealkirjad ja paroolid, mis on tootja poolt määratud, tuleks paigaldamise ajal ära muuta</li>
                                    <li>Kui traadita võrke ei kasutata pikka aega, tuleks need välja lülitada</li>",
    "online security 14" => "Isikliku ja konfidentsiaalse teabe turvalisus",
    "online security 15" => '<li>Kus võimalik, peaksid paroolid olema keerulised ja iga konto jaoks unikaalsed</li>
                                    <li>Paroole tuleks hoida turvaliselt ega jagada neid kellegagi</li>
                                    <li>Isikliku ja konfidentsiaalse teabe jagamine peaks olema piiratud usaldusväärsete isikutega ja seda tuleks pakkuda ainult nõutud viisil turvaliste veebisaitide kaudu</li>
                                    <li>Isikliku ja konfidentsiaalse teabe edastamine e-postiga peaks olema piiratud, kuna enamik e-postisüsteeme pole turvalised</li>
                                    <li>Olulisi faile tuleks regulaarselt varundada</li>
                                    <li>Igaüksus peaks alati veebiseansside lõpus "väljalogima", et tagada seansi täielik lõpetamine - lihtsalt brauseri sulgemine ei pruugi seanssi täielikult lõpetada</li>',
    "online security 16" => "Mobiilseadmete turvalisus",
    "online security 17" => "<li>Luba paroolilukk</li>
                                    <li>Luba töötamata oleku ajal automaatne lukustus, et seade lukustuks automaatselt, kui seda pole kasutatud</li>
                                    <li>Operatsioonisüsteemid ja installitud rakendused tuleks hoida ajakohasena</li>
                                    <li>Kus võimalik, tuleks krüpteerida isiklikel seadmetel olevad andmed</li>
                                    <li>Kui isiklik seade tuleb utiliseerida, tuleks kõik isiklikud andmed seadme andmesalvestusmeediumilt alaliselt kustutada</li>
                                    <li>Lihtsalt failinimede kustutamine ei pruugi andmeid alaliselt eemaldada, seega kasutage seadme pühkimisfunktsioone või otsige tooteid, mis on mõeldud seadme utiliseerimiseks</li>",
    "online security 18" => "Ole teadlik",
    "online security 19" => "Internetis on palju saadaolevaid ressursse, mis pakuvad teavet ja näpunäiteid turvalisuse tagamiseks. Võtke aega ja hoidke end informeerituna.
                                    <br><br>
                                    Föderaalne Kaubanduskomisjoni (FTC) veebisait on ressurss nii institutsioonidele kui ka üksikisikutele. Kogu veebisaidil on näpunäiteid ja teavet ennetava turvalisuse kohta ning mida teha pettuste korral. Lisateabe saamiseks klõpsake sellel lingil:",
    ...
    // Regulation E
    "regulation e 1" => "Föderaalreservi juhatuse määrus E reguleerib teatud elektrooniliste rahakaartide teenuste kasutamisel
                            meie tarbijaklientide õigusi, vastutust ja kohustusi. Määrus E ei kohaldu juhtmeülekannetele.
                            Täpsema teabe saamiseks määruse E kohta palun vaadake seda linki ja vastavaid kontolepinguid:",
    ...
    "cookie policy 3" => 'Sunrise ja kõik muud sellega seotud sidus- ja tütarettevõtted (ühiselt "Sunrise", "meie" või "meie")
                            ...
                            privaatsuspõhimõtetega, mis on leitavad aadressil',
    "cookie policy 4" => "Küpsisepoliitikaga hõlmatavad veebisaidid",
    "cookie policy 5" => '<p>Käesolev küpsisepoliitika selgitab, kuidas küpsiseid kasutatakse veebisaidil wgaml.com ja muudel meie
                            poolt opereeritavatel veebisaitidel, mille kaudu te käesolevat küpsisepoliitikat kasutate (ühiselt
                            viidatud kui \'saidid\').</p>
                        <p>Poliitikat võidakse aeg-ajalt muuta. Kui see muutub, anname teile sellest teada, postitades
                            muudetud poliitika käesolevale lehele uue "Viimati uuendatud" kuupäevaga. Kui te ei soovi meie
                            saitidelt küpsiseid vastu võtta, keelake need oma veebibrauseris (palun külastage meie
                            küpsiste haldamise lehte) või ärge kasutage saite.</p>
                        <p>Käesolev küpsisepoliitika ei kehti nende veebisaitide suhtes, mis omavad oma küpsisepoliitikat või
                            teiste ettevõtete või üksuste veebisaitidele, millele see veebisait viitab. Muude seotud
                            veebisaitide privaatsus- ja küpsisepoliitika kohta lisateabe saamiseks vaadake vastava veebisaidi
                            privaatsus- või küpsisepoliitikat.</p>',
    "cookie policy 6" => "Mida see küpsisepoliitika hõlmab",
    "cookie policy 7" => "Käesolev küpsisepoliitika hõlmab:",
    "cookie policy 8" => "<li>Mida tähendavad küpsised ja sarnased tehnoloogiad;</li>
                            <li>Kes seab küpsised;</li>
                            <li>Kui kaua küpsised kestavad;</li>
                            <li>Meie saitidel kasutatavad küpsised;</li>
                            <li>Küpsiste keelamine või haldamine meie saitidel;</li>
                            <li>Küpsised ja e-kirjad; ja</li>
                            <li>Kuidas meiega ühendust võtta.</li>",
    "cookie policy 9"    => "Mis on küpsised ja sarnased tehnoloogiad?",
    "cookie policy 10"   => "<p>Küpsised on tekstifailid, mis sisaldavad väikest kogust teavet ja mida alla laaditakse teie
                                arvutisse või seadmesse, kui külastate veebisaiti. Küpsised saadetakse seejärel tagasi
                                algsele veebisaidile iga järgneva külastuse ajal või teisele saidile, mis tunneb ära selle
                                küpsise. Küpsised on kasulikud, kuna võimaldavad saidil tuvastada kasutaja seadet.</p>
                            <p>Küpsised täidavad erinevaid ülesandeid, näiteks võimaldavad teil efektiivselt liikuda lehtede
                                vahel, meelde jätta teie eelistused ja üldiselt parandada kasutajakogemust. Samuti võivad nad
                                aidata tagada, et veebisaitidel kuvatavad reklaamid on teie huvidega rohkem seotud. Palun
                                pange tähele, et saidid ei sisalda reklaame ega kasuta reklaamiküpsiseid.</p>
                            <p>Mõned küpsised, mida kasutame, on veebianalüütika ja teave meie saitide kohta. Need aitavad meil
                                õppida, millised saitide osad on kasulikud ja millised vajavad täiustamist. Selleks võime
                                turunduse-kirjade e-kirjades kasutada ka veebimärke või muid sarnaseid tehnoloogiaid, et
                                teha kindlaks, kas kirju on avatud ja linke klõpsatud. Veebimärgid ei salvesta teie seadmesse
                                teavet, kuid võivad töötada koos küpsistega, et salvestada saidi aktiivsust.</p>
                            <p>Üldiselt saate oma veebibrauseri seadete muutmise kaudu otsustada, kas aktsepteerida küpsiste
                                ja sarnaste tehnoloogiate kasutamist või mitte. Lisateabe saamiseks selle kohta, kuidas seda
                                teha, külastage meie küpsiste haldamise lehte. Kuid kui keelate küpsised ja sarnased
                                tehnoloogiad, võib see mõjutada teie kogemust saitidel ning mõned funktsioonid ei pruugi
                                töötada oodatud viisil.</p>",
    "cookie policy 11"   => "Lisateavet küpsiste ja sarnaste tehnoloogiate kohta leiate aadressilt:",
    "cookie policy 12"   => "Kes seab küpsised?",
    "cookie policy 13"   => '<p>Küpsiseid võib meie saitidel seada kas meie ise või mõni teine sait enne teie visiiti või
                                selle ajal. Neid nimetatakse "esimese osapoole" ja "kolmanda osapoole" küpsisteks.</p>
                            <p>Esimese osapoole küpsised kuuluvad veebisaidi domeeni, mis kuvatakse veebibrauseri aadressiribal.</p>
                            <p>Kolmanda osapoole küpsised kuuluvad veebisaitide domeenidele, mis erinevad aadressiribal
                                näidatavast. Mõned meie teenusepakkujad, kes pakuvad meie teenustele tehnoloogilisi platvorme
                                (näiteks videoklipid), võivad seada küpsiseid ka teie seadmesse meie saitidel külastuse
                                ajal.</p>
                            <p><em>Kui kaua küpsised kestavad?</em></p>
                            <p>Küpsised võivad olla seatud kas üheks "seansiks" või "püsivalt".</p>
                            <p>"Seansiküpsised" on ajutised ja aeguvad, kui lahkute veebisaidilt, st kui te saiti külastate.
                                Seansiküpsised võimaldavad veebisaidil tuvastada teid ja kanda teavet, kui liigute lehtede
                                vahel ühe veebibrauseri seansi jooksul ning võimaldavad teil veebisaiti tõhusalt kasutada.</p>
                            <p>"Püsivad küpsised" jäävad teie veebibrauseri faili pärast veebisaidilt lahkumist ja pärast
                                veebibrauseri sulgemist. Need küpsised kehtivad kuni nende määratud aegumiskuupäevani (välja
                                arvatud juhul, kui kasutaja kustutab need enne aegumiskuupäeva). Need küpsised võimaldavad
                                veebisaidil koguda ja analüüsida liikluse ja kasutamise andmeid anonüümselt, jälgida süsteemi
                                ning parandada tööd. Näiteks võimaldavad need veebisaidil tuvastada teid tagasipöördumisel,
                                meelde jätta teie eelistused ja pakkuda teile isikupärastatud teenuseid.</p>',
    "cookie policy 14"   => "Range vajalikkusega küpsised",
    "cookie policy 15"   => "- Need küpsised on hädavajalikud, et võimaldada teil saiti kasutada ja selle funktsioone,
                                näiteks turvalistele aladele juurdepääsu. Ilma nende küpsisteta teenuseid ei saa pakkuda.</p>
                            <p>Allpool loetleme range vajalikkusega küpsise, mida kasutame:",
    "cookie policy 16"   => "INFUSE, meie kliendiportaali registreeritud külastaja küpsis - Kui külastaja meie
                                saidil logib sisse INFUSE, meie turvalisse kliendiportaali, seab sait kasutaja
                                arvutisse ID-küpsise, et unikaalselt tuvastada kasutajat kogu tema interaktsiooni jooksul
                                INFUSE-ga. Selle küpsise kehtivusaeg on kakskümmend neli (24) tundi pärast selle väljastamist
                                või kui kasutaja logib välja portaalist või sulgeb oma veebibrauseri. INFUSE portaali ei saa
                                kasutada selle küpsiseta.",
    "cookie policy 17"   => "Jõudlusküpsised",
    "cookie policy 18"   => "- Need küpsised koguvad teavet selle kohta, kuidas külastajad saiti kasutavad, näiteks
                                millistele lehtedele külastajad kõige sagedamini lähevad ja kas nad saavad veebilehtedel
                                tõrkeid. Need küpsised ei kogu teavet, mis tuvastaks külastaja. Kogu teave, mida need
                                küpsised koguvad, on anonüümne ja seda kasutatakse ainult saitide parendamiseks.",
    "cookie policy 19"   => "Jõudlusküpsised",
    "cookie policy 20"   => "<li>Viite-URL (sisemine leht) - Kasutatakse eelnevalt külastatud lehe URL-i salvestamiseks.
                                Võimaldab jälgida, kuidas külastajad meie saitidel navigeerivad.</li>
                            <li>Viite-URL - Kasutatakse viite-URL-i salvestamiseks, mis suunab külastaja meie saitidele, et
                                mõista, millised URL-id külastajaid suunavad.</li>
                            <li>URL-i ajalugu - Kasutatakse kasutaja külastatud lehe salvestamiseks enne vormi esitamist.
                                Samuti kasutatakse hiljuti vaadatud artiklite kuvamiseks igale külastajale.</li>
                            <li>Registreerimata külastaja küpsis - Unikaalne identifikaator, mida antakse igale külastajale,
                                et analüüsida, kuidas registreerimata külastajad meie saiti kasutavad.</li>
                            <li>Seansihalduse küpsised - Need küpsised võimaldavad jälgida kasutaja tegevusi veebibrauseri
                                seansi jooksul. Veebibrauseri seanss algab, kui kasutaja avab brauseriakna, ja lõpeb, kui
                                nad sulgevad brauseriakna. Meie seansihalduse küpsised luuakse ajutiselt. Kui sulgete
                                brauseri, kustutatakse meie seansihalduse küpsised.<br></li>",
    "cookie policy 21"   => "Funktsionaalsusküpsised",
    "cookie policy 22"   => "- Need küpsised võimaldavad saidil meelde jätta teie tehtud valikud (näiteks kasutajanimi,
                                keel või teie asukoht) ja pakkuda täiustatud ja isikupärasemaid funktsioone. Näiteks võib
                                sait teie asukoha salvestamiseks küpsisesse salvestada teie praeguse piirkonna. Neid
                                küpsiseid saab kasutada ka teksti suuruse, fondi ja muude veebilehe osade muudatuste
                                meeldejätmiseks, mida saate kohandada. Neid võib kasutada ka nõutud teenuste pakkumiseks,
    ...
    "cookie policy 23"   => "Need küpsised ei saa jälgida teie sirvimistegevust teistel veebisaitidel. Need ei kogu teavet
                                teie kohta, mida saaks kasutada reklaamimiseks ega mäletamiseks, kus olete internetis meie
                                saidi väliselt käinud.",
    "cookie policy 24"   => "Funktsionaalsusküpsised",
    "cookie policy 25"   => "<li>Hiljuti vaadatud lehed - Säilitab kasutaja külastatud lehed meie saitidel ja kuvab neid
                            parempoolses navigeerimises lihtsaks viiteks.</li>
                            <li>Otsingu ajalugu - Säilitab kasutaja saitidel tehtud otsingud ja kuvab need kasutajale
                            parempoolses navigeerimises lihtsaks viiteks.</li>",
    "cookie policy 26"   => "Küpsiste keeldumine või haldamine meie saitidel",
    "cookie policy 27"   => "Kui soovite olemasolevad küpsised oma seadmest eemaldada, saate seda teha oma veebibrauseri
                                valikute kaudu. Kui soovite tulevased küpsised blokeerida või soovite veebisaidi jälgimise
                                keelata, saate oma veebibrauseri seadeid muuta.  Juhiste saamiseks, kuidas haldada oma
                                küpsiste eelistusi erinevates veebibrauserites, külastage meie lehte küpsiste haldamiseks
                                või külastage järgmist kolmanda osapoole saiti:",
    "cookie policy 28"   => "Juhised tuleb järgida igas brauseris eraldi.",
    "cookie policy 29"   => "<p>Olemasolevate küpsiste kustutamine ja blokeerimine mõjutab teie kasutajakogemust, kuna mõned
                                saitide osad võivad enam korralikult töötada. Kui te ei ole küpsiseid blokeerinud, väljastab
                                meie süsteem küpsiseid kohe, kui külastate meie saite, isegi kui olete eelnevalt meie
                                küpsised kustutanud.</p>
                            <p><em>Küpsised ja e-kirjad</em></p>
                            <p>Kasutame küpsiseid ja sarnaseid tehnoloogiaid, nagu jälgimispikslid, ka meie saadetavates
                                e-kirjades. Kogume teavet, näiteks teie IP-aadressi ja geograafilise asukoha ning seda, kas
                                avate e-kirja ja milliseid linke e-kirjas klõpsate. Kogume seda teavet, et hinnata oma
                                e-kirjakampaaniate jõudlust, mõista, milline sisu resonantsi leidis, ja jälgida vastuseid meie
                                ürituste teadetele.</p>
                            <p><em>Kontakt</em></p>
                            <p>Kui teil on selle poliitika kohta küsimusi või kommentaare, võtke ühendust:",
    // Küpsiste haldamine
    "manage cookies 1" => "<p>Tänu teie veebibrauseri versioonile, brauseri seadetele ja seadme seadetele võivad allpool toodud juhised erineda igale kasutajale.</p>
<p>Märkus: Allpool kirjeldatud küpsiste seadete muutused mõjutavad kõiki vastava brauseri kaudu juurdepääsetavaid veebisaite (kuni neid hiljem uuesti uuendate). Kuigi küpsiste keelamine ei mõjuta teie võimet ligi pääseda selle veebisaidi sisule, töötavad kõik saidid erinevalt. Te võite kogeda piiratud funktsionaalsust teistel külastatavatel veebisaitidel.</p>
<br>
<h3>Järgige neid juhiseid küpsiste <em>kustutamiseks</em> vastavalt oma veebibrauserile:</h3>",
    "manage cookies 2" => "Chrome",
    "manage cookies 3" => "<p>Minge seadetele (3 punkti ülemises paremas nurgas)</p>
    <p>Valige „Rohkem tööriistu“</p>
    <p>Valige „Sirvimisandmete kustutamine“</p>
    <p>Valige „Küpsised ja muud saitide andmed“</p>
    <p>Klõpsake nuppu „Kustuta andmed“<br> </p>",
    "manage cookies 4" => "Mobiilne Chrome",
    "manage cookies 5" => "<p>Puudutage ekraani alumises paremas nurgas olevat menüünuppu (3 kuhjatud punkti)</p>
    <p>Valige „Seaded“</p>
    <p>Valige vahekaart „Privaatsus“ jaotises „Kustuta sirvimisandmed“</p>
    <p>Järgmisel ekraanil valige suvand „Küpsised, saitide andmed“, et see märkeruut tühjaks jätta, ja puudutage linki „Kustuta sirvimisandmed“</p>
    <p>Valige „Valmis“</p>",
    "manage cookies 6" => "Firefox",
    "manage cookies 7" => "<p>Valige ülemises paremas nurgas asuv kuhjatud menüünupp (3 triipu)</p>
    <p>Valige „Valikud“</p>
    <p>Mine vasakpoolsel navigeerimispaanil jaotisse „Privaatsus ja turvalisus“</p>
    <p>Jaotises „Ajalugu“ klõpsake lingil „Ajaloo kustutamine“</p>
    <p>Ajaloo kustutamiseks valige „Kustuta kõik“</p>
    <p>Kasutades rippmenüüd „Üksikasjad“, veenduge, et märkeruut „Küpsised“ on märgitud, ja klõpsake nuppu „Kustuta kohe“<br> </p>",
    "manage cookies 8" => "Microsoft Edge",
    "manage cookies 9" => "<p>Avage menüü (3 punkti ülemises paremas nurgas)</p>
    <p>Valige „Seaded“</p>
    <p>Jaotises „Sirvimisandmete kustutamine“ valige „Mida kustutada“</p>
    <p>Valige „Küpsised ja salvestatud veebisaidi andmed“ ning klõpsake nuppu „Kustuta“<br> </p>",
    "manage cookies 10" => "Internet Explorer",
    "manage cookies 11" => "<p>Avage sätete menüü (hammasratta ikoon ülemises paremas nurgas)</p>
                            <p>Jaotises „Interneti-suvandid“ liikuge vahekaardile „Üldine“ ja kerige alla jaotiseni „Sirvimisajalugu“</p>
                            <p>Valige „Küpsised ja veebisaidiandmed“</p>
                            <p>klõpsake nuppu „Kustuta“<br> </p>
                            <p>Märkus: Veenduge, et ruut „Säilita veebisaidi lemmikandmed“ oleks tühjendatud<br> </p>",
    "manage cookies 12" => "Safari",
    "manage cookies 13" => "<p>Valige Safari menüüst „Eelistused“</p>
                            <p>Valige vahekaart „Privaatsus“</p>
                            <p>Klõpsake nuppu „Halda veebisaidi andmeid“ ja seejärel klõpsake nuppu „Eemalda kõik“<br> </p>",
    "manage cookies 14" => "Mobiilne Safari",
    "manage cookies 15" => "<p>Avage oma iPhone'is rakendus „Seaded“</p>
                            <p>Kerige alla ja valige „Safari“</p>
                            <p>Kerige alla ja valige „Ajaloo ja veebisaidi andmete kustutamine“</p>
                            <p>Kinnitage toiming ja valige nupp „Kustuta sirvimisandmed“<br> </p>
                            <h3>Järgige neid juhiseid küpsiste <em>keelamiseks</em> vastavalt oma veebibrauserile:</h3>",
    "manage cookies 16" => "Chrome",
    "manage cookies 17" => "<p>Klõpsake paremas ülanurgas 3 punkti</p>
                                <p>Valige „Seaded“</p>
                                <p>Kasutades vasakpoolset navigeerimist, klõpsake „Lisavalikute“ avamiseks</p>
                                <p>Valige „Privaatsus ja turvalisus“ ning kerige alla jaotiseni „Sisu seaded“</p>
                                <p>Klõpsake „Sisu seaded“</p>
                                <p>Klõpsake „Küpsised“</p>
                                <p>Lülitage välja suvand „Luba saitidel küpsiseid salvestada ja lugeda“<br> </p>",
    "manage cookies 18" => "Mobiilne Chrome",
    "manage cookies 19" => "<p>Puudutage ekraani alumises paremas nurgas olevat menüünuppu (3 kuhjatud punkti)</p>
                            <p>Valige „Seaded“</p>
                            <p>Valige „Saidi seaded“</p>
                            <p>Lülitage küpsised välja ja tühjendage valik „Luba kolmanda osapoole küpsised“<br> </p>",
    "manage cookies 20" => "Firefox",
    "manage cookies 21" => "<p>Valige ülemises paremas nurgas asuv kuhjatud menüünupp (3 triipu)</p>
                            <p>Valige „Valikud“</p>
                            <p>Mine vasakpoolsel navigeerimispaanil jaotisse „Privaatsus ja turvalisus“</p>
                            <p>Valige jaotises „Ajalugu“ suvand „Kasuta kasutaja määratletud seadeid“ rippmenüüst</p>
                            <p>Eemaldage märkeruut „Nõustu küpsistega veebisaitidelt“<br> </p>",
    "manage cookies 22" => "Microsoft Edge",
    "manage cookies 23" => "<p>Avage menüü (3 punkti ülemises paremas nurgas)</p>
    <p>Valige „Seaded“</p>
    <p>Kerige alla jaotiseni „Täpsemad sätted“ ning klõpsake suvandit „Kuva täpsemad sätted“</p>
    <p>Jaotises „Küpsised“ valige „Blokeeri kõik küpsised“<br> </p>",
    "manage cookies 24" => "Internet Explorer",
    "manage cookies 25" => "<p>Avage sätete menüü (hammasratta ikoon ülemises paremas nurgas)</p>
    <p>Jaotises „Interneti-suvandid“ liikuge vahekaardile „Privaatsus“ ja klõpsake suvandit „Täpsemad“</p>
    <p>Valige iga tüüpi küpsise blokeerimiseks suvand „Blokeeri“ (esimene osapoole ja kolmanda osapoole küpsised)</p>
    <p>Klõpsake nuppu „OK“, kui olete lõpetanud<br> </p>",
    "manage cookies 26" => "Safari",
    "manage cookies 27" => "<p>Valige Safari menüüst</p>
    <p>Valige „Eelistused“</p>
    <p>Klõpsake „Privaatsus“</p>
    <p>Jaotises „Küpsised ja veebisaidi andmed“ valige suvand „Blokeeri alati“<br> </p>",
    "manage cookies 28" => "Mobiilne Safari",
    "manage cookies 29" => "<p>Avage oma iPhone'is rakendus „Seaded“</p>
    <p>Kerige alla ja valige „Safari“</p>
...
"our firm 12" => "- toidu pakkumine hädalistele
<br>- toidu ja kingituste annetamine pühade ajal
<br>- kodude ehitamine madala sissetulekuga peredele
<br>- linnade laiuline koristuskampaania
<br>- kooli ilustamine",
"our firm 13" => "Inimestele vajalike ressursside ja oskuste pakkumine edu saavutamiseks, sealhulgas:",
"our firm 14" => "- raamatute ja koolitarvete jagamine
<br>- maksudeklaratsioonide abistamine
<br>- lugemispakettide koostamine
...
"our firm 16" => "Sunrisei töötaja abifond on heategevusorganisatsioon, mida toetavad peamiselt Sunrisei töötajad ja ärilised partnerid. Selle peamine eesmärk on pakkuda finantsabi abikõlblikele Sunrisei töötajatele ja nende otsestele pereliikmetele ootamatute hädaolukordade ja põhivajaduste korral, mida põhjustavad katastroofilised sündmused. Fondi eesmärk on pakkuda leevendust, aidates vähendada osa nendest raskustest põhjustatud finantskoormusest. Abi antakse administratiivselt teostatavalt võimalikult kiiresti, et pakkuda tuge ja leevendada osa seotud kuludest.",
 ...
 //menu
 "menu 1" => "Partnerlus",
"menu 2" => "Meie Missioon & Profiil",
"menu 3" => "Jätkusuutlikkus",
"menu 4" => "Heategevus",
...
"menu 11" => "Usaldusteenused",
"menu 12" => "Erakliendi Laenamine",
"menu 13" => "Keskus Naistele ja Varandusele",
"menu 14" => "Ettevõtete Nõustamine",
"menu 15" => "Ettevõtete Pangandus",
"menu 16" => "Keskus Pereettevõtetele",
"menu 17" => "Meist",
"menu 18" => "Investeerimisprofiil",
"menu 19" => "Investeerimisstrateegia & Tehingutüübid",
"menu 20" => "Vali Portfelli Ettevõtted",
"menu 21" => "USA Suurkapitali Aktsiad",
"menu 22" => "Ülemaailmsed Aktsiad",
"menu 23" => "USA Väike- ja Keskmise Suurusega Kapitali Aktsiad",
"menu 24" => "Maksustatavad Fikseeritud Tulumääraga Strateegiad",
"menu 25" => "Maksuvabad Fikseeritud Tulumääraga Strateegia",
"menu 26" => "USA TIPS Strateegia",
"menu 27" => "Hoidla",
"menu 28" => "Hoidja & Usaldusisik",
"menu 29" => "Fondide Raamatupidamine",
"menu 30" => "Fondide Haldamine",
"menu 31" => "Ülekandeteenus",
"menu 32" => "Ülemaailmne Maksustamine",
"menu 33" => "Tagatisvara Haldus",
"menu 34" => "Fondide Tellimused & Hoidla",
"menu 35" => "Piiriülese Raha Fondid",
"menu 36" => "USA Fondid",
"menu 37" => "Konsultandid & Nõustajad",
"menu 38" => "Jaotusintelligentsus",
"menu 39" => "Alternatiivsed Fondid",
"menu 40" => "Börsil Kaubeldavad Fondid",
"menu 41" => "Kindlustus",
"menu 42" => "Regulatiivne Intelligentsus",
"menu 43" => "Võõrvaluuta",
"menu 44" => "Aktiivne Välisvaluuta Tehing",
"menu 45" => "InfoFX",
"menu 46" => "Valuutakaitse",
"menu 47" => "Väärtust Paberi Laenutamine",
"menu 48" => "Turuintelligentsus",
"menu 49" => "Tehnoloogiateenused",
"menu 50" => "Keskne Büroo Väline Haldamine",
"menu 51" => "Võtke Meiega Ühendust",
"menu 52" => "Keel",
...
"home page 7" => "Meie Teenused",
"home page 8" => "Privaatne Kapital",
"home page 9" => "Privaatne<br>Kapital",
"home page 10" => "Pakume oma klientidele juurdepääsu maailmaturgudele ja meie meeskond on saadaval, et aidata teil navigeerida saadaolevate investeerimisvõimaluste laias valikus. Lisaks teevad meie isiklikud nõustajad klientidega tihedat koostööd, et välja selgitada kõige sobivamad võimalused nende olukorra arvestades.",
"home page 11" => "Detailid",
"home page 12" => "Usaldusteenused",
"home page 13" => "Kogenud usaldusteenuse osutajatena teeme koostööd klientide ja nende nõustajatega, et hallata kõiki tüüpi usaldusfonde, alates lihtsatest elavate usalduste haldamisest kuni keerukate maksualaste kaalutlustega seotud varahaldusvahenditeni. Pakume ka spetsialiseeritud teenuseid pensioni- ja heategevusfondidele.",
"home page 14" => "Usaldusteenused",
"home page 15" => "Hedgefondid",
"home page 16" => "Hedgefondid",
"home page 17" => "Globaalse juurdepääsuga hedgefondidele pakume klientidele ennenägematuid võimalusi ja meie meeskond on siin, et tagada teie edu. Meie ulatuslik ekspertiis selles valdkonnas võimaldab meil aidata kliente valida nende portfellide jaoks optimaalseima hedgefondi.",
"home page 18" => "Kinnisvara",
"home page 19" => "Kinnisvaraturu tulemuslikkus on lahutamatult seotud kohalike majandustega ja kasutame oma ülemaailmset võrgustikku majandusandmete uurimiseks ja analüüsimiseks, et mõista turusuunda ning saada teadmisi, mis juhivad meie investeerimisstrateegiaid.",
"home page 20" => "Kinnisvara",
"home page 21" => "Tehnoloogilised toorained",
"home page 22" => "Pakume oma klientidele juurdepääsu laiale valikule kõvadele ja pehmetele toorainetele, kasutades selleks meie ülemaailmset ulatust ja võrgustikke, et pakkuda teile võimalusi. Mõistmisega meie kliendi positsioonist ja toorainete valikute tegelikust väärtusest püüame leida portfelli parandavaid lahendusi.",
...
"pe5" => "Äriomadused",
"pe6" => " - Olulised kaubad ja teenused<br>

Lojaalsed kliendid<br>
Juhtiv positsioon kasumlikul turusegmendil või tööstusharus<br>
Jätkusuutlikud konkurentsieelised",
"pe7" => "Juhtimisomadused",
"pe8" => "- Tugevad juhid moraalse iseloomuga<br>
Soodsad kapitali paigutused<br>
Märgatav osalus ettevõttes",
"pe9" => "Finantsomadused",
...
"pe16" => "Äriomadused",
"pe17" => " - Olulised kaubad ja teenused<br>
Lojaalsed kliendid<br>
Juhtiv positsioon kasumlikul turusegmendil või tööstusharus<br>
Jätkusuutlikud konkurentsieelised",
"pe18" => "Juhtimisomadused",
"pe19" => "- Tugevad juhid moraalse iseloomuga<br>
Soodsad kapitali paigutused<br>
Märgatav osalus ettevõttes",
"pe20" => "Finantsomadused",
...
<br>
-Rahvusvahelisse investeerimisse kaasnevad unikaalsed riskid, nagu valuutarisk, suurenenud volatiilsus, poliitiline risk ja erinevused auditeerimises ja muudes finantsstandardites.
<br> <br>
...
Investeerige krediiti ainult siis, kui on olemas ohutusmarginaal.
<br>
Toetage portfellide konstruktsiooni väärtuse loomise kaudu
<br>
Võtke kasutusele pikaajaline vaatenurk
<br>
Julgustage avatuse, protsessi distsipliini ja arutelu kultuuri",
"pe28" => "Investeerimiskriteeriumid:",
"pe29" => "Kujundame oma maksustatavad fikseeritud sissetulekustrateegiad võlakirjalt võlakirjale, kasutades põhjalikku analüüsi ja patenteeritud hindamisraamistikku turu skriinimiseks potentsiaalselt veenvate väärtuste jaoks. Seejärel omandame krediidid marginaaliga ohutuse* alusel, mis varieerub võlakirja tüübi ja reitingu järgi ning määratleb hinnaamordi, mille me usume, et määratleb atraktiivse hinna võlakirjale pikemaajalises perspektiivis, arvestades krediiditurul valitsevat tsüklilisust. Kordame oma investeerimisprotseduuri, moodustades kõrge tootlusega pikaajaliste võlakirjade portfelle.",
"pe30" => "Kavatseme omandada pikaajalisi krediidisid, mis vastavad järgmistele investeerimiskriteeriumidele:",
"pe31" => "- Kestus: Meie portfellides olevad emiteerijad peavad omama jätkusuutlikku tulumudelit ja/või tagatist. Lisaks hindame ettevõtte vastupidavust erinevatele regulatiivsetele ja majanduslikele häiretele.
<br>
Läbipaistvus: Emiteerija peab tegutsema ärimudeli ja finantsstruktuuriga, mis on tuvastatav ja mõistetav. Vähem tõenäoline on, et investeerime emiteerijasse, kui selle ärimudel ja kapitalistruktuur on keerukamad.
<br>
Juhtimine: Tugev juhtimine on vastupidava krediidiga tuvastamiseks hädavajalik ning tuvastame juhtkonnad, kes säilitavad tasakaalustatud suhte kõigi kapitali pakkujate suhtes.
<br>
Struktuur: On oluline, et emiteerija suudaks genereerida piisavalt sisemist rahastust oma kapitalistruktuuri toetamiseks. Kinnitame, et emiteerijal ei ole ülemäärast võlga, arvestades rahavoogude sisemist volatiilsust, ega ole tal ebatervet sõltuvust kapitaliturgudest rahastamiseks.",
"pe32" => "*Me usume, et ohutusmarginaal eksisteerib, kui saame leevendada nii äriohu (meie äri, finants- ja juhtimiskriteeriumid on täidetud; on jätkusuutlikud konkurentsieelised) KUI KA hinnariski (kui usume, et ostuhetkel on oluline allahindlus olemuslikule väärtusele - me püüame osta 75% või vähem meie hinnangust olemuslikule väärtusele).
<br>
-Võlakirjaturul investeerimisega kaasnevad teatavad riskid, sealhulgas turu-, intressi-, emiteerija-, krediidi- ja inflatsioonirisk; lunastamisel võib investeering olla väärt rohkem või vähem kui selle algne maksumus.
<br><br>
MITTE FDIC KINNITATUD PUUDUB PANGAGARANTII VÕIB KAOTADA OMA VÄÄRTUSES",
...
Finantsvitaliteet
<br>
Käivitusparadigma koos hinnakujundusvabaduse ja tugevusega
<br>
Toetatud kontrollitud tulude allikaga
<br>
Tugev kaitse ja lepingu kate
<br>
Õigeaegsed rahalised aruanded",
"pe38" => "Alati kui võimalik, võtame arvesse ka järgmisi juhtimisomadusi:",
"pe39" => "- Poliitiline kalle iseseisvusele hindade määramisel
<br>
Kasumlik operatiivne tõhusus
<br>
...
<br>
Võlakirjaturul investeerimine on seotud teatud riskidega, sealhulgas turu-, intressi-, emiteerija-, krediidi- ja inflatsioonirisk; lunastamisel võib investeering olla väärt rohkem või vähem kui selle algne maksumus.
<br><br>
MITTE FDIC KINNITATUD PUUDUB PANGAGARANTII VÕIB KAOTADA OMA VÄÄRTUSES",
...
<br>
Mitte-suunalised strateegiad: Meie uurimine on tuvastanud mitmeid järjepidevaid ja korduvaid ebavõrdsusi USA TIPS turul ning meie investeerimismeeskond paigutab sageli meie portfelli, et püüda kinni neist ebavõrdsusest tulenevatest suhtelisest ülejäägitootest. Enampakkumiste tsüklid, hooajalised mustrid, esitusindeksi laiendused, inflatsioonikasvud ja hoiuste laienemised ning mahaarvamised on nende turutõrgete hulka.
<br>
Need strateegiad hõlmavad USA riigikassa turgu ja välisriikide suveräänsete inflatsiooniindeksiga turgude positsioone.
<br><br>
MITTE FDIC KINNITATUD PUUDUB PANGAGARANTII VÕIB KAOTADA OMA VÄÄRTUSES",
