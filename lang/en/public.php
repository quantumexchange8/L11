...
return [
    ...
    "our firm caption 2" => "To safeguard our clients' financial well-being",
    "our firm caption 3" => "Enriching our clients, our people, and our communities through positive contributions",
    "our firm caption 4" => "Demonstrating compassion for the community while fostering strong relationships with our colleagues.",
    ...
    // wealth planning
    "wealth planning 1" => "Our experienced wealth planners work closely with your legal and tax advisors to design and implement a wealth and estate plan that is driven by your personal goals and values and aligned with your overall investment strategy.",
    "wealth planning 2" => "This integrated approach allows us to proactively present you with appropriate planning opportunities as your wealth grows, your family changes over time, and the legislative and financial landscape shifts.",
    "wealth planning 3" => "Our wealth planning services include but are not limited to; ",
    "wealth planning 4" => "Personal and family objectives",
    "wealth planning 5" => "Near and long-term financial goal estimations",
    "wealth planning 6" => "Family governance, including education of next-generation",
    "wealth planning 7" => "Family business succession planning, wealth and estate planning, including estate design implementation, retirement asset planning & assisting with the design, establishment, and administration of a family foundation",
    "wealth planning 8" => "Advising on charitable donations, philanthropic interests and identifying philanthropic vehicles to accomplish your family’s charitable giving goals.",
    "wealth planning 9" => "",
    "wealth planning 10" => "",
    "wealth planning 11" => "",
    "wealth planning 12" => "",
    ...
    "fund administration 4" => "Market and Regulatory Expertise",
    "fund administration 5" => "Understanding and staying informed of market trends and regulatory changes impacting the funds industry has
    ...
    "fund administration 6" => "A Collaborative Approach and Service Model",
    "fund administration 7" => ", single global technology platform and intelligent integration of business teams
    ...
    "middle office outsourcing 3" => "Offering middle office operational services that add transparency and efficiency across the entire post-trade lifecycle.",
    "middle office outsourcing 4" => "Enabling improved front office decision making through data aggregation and augmentation tools, and a consistent, transparent view into enterprise-wide investment activity.",
    ...
    "investment accounting & enterprise data support 1" => "The increasing complexity of capital markets, investment products, and the regulatory environment
    ...
    "investment accounting & enterprise data support 2" => "Antiquated Status Quo",
    "investment accounting & enterprise data support 3" => "Asset gatherers have built strong franchises on the backs of order management systems (OMS) and Accounting
                                                            ...
                                                            enhancements.",
    "investment accounting & enterprise data support 4" => "IBOR Strategy",
    "investment accounting & enterprise data support 5" => "The front office seeks information on real-time cash, securities and known future securities’ events across
    ...
    "data connectivity & applications via infomediary 1" => "A core component of Sunrise’s single integrated technology platform is the robust Sunrise Infomediary®
                                                                ...
                                                                to reconciliation, trade messaging and management, corporate actions, FX netting and aggregation, as well as
                                                                differing or non-existing industry standards.",
    "data connectivity & applications via infomediary 2" => "Connecting the Financial Services Marketplace",
    "data connectivity & applications via infomediary 3" => "A highly customizable, hosted communications platform, Infomediary provides a single connectivity point
                                                                between clients and their external service providers and internal systems. Infomediary takes in data in any
                                                                electronic format, normalizes it, and then translates, transforms, and transmits the information over
                                                                networks such as SWIFT or via proprietary connections.",
    "data connectivity & applications via infomediary 4" => "Innovative Modular Applications for Complex Operations",
    "data connectivity & applications via infomediary 5" => "In addition to its core messaging and connectivity capabilities, Infomediary offers exclusive modular applications such as:",
    "data connectivity & applications via infomediary 6" => "multi-provider automation for the entire corporate actions event lifecycle",
    "data connectivity & applications via infomediary 7" => "a dynamic foreign exchange alternative that combines quality execution with cost efficiencies and clear, comprehensive reporting – all through a fully automated, efficient workflow",
    "data connectivity & applications via infomediary 8" => "a scalable outsource solution that provides an automated process for reconciling cash data and securities data across all service providers",
    ...
    "entry level 1" => "Are you a recent graduate searching for an ideal starting point for your professional career?
                        ...
                        to explore innovative approaches to assist our clients in achieving their goals.
                        <br><br>
                        If you possess a strong dedication to collaborating effectively with others, maintaining high
                        ...
                        thinking and find creative solutions to support our clients' objectives.
                        <br><br>
                        By becoming a part of our organization, you will have the opportunity to contribute to the
                        ...
                        enabling you to learn from experienced professionals and enhance your skills.
                        <br><br>
                        If you are motivated, passionate, and ready to embark on a rewarding career in the financial
                        services industry, we invite you to apply and explore the possibilities of joining our team.
                        <br><br>
                        As an entry-level candidate, this means:",
...
<h3>Please follow these instructions to <em>delete </em>your cookies based on your browser</h3>",
    ...
    "our firm 12"   => "- serving meals to the destitute 
    <br>- donating food and gifts during the holidays 
    <br>- constructing homes for low-income families
    <br>- citywide clean-up initiatives 
    <br>- school beautification efforts",
    "our firm 13"   => "Providing individuals with the resources and skills necessary for success, including:",
    "our firm 14"   => "- distributing books and school supplies 
    <br>- assisting with tax returns 
    <br>- assembling literacy packages 
    ...
    "our firm 20"   => "Providing mentorship, scholarship and Work placement for students who could potentially become the future of Sunrise Fund Limited.",
     ...
     "menu 11" => "Trust Services",
     "menu 12" => "Private Client Lending",
     ...
     "menu 22" => "Global Equity",
     "menu 23" => "US Small & Mid-Cap Equity",
     "menu 24" => "Taxable Fixed Income Strategies",
     "menu 25" => "Tax-Exempt Fixed Income Strategy",
     "menu 26" => "US TIPS Strategy",
     "menu 27" => "Custody",
     "menu 28" => "Depositary & Trustee",
     "menu 29" => "Fund Accounting",
     "menu 30" => "Fund Administration",
     "menu 31" => "Transfer Agency",
     "menu 32" => "Global Tax",
     "menu 33" => "Collateral Management",
     "menu 34" => "Fund Order & Custody",
     "menu 35" => "Cross-Border Funds",
     "menu 36" => "US Funds",
     "menu 37" => "Consultants & Advisors",
     "menu 38" => "Distribution Intelligence",
     "menu 39" => "Alternative Funds",
     "menu 40" => "Exchange Traded Funds",
     "menu 41" => "Insurance",
     "menu 42" => "Regulatory Intelligence",
     "menu 43" => "Foreign Exchange",
     "menu 44" => "Active FX Execution",
     "menu 45" => "InfoFX",
     "menu 46" => "Currency Hedging",
     "menu 47" => "Securities Lending",
     "menu 48" => "Market Intelligence",
     "menu 49" => "Technology Services",
    ...
    "home page 7" => "Our Services",
    "home page 8" => "Private Equity",
    "home page 9" => "Private<br>Equity",
    "home page 10" => "We provide our clients with access to global markets, and our team is available to assist you in navigating the vast array of available investment vehicles. Additionally, our personal advisors collaborate closely with clients to determine the most suitable options given their circumstances.",
    "home page 11" => "Details",
    "home page 12" => "Trust<br>Services",
    "home page 13" => "As seasoned trustees and executors, we collaborate with clients and their advisors to administer all types of trusts, from simple living trusts to complex estate planning vehicles propelled by tax considerations. We also provide specialised services for retirement and charitable foundations.",
    "home page 14" => "Trust Services",
    "home page 15" => "Hedge Funds",
    "home page 16" => "Hedge<br>Funds",
    "home page 17" => "With global access to hedge funds, we offer our clients unrivalled opportunities, and our team is here to ensure your success. Our extensive expertise in this field enables us to assist clients in selecting the optimal hedge fund for their portfolios.",
    "home page 18" => "Real<br>Estate",
    "home page 19" => "Real estate market performance is inextricably linked to local economies, and we leverage our global network to research and analyse economic data to comprehend market direction and gain insights that inform our investment strategies.",
    "home page 20" => "Real Estate",
    "home page 21" => "Commodities",
    "home page 22" => "We provide our clients with access to a vast selection of hard and soft commodities by leveraging our global reach and networks to offer you the opportunities. With an understanding of our client's position and the true value of commodity options, we aim to discover portfolio-improving solutions.",
    ...
    "home page 26" => "All the information, news, opinions, research, and analyses on this website are provided as a reference. All the information provided by Sunrise Fund Limitedon this website is subject to change from time to time and up to date. By using Online platforms there is a possibility of communication failures, hardware, software, and connection issues, measures are in place to minimize the failure and delay, and users should be responsible and aware of this. Sunrise Fund Limitedis not responsible for this communication failure. The unauthorized use, of all and/or any information on this website, is strictly prohibited.",
    "home page 26b" => "Sunrise Fund Limitedis licensed by the Securities and Futures Commission (SFC) of the Hong Kong  to engage with clients by Dealing in Securities regulated activity as defined in Schedule 5 of the Securities and Futures Ordinance (SFO). SFC Regulatory Number: BOC314. Sunrise Fund Limitedis a Hong Kong corporation headquartered at: Unit 1112, The Metropolis Tower, 10 Metropolis Drive, Hung Hom, Hong Kong. Company Registration No: 2715718.",
    ...
    "pe6" => " - Important goods and services<br>
    - Loyal clients<br>
    - Leadership in a profitable market segment or industry<br>
    - Sustainable competitive advantages",
    "pe7" => "Management Attributes",
    "pe8" => "- Strong managers with moral character<br>
    - Favourable capital allocations<br>
    - Significant stake ownership",
    "pe9" => "Financial Attributes",
    ...
    *Sunrise estimate of the present value of the cash that a company can generate and distribute to its shareholders over the remainder of its existence
    ...
    "pe17" => " - Important goods and services<br>
    - Loyal clients<br>
    - Leadership in a profitable market segment or industry<br>
    - Sustainable competitive advantages",
    "pe18" => "Management Attributes",
    "pe19" => "- Strong managers with moral character<br>
    - Favourable capital allocations<br>
    - Significant stake ownership",
    ...
    <br>
    -Investing internationally is fraught with unique risks, such as currency risk, increased volatility, political risk, and disparities in auditing and other financial standards.
    <br> <br>
    NOT FDIC INSURED NO BANK GUARANTEE MAY DEPRECIATE IN VALUE",
    ...
    "pe28" => "Investment Criteria:",
    "pe29" => "We construct our taxable fixed income portfolios bond by bond, using fundamental analysis and a proprietary valuation framework to screen the market for potentially compelling values. Then, we acquire credits with a margin of safety* that varies based on the type and rating of the bond and defines a price cushion that we believe will define an attractive price for the bond over the lengthier term, taking into account the cyclicality of credit markets. Repeating our investment procedure, we construct portfolios of high-yielding, long-term debt securities.",
    "pe30" => "We intend to acquire long-term credits that satisfy the following investment criteria:",
    "pe31" => "- Durability: The issuers in our portfolios are required to have a sustainable revenue model and/or collateral. In addition, we evaluate the company's resilience to a variety of regulatory and economic disruptions.
    <br>
    ...
    "pe38" => "Whenever applicable, we also take the following management characteristics into account:",
    "pe39" => "- Political disposition to exercise rate independence
    <br>
